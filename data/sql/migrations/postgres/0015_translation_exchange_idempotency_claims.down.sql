...
ALTER TABLE translation_exchange_apply_ledger DROP COLUMN IF EXISTS lease_expires_at;
ALTER TABLE translation_exchange_apply_ledger DROP COLUMN IF EXISTS claim_token;
ALTER TABLE translation_exchange_apply_ledger DROP COLUMN IF EXISTS status;
