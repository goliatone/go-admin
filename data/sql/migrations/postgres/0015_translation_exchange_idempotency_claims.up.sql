...
ALTER TABLE translation_exchange_apply_ledger ADD COLUMN IF NOT EXISTS status TEXT NOT NULL DEFAULT 'applied';
ALTER TABLE translation_exchange_apply_ledger ADD COLUMN IF NOT EXISTS claim_token TEXT;
ALTER TABLE translation_exchange_apply_ledger ADD COLUMN IF NOT EXISTS lease_expires_at TIMESTAMPTZ;
