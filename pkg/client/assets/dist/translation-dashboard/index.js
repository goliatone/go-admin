...
import { E as se, T as ne, _ as I, b as T, g as B, k as oe, m as v, nt as O, s as ie, u as q, v as z, w as le, x as N, y as F } from "../chunks/translation-shared-DxbdCW0D.js";
  ...
  return a.embedded ? `
      <div data-dashboard-table="${c(t.id)}">
        <header class="flex items-center justify-between gap-3 border-b border-gray-200 px-4 py-3 bg-white">
          <div>
            <p class="text-xs text-gray-500">Showing top ${i(String(t.rows.length))} of ${i(String(t.total))}</p>
          </div>
          ${l?.href ? `
            <a
              href="${c(l.href)}"
    ...
    <section class="overflow-hidden ${v} shadow-sm" data-dashboard-table="${c(t.id)}">
      <header class="flex items-center justify-between gap-3 border-b border-gray-200 px-4 py-3">
        <div>
          ...
          <p class="mt-1 text-xs text-gray-500">Showing top ${i(String(t.rows.length))} of ${i(String(t.total))}</p>
        </div>
        ${l?.href ? `
          <a
            href="${c(l.href)}"
    ...
    <section class="${v} shadow-sm overflow-hidden" data-dashboard-toolbar="true">
      <div class="px-5 py-4">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <p class="${ne}">Manager Monitoring</p>
          ...
          <div class="flex flex-wrap items-center gap-3">
            ...
            <button type="button" class="${q}" data-dashboard-refresh-button="true" aria-label="Refresh translation dashboard" ${e ? "disabled" : ""}>
...
function He(t) {
  ...
  return w({
    tag: "section",
    containerClass: `${B} p-6 shadow-sm`,
    bodyClass: "",
    contentClass: "",
    ...
    actionsHtml: `
      <div class="mt-5 flex flex-wrap gap-3">
        <button type="button" class="${q}" data-dashboard-refresh-button="true">Refresh dashboard</button>
        ${a}
      </div>
    `,
