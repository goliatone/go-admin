...
export interface EntryNavigationExamplesContract {
    inherit?: {
        _navigation?: Record<string, 'inherit' | 'show' | 'hide' | string>;
    };
    show_hide?: {
        _navigation?: Record<string, 'inherit' | 'show' | 'hide' | string>;
    };
...
export type FieldType = 'text' | 'textarea' | 'rich-text' | 'markdown' | 'code' | 'number' | 'integer' | 'currency' | 'percentage' | 'select' | 'radio' | 'checkbox' | 'chips' | 'toggle' | 'date' | 'time' | 'datetime' | 'daterange' | 'media-picker' | 'media-gallery' | 'file-upload' | 'reference' | 'references' | 'user' | 'group' | 'repeater' | 'blocks' | 'json' | 'slug' | 'color' | 'location';
...
export type FieldTypeConfig = TextFieldConfig | NumberFieldConfig | SelectFieldConfig | MediaFieldConfig | ReferenceFieldConfig | RepeaterFieldConfig | BlocksFieldConfig | CodeFieldConfig | SlugFieldConfig | ColorFieldConfig | LocationFieldConfig | DateRangeFieldConfig;
...
export type FieldTypeCategory = 'text' | 'number' | 'selection' | 'datetime' | 'media' | 'reference' | 'structural' | 'advanced';
