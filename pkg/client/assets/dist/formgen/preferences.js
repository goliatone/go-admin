(() => {
  const l = "[data-preferences-form]", c = 'textarea[name="raw_ui"]', f = '[data-json-editor="true"]', u = "raw_ui must be valid JSON", m = "raw_ui must be a JSON object", E = (e) => !!e && typeof e == "object" && !Array.isArray(e), S = (e) => {
    const r = e.trim();
    if (!r) return {
      value: null,
      empty: !0
    ...
    try {
      ...
      return {
        value: null,
        empty: !1,
        error: t instanceof Error ? t.message : u
      };
    }
  }, n = (e, r, t) => {
    ...
    const a = S(e.value || "");
    return a.empty ? (n(e, r, ""), !0) : a.error ? t ? (n(e, r, u), !1) : (n(e, r, ""), !0) : t && !E(a.value) ? (n(e, r, m), !1) : (n(e, r, ""), s && (e.value = JSON.stringify(a.value, null, 2)), !0);
  }, v = (e) => {
    ...
    t.addEventListener("input", i), t.addEventListener("blur", i), r.addEventListener("submit", (y) => {
      !o(t, a, s, !0) && s && (y.preventDefault(), t.reportValidity());
    }), i();
  }, d = () => {
