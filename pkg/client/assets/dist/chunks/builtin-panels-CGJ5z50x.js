...
function De(e, t, o) {
  ...
  return `
    ...
    <tr class="${t.detailRow}" data-detail-for="${i(c)}" style="display:${de}">
      <td colspan="5">${ce}</td>
    </tr>
  `;
}
...
function rt(e, t, o) {
  const { useIconCopyButton: r = !1, showCount: s = !0 } = o, n = z(e), a = D(e, !0), d = tt(t, r), c = s ? `<span class="${t.muted}">${b(ue(e))} keys</span>` : "";
  return `
...
function Xt(e, t) {
  ...
  const r = ie(o), s = e.counters || {}, n = s.hits || 0, a = s.misses || 0, d = s.errors || 0;
  let c = "N/A";
  const l = s.lookups || 0;
...
var ao = {
  ...
  renderConsole: (e, t, o) => A(e || [], t, {
    ...o,
    maxEntries: 200,
    showSortToggle: !1,
    useIconCopyButton: !0
  }),
  renderToolbar: (e, t, o) => A(e || [], t, {
    ...o,
    maxEntries: 50,
    showSortToggle: !0,
    useIconCopyButton: !1
