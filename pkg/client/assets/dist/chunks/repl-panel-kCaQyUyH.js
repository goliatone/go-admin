...
import { r as st } from "./icons-Dr5y9RE3.js";
...
}, Dr = Object.defineProperty, xn = Object.getOwnPropertyDescriptor, En = (e, t) => {
  for (var i in t) Dr(e, i, {
    get: t[i],
    enumerable: !0
  });
}, q = (e, t, i, s) => {
  for (var r = s > 1 ? void 0 : s ? xn(t, i) : t, n = e.length - 1, o; n >= 0; n--) (o = e[n]) && (r = (s ? o(t, i, r) : o(r)) || r);
  return s && r && Dr(t, i, r), r;
}, y = (e, t) => (i, s) => t(i, s, e), ks = "Terminal input", Ci = {
  get: () => ks,
  set: (e) => ks = e
}, xs = "Too much output to announce, navigate to rows manually to read", ki = {
  get: () => xs,
  set: (e) => xs = e
};
function Dn(e) {
...
function Mn(e, t, i, s) {
  e.stopPropagation(), e.clipboardData && Br(e.clipboardData.getData("text/plain"), t, i, s);
}
function Br(e, t, i, s) {
...
function Es(e, t, i, s, r) {
  Rr(e, t, i), r && s.rightClickSelect(e), t.value = s.selectionText, t.select();
}
function Ue(e) {
...
var Ln = class {
  ...
  clone() {
    return new Pr(this._ext, this._urlId);
  }
  isEmpty() {
    return this.underlineStyle === 0 && this._urlId === 0;
  }
}, be = class Tr extends Rt {
  constructor() {
...
}, Ds = "di$target", xi = "di$dependencies", ci = /* @__PURE__ */ new Map();
function Tn(e) {
  return e[xi] || [];
}
function re(e) {
...
var ce = re("BufferService"), Ar = re("CoreMouseService"), tt = re("CoreService"), On = re("CharsetService"), _s = re("InstantiationService"), Or = re("LogService"), de = re("OptionsService"), Ir = re("OscLinkService"), In = re("UnicodeService"), Mt = re("DecorationService"), Ei = class {
  constructor(e, t, i) {
...
var ii = re("CharSizeService"), Oe = re("CoreBrowserService"), fs = re("MouseService"), Ie = re("RenderService"), Hn = re("SelectionService"), Nr = re("CharacterJoinerService"), nt = re("ThemeService"), Hr = re("LinkProviderService"), zn = class {
  constructor() {
    this.listeners = [], this.unexpectedErrorHandler = function(e) {
      setTimeout(() => {
        throw e.stack ? Bs.isErrorNoTelemetry(e) ? new Bs(e.message + `
...
}, Ri = class zr extends Error {
  constructor(t) {
    super(t || "An unexpected bug occurred."), Object.setPrototypeOf(this, zr.prototype);
  }
};
...
var $r = class Kr {
  ...
  add(t) {
    ...
    return xt(t, this), this._isDisposed ? Kr.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(t), t;
  }
  delete(t) {
    if (t) {
...
}, io = globalThis.performance && typeof globalThis.performance.now == "function", so = class Ur {
  static create(t) {
    return new Ur(t);
  }
  constructor(t) {
...
((e) => {
  ...
  function t(b) {
    if (no) {
      let { onDidAddListener: v } = b, C = Ni.create(), w = 0;
      b.onDidAddListener = () => {
        ++w === 2 && (console.warn("snapshotted emitter LIKELY used public and SHOULD HAVE BEEN created with DisposableStore. snapshotted here"), C.print()), v?.();
      };
    }
  }
  function i(b, v) {
  ...
  function s(b) {
    return (v, C = null, w) => {
      let x = !1, S;
      return S = b((T) => {
        if (!x) return S ? S.dispose() : x = !0, v.call(C, T);
      }, null, w), x && S.dispose(), S;
    };
  }
  e.once = s;
  function r(b, v, C) {
    return d((w, x = null, S) => b((T) => w.call(x, v(T)), null, S), C);
  }
  e.map = r;
  function n(b, v, C) {
  ...
  e.forEach = n;
  function o(b, v, C) {
    return d((w, x = null, S) => b((T) => v(T) && w.call(x, T), null, S), C);
  }
  e.filter = o;
  function h(b) {
    return b;
  ...
  e.signal = h;
  function l(...b) {
    return (v, C = null, w) => c(to(...b.map((x) => x((S) => v.call(C, S)))), w);
  }
  e.any = l;
  function a(b, v, C, w) {
    let x = C;
    return r(b, (S) => (x = v(x, S), x), w);
  }
  e.reduce = a;
  function d(b, v) {
    let C, w = {
  ...
  function c(b, v) {
    return v instanceof Array ? v.push(b) : v && v.add(b), b;
  }
  function _(b, v, C = 100, w = !1, x = !1, S, T) {
    let $, oe, xe, Me = 0, Z, Ne = {
      leakWarningThreshold: S,
      onWillAddFirstListener() {
        $ = b((Ye) => {
          Me++, oe = v(oe, Ye), w && !xe && (le.fire(oe), oe = void 0), Z = () => {
            let at = oe;
  ...
  e.debounce = _;
  function f(b, v = 0, C) {
    return e.debounce(b, (w, x) => w ? (w.push(x), w) : [x], v, void 0, !0, void 0, C);
  }
  e.accumulate = f;
  function u(b, v = (w, x) => w === x, C) {
    let w = !0, x;
    return o(b, (S) => {
      let T = w || !v(S, x);
      return w = !1, x = S, T;
  ...
  e.latch = u;
  function g(b, v, C) {
    return [e.filter(b, v, C), e.filter(b, (w) => !v(w), C)];
  }
  e.split = g;
  function k(b, v = !1, C = [], w) {
  ...
  class L {
    ...
    filter(v) {
      return this.steps.push((C) => v(C) ? C : I), this;
    }
    reduce(v, C) {
      let w = C;
      return this.steps.push((x) => (w = v(w, x), w)), this;
    }
    latch(v = (C, w) => C === w) {
      let C = !0, w;
    ...
    evaluate(v) {
      for (let C of this.steps) if (v = C(v), v === I) break;
      return v;
    }
  }
  function E(b, v, C = (w) => w) {
    let w = (...$) => T.fire(C(...$)), x = () => b.on(v, w), S = () => b.removeListener(v, w), T = new m({
  ...
  function P(b, v, C = (w) => w) {
    let w = (...$) => T.fire(C(...$)), x = () => b.addEventListener(v, w), S = () => b.removeEventListener(v, w), T = new m({
      onWillAddFirstListener: x,
      onDidRemoveLastListener: S
    });
    return T.event;
  ...
  class Tt {
    constructor(v, C) {
      ...
      C || t(w), this.emitter = new m(w), C && C.add(this.emitter);
    }
    beginUpdate(v) {
      this._counter++;
    }
  ...
  function F(b, v) {
    return new Tt(b, v).emitter.event;
  }
  e.fromObservable = F;
  function ai(b) {
    return (v, C, w) => {
      let x = 0, S = !1, T = {
        ...
        endUpdate() {
          x--, x === 0 && (b.reportChanges(), S && (S = !1, v.call(C)));
        },
...
var oo = Oi, Ts = -1, qr = class Vr {
  constructor(t, i, s = (Vr._idPool++).toString(16).padStart(3, "0")) {
...
qr._idPool = 1;
var ao = qr, Ni = class Yr {
  constructor(t) {
    this.value = t;
  }
  static create() {
    return new Yr((/* @__PURE__ */ new Error()).stack ?? "");
  }
  print() {
...
var m = class {
  constructor(e) {
    this._size = 0, this._options = e, this._leakageMon = Ts > 0 || this._options?.leakWarningThreshold ? new ao(e?.onListenerError ?? zt, this._options?.leakWarningThreshold ?? Ts) : void 0, this._perfMon = this._options?._profName ? new oo(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
    if (!this._disposed) {
  ...
  get event() {
    return this._event ?? (this._event = (e, t, i) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(h);
        let l = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], a = new lo(`${h}. HINT: Stack shows most frequent listener (${l[1]}-times)`, l[0]);
        return (this._options?.onListenerError || zt)(a), R.None;
      }
      if (this._disposed) return R.None;
      t && (e = e.bind(t));
      let s = new Wt(e), r, n;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (s.stack = Ni.create(), r = this._leakageMon.check(s.stack, this._size + 1)), Ps && (s.stack = n ?? Ni.create()), this._listeners ? this._listeners instanceof Wt ? (this._deliveryQueue ?? (this._deliveryQueue = new fo()), this._listeners = [this._listeners, s]) : this._listeners.push(s) : (this._options?.onWillAddFirstListener?.(this), this._listeners = s, this._options?.onDidAddFirstListener?.(this)), this._size++;
      let o = z(() => {
        Ft?.unregister(o), r?.(), this._removeListener(s);
      });
      if (i instanceof Ve ? i.add(o) : Array.isArray(i) && i.push(o), Ft) {
        let h = (/* @__PURE__ */ new Error()).stack.split(`
`).slice(2, 3).join(`
`).trim(), l = /(file:|vscode-file:\/\/vscode-app)?(\/[^:]*:\d+:\d+)/.exec(h);
        Ft.register(o, l?.[2] ?? h, o);
      }
      return o;
    }), this._event;
  }
...
ps.INSTANCE.onDidChangeZoomLevel;
function go(e) {
  return ps.INSTANCE.getZoomFactor(e);
}
ps.INSTANCE.onDidChangeFullscreen;
var ot = typeof navigator == "object" ? navigator.userAgent : "", zi = ot.indexOf("Firefox") >= 0, $t = ot.indexOf("AppleWebKit") >= 0, gs = ot.indexOf("Chrome") >= 0, mo = !gs && ot.indexOf("Safari") >= 0;
ot.indexOf("Electron/");
ot.indexOf("Android");
var Kt = !1;
...
var Ut = "en", Wi = !1, Fi = !1, qt = !1, jr = !1, Xr = !1, Vt = Ut, Pe, Ae = globalThis, pe;
...
if (typeof pe == "object") {
  Wi = pe.platform === "win32", Fi = pe.platform === "darwin", qt = pe.platform === "linux", qt && pe.env.SNAP && pe.env.SNAP_REVISION, pe.env.CI || pe.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Vt = Ut;
  ...
  jr = !0;
} else typeof navigator == "object" && !So ? (Pe = navigator.userAgent, Wi = Pe.indexOf("Windows") >= 0, Fi = Pe.indexOf("Macintosh") >= 0, (Pe.indexOf("Macintosh") >= 0 || Pe.indexOf("iPad") >= 0 || Pe.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, qt = Pe.indexOf("Linux") >= 0, Pe?.indexOf("Mobi"), Xr = !0, Vt = globalThis._VSCODE_NLS_LANGUAGE || Ut, navigator.language.toLowerCase()) : console.error("Unable to resolve platform.");
var Gr = Wi, Be = Fi, bo = qt, di = jr;
Xr && typeof Ae.importScripts == "function" && Ae.origin;
var Re = Pe, We = Vt, As;
((e) => {
  function t() {
    return We;
...
di || document.queryCommandSupported && document.queryCommandSupported("copy") || Fe && Fe.clipboard && Fe.clipboard.writeText, di || Fe && Fe.clipboard && Fe.clipboard.readText, di || vo() || Fe.keyboard, "ontouchstart" in Se || Fe.maxTouchPoints, Se.PointerEvent && ("ontouchstart" in Se || navigator.maxTouchPoints);
var ms = class {
  constructor() {
...
}, ui = new ms(), Os = new ms(), Is = new ms(), Co = new Array(230), $i;
((e) => {
  function t(h) {
  ...
  e.fromString = i;
  function s(h) {
    return Os.keyCodeToStr(h);
  }
  e.toUserSettingsUS = s;
  function r(h) {
    return Is.keyCodeToStr(h);
  }
  e.toUserSettingsGeneral = r;
  function n(h) {
    return Os.strToKeyCode(h) || Is.strToKeyCode(h);
  }
...
var ko = class Jr {
  ...
  equals(t) {
    return t instanceof Jr && this.ctrlKey === t.ctrlKey && this.shiftKey === t.shiftKey && this.altKey === t.altKey && this.metaKey === t.metaKey && this.keyCode === t.keyCode;
  }
  getHashCode() {
...
var Do = Be ? 256 : 2048, Bo = 512, Ro = 1024, Mo = Be ? 2048 : 256, Ki = class {
  constructor(e) {
  ...
  constructor(e, t = 0, i = 0) {
    ...
    if (e) {
      ...
      if (typeof r.wheelDeltaY < "u") s ? this.deltaY = r.wheelDeltaY / (120 * o) : this.deltaY = r.wheelDeltaY / 120;
        ...
        let h = e;
        h.deltaMode === h.DOM_DELTA_LINE ? zi && !Be ? this.deltaY = -e.deltaY / 3 : this.deltaY = -e.deltaY : this.deltaY = -e.deltaY / 40;
      }
      if (typeof r.wheelDeltaX < "u") mo && Gr ? this.deltaX = -(r.wheelDeltaX / 120) : s ? this.deltaX = r.wheelDeltaX / (120 * o) : this.deltaX = r.wheelDeltaX / 120;
      else if (typeof n.HORIZONTAL_AXIS < "u" && n.axis === n.HORIZONTAL_AXIS) this.deltaX = -e.detail / 3;
      else if (e.type === "wheel") {
        let h = e;
        h.deltaMode === h.DOM_DELTA_LINE ? zi && !Be ? this.deltaX = -e.deltaX / 3 : this.deltaX = -e.deltaX : this.deltaX = -e.deltaX / 40;
      }
...
var To = class {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? Zr : (this._emitter || (this._emitter = new m()), this._emitter.event);
  }
  dispose() {
...
function zo(e, t) {
  return t = Te(104579, t), e.reduce((i, s) => Ss(s, i), t);
}
function Wo(e, t) {
  return t = Te(181387, t), Object.keys(e).sort().reduce((i, s) => (i = Qr(s, i), Ss(e[s], i)), t);
}
function _i(e, t, i = 32) {
  let s = i - t, r = ~((1 << s) - 1);
  return (e << t | (r & e) >>> s) >>> 0;
}
function Ks(e, t = 0, i = e.byteLength, s = 0) {
...
var $o = class en {
  ...
  _step() {
    let t = en._bigBlock32, i = this._buffDV;
...
var { registerWindow: gl, getWindow: Ce, getDocument: ml, getWindows: vl, getWindowsCount: Sl, getWindowId: Ko, getWindowById: bl, hasWindow: wl, onDidRegisterWindow: Uo, onWillUnregisterWindow: yl, onDidUnregisterWindow: Cl } = (function() {
...
(function() {
  let e = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map(), r = (n) => {
    i.set(n, !1);
    let o = e.get(n) ?? [];
    for (t.set(n, o), e.set(n, []), s.set(n, !0); o.length > 0; ) o.sort(qs.sort), o.shift().execute();
    s.set(n, !1);
  };
  bs = (n, o, h = 0) => {
    let l = Ko(n), a = new qs(o, h), d = e.get(l);
...
new class {
  ...
  observe(e, t, i) {
    ...
    if (n) n.users += 1;
      ...
      let o = new m(), h = new MutationObserver((a) => o.fire(a));
      h.observe(e, i);
      let l = n = {
        users: 1,
        observer: h,
...
function Jo(e, t, ...i) {
  return tn("http://www.w3.org/1999/xhtml", e, t, ...i);
}
Jo.SVG = function(e, t, ...i) {
  return tn("http://www.w3.org/2000/svg", e, t, ...i);
};
var Zo = class {
  constructor(e) {
...
var mt = class ae extends R {
  constructor() {
    super(), this.dispatched = !1, this.targets = new Ls(), this.ignoreTargets = new Ls(), this.activeTouches = {}, this.handle = null, this._lastSetTapCountTime = 0, this._register(se.runAndSubscribe(Uo, ({ window: t, disposables: i }) => {
  ...
  static addTarget(t) {
    return ae.isTouchDevice() ? (ae.INSTANCE || (ae.INSTANCE = Ms(new ae())), z(ae.INSTANCE.targets.push(t))) : R.None;
  }
  static ignoreTarget(t) {
    return ae.isTouchDevice() ? (ae.INSTANCE || (ae.INSTANCE = Ms(new ae())), z(ae.INSTANCE.ignoreTargets.push(t))) : R.None;
  }
...
mt.SCROLL_FRICTION = -5e-3, mt.HOLD_DELAY = 700, mt.CLEAR_TAP_COUNT_TIME = 400, q([Qo], mt, "isTouchDevice", 1);
var ea = mt, ws = class extends R {
  onclick(e, t) {
  ...
  onkeydown(e, t) {
    this._register(B(e, Q.KEY_DOWN, (i) => t(new Ki(i))));
  }
  onkeyup(e, t) {
    this._register(B(e, Q.KEY_UP, (i) => t(new Ki(i))));
  }
  oninput(e, t) {
...
}, Ys = 11, ta = class extends ws {
  constructor(e) {
    super(), this._onActivate = e.onActivate, this.bgDomNode = document.createElement("div"), this.bgDomNode.className = "arrow-background", this.bgDomNode.style.position = "absolute", this.bgDomNode.style.width = e.bgWidth + "px", this.bgDomNode.style.height = e.bgHeight + "px", typeof e.top < "u" && (this.bgDomNode.style.top = "0px"), typeof e.left < "u" && (this.bgDomNode.style.left = "0px"), typeof e.bottom < "u" && (this.bgDomNode.style.bottom = "0px"), typeof e.right < "u" && (this.bgDomNode.style.right = "0px"), this.domNode = document.createElement("div"), this.domNode.className = e.className, this.domNode.style.position = "absolute", this.domNode.style.width = Ys + "px", this.domNode.style.height = Ys + "px", typeof e.top < "u" && (this.domNode.style.top = e.top + "px"), typeof e.left < "u" && (this.domNode.style.left = e.left + "px"), typeof e.bottom < "u" && (this.domNode.style.bottom = e.bottom + "px"), typeof e.right < "u" && (this.domNode.style.right = e.right + "px"), this._pointerMoveMonitor = this._register(new sn()), this._register(Us(this.bgDomNode, Q.POINTER_DOWN, (t) => this._arrowPointerDown(t))), this._register(Us(this.domNode, Q.POINTER_DOWN, (t) => this._arrowPointerDown(t))), this._pointerdownRepeatTimer = this._register(new jo()), this._pointerdownScheduleRepeatTimer = this._register(new vs());
  }
  _arrowPointerDown(e) {
  ...
  withScrollDimensions(t, i) {
    return new Ui(this._forceIntegerValues, typeof t.width < "u" ? t.width : this.width, typeof t.scrollWidth < "u" ? t.scrollWidth : this.scrollWidth, i ? this.rawScrollLeft : this.scrollLeft, typeof t.height < "u" ? t.height : this.height, typeof t.scrollHeight < "u" ? t.scrollHeight : this.scrollHeight, i ? this.rawScrollTop : this.scrollTop);
  }
  withScrollPosition(t) {
    return new Ui(this._forceIntegerValues, this.width, this.scrollWidth, typeof t.scrollLeft < "u" ? t.scrollLeft : this.rawScrollLeft, this.height, this.scrollHeight, typeof t.scrollTop < "u" ? t.scrollTop : this.rawScrollTop);
  }
  ...
  constructor(e) {
    super(), this._scrollableBrand = void 0, this._onScroll = this._register(new m()), this.onScroll = this._onScroll.event, this._smoothScrollDuration = e.smoothScrollDuration, this._scheduleAtNextAnimationFrame = e.scheduleAtNextAnimationFrame, this._state = new ia(e.forceIntegerValues, 0, 0, 0, 0, 0, 0), this._smoothScrolling = null;
  }
  dispose() {
  ...
  setScrollPositionSmooth(e, t) {
    ...
    if (this._smoothScrolling) {
      ...
      let s;
      t ? s = new Xs(this._smoothScrolling.from, i, this._smoothScrolling.startTime, this._smoothScrolling.duration) : s = this._smoothScrolling.combine(this._state, i, this._smoothScrollDuration), this._smoothScrolling.dispose(), this._smoothScrolling = s;
    } else {
      let i = this._state.withScrollPosition(e);
      this._smoothScrolling = Xs.start(this._state, i, this._smoothScrollDuration);
    }
...
var Xs = class qi {
  ...
  _tick(t) {
    ...
    return i < 1 ? new js(this.scrollLeft(i), this.scrollTop(i), !1) : new js(this.to.scrollLeft, this.to.scrollTop, !0);
  }
  combine(t, i, s) {
    return qi.start(t, i, s);
  }
  static start(t, i, s) {
    return s = s + 10, new qi(t, i, Date.now() - 10, s);
  }
};
function na(e) {
  return Math.pow(e, 3);
...
var aa = class extends R {
...
}, ha = 140, rn = class extends ws {
  constructor(e) {
    super(), this._lazyRender = e.lazyRender, this._host = e.host, this._scrollable = e.scrollable, this._scrollByPage = e.scrollByPage, this._scrollbarState = e.scrollbarState, this._visibilityController = this._register(new aa(e.visibility, "visible scrollbar " + e.extraScrollbarClassName, "invisible scrollbar " + e.extraScrollbarClassName)), this._visibilityController.setIsNeeded(this._scrollbarState.isNeeded()), this._pointerMoveMonitor = this._register(new sn()), this._shouldRender = !0, this.domNode = yt(document.createElement("div")), this.domNode.setAttribute("role", "presentation"), this.domNode.setAttribute("aria-hidden", "true"), this._visibilityController.setDomNode(this.domNode), this.domNode.setPosition("absolute"), this._register(B(this.domNode.domNode, Q.POINTER_DOWN, (t) => this._domNodePointerDown(t)));
  }
  _createArrow(e) {
  ...
  clone() {
    return new Vi(this._arrowSize, this._scrollbarSize, this._oppositeScrollbarSize, this._visibleSize, this._scrollSize, this._scrollPosition);
  }
  setVisibleSize(t) {
    let i = Math.round(t);
  ...
  _refreshComputedValues() {
    let t = Vi._computeValues(this._oppositeScrollbarSize, this._arrowSize, this._visibleSize, this._scrollSize, this._scrollPosition);
  ...
  constructor(e, t, i) {
    ...
    if (super({
      ...
      host: i,
      scrollbarState: new nn(t.horizontalHasArrows ? t.arrowSize : 0, t.horizontal === 2 ? 0 : t.horizontalScrollbarSize, t.vertical === 2 ? 0 : t.verticalScrollbarSize, s.width, s.scrollWidth, r.scrollLeft),
  ...
  constructor(e, t, i) {
    ...
    if (super({
      lazyRender: t.lazyRender,
      host: i,
      scrollbarState: new nn(t.verticalHasArrows ? t.arrowSize : 0, t.vertical === 2 ? 0 : t.verticalScrollbarSize, 0, s.height, s.scrollHeight, r.scrollTop),
...
Yi.INSTANCE = new Yi();
var _a = Yi, fa = class extends ws {
  constructor(e, t, i) {
    super(), this._onScroll = this._register(new m()), this.onScroll = this._onScroll.event, this._onWillScroll = this._register(new m()), this.onWillScroll = this._onWillScroll.event, this._options = ga(t), this._scrollable = i, this._register(this._scrollable.onScroll((r) => {
  ...
  _onMouseWheel(e) {
    ...
    let t = _a.INSTANCE;
    Js && t.acceptStandardWheelEvent(e);
    let i = !1;
    if (e.deltaY || e.deltaX) {
      ...
      if (r) {
        let a = Gs * r, d = h.scrollTop - (a < 0 ? Math.floor(a) : Math.ceil(a));
        this._verticalScrollbar.writeScrollPosition(l, d);
      }
      if (n) {
        let a = Gs * n, d = h.scrollLeft - (a < 0 ? Math.floor(a) : Math.ceil(a));
        this._horizontalScrollbar.writeScrollPosition(l, d);
      }
      l = this._scrollable.validateScrollPosition(l), (h.scrollLeft !== l.scrollLeft || h.scrollTop !== l.scrollTop) && (Js && this._options.mouseWheelSmoothScroll && t.isPhysicalMouseWheel() ? this._scrollable.setScrollPositionSmooth(l) : this._scrollable.setScrollPositionNow(l), i = !0);
    }
    let s = i;
...
var ji = class extends R {
  constructor(e, t, i, s, r, n, o, h) {
    ...
    let l = this._register(new sa({
      ...
      scheduleAtNextAnimationFrame: (a) => bs(s.window, a)
    }));
  ...
  createRow(e, t, i, s, r, n, o, h, l, a, d) {
    ...
    for (let b = 0; b < u; b++) {
      ...
      if (_.length > 0 && b === _[0][0] && w) {
        ...
        w && (w = !i || n < O[0] || n >= O[1]), w ? (C = !0, S = new va(this._workCell, e.translateToString(!0, O[0], O[1]), O[1] - O[0]), x = O[1] - 1, v = S.getWidth()) : Tt = O[1];
      }
      ...
      if (Me === " " && (S.isUnderline() || S.isOverline()) && (Me = " "), ke = v * h - l.get(Me, S.isBold(), S.isItalic()), !g) g = this._document.createElement("span");
      ...
      switch (Ye) {
        ...
        case 33554432:
          ...
          break;
        case 50331648:
          ze = Y.toColor(le >> 16, le >> 8 & 255, le & 255), this._addStyle(g, `background-color:#${Qs((le >>> 0).toString(16), "0", 6)}`);
          break;
        default:
      ...
      switch (He || S.isDim() && (He = H.multiplyOpacity(ze, 0.5)), Ne) {
        ...
        case 50331648:
          ...
          this._applyMinimumContrast(g, ze, O, S, He, At) || this._addStyle(g, `color:#${Qs(Z.toString(16), "0", 6)}`);
          break;
        default:
...
var pi = "xterm-dom-renderer-owner-", ge = "xterm-rows", It = "xterm-fg-", er = "xterm-bg-", dt = "xterm-focus", Nt = "xterm-selection", Ea = 1, Qi = class extends R {
  ...
  _injectCss(e) {
    ...
    for (let [n, o] of e.ansi.entries()) t += `${this._terminalSelector} .${It}${n} { color: ${o.css}; }${this._terminalSelector} .${It}${n}.xterm-dim { color: ${H.multiplyOpacity(o, 0.5).css}; }${this._terminalSelector} .${er}${n} { background-color: ${o.css}; }`;
    t += `${this._terminalSelector} .${It}257 { color: ${H.opaque(e.background).css}; }${this._terminalSelector} .${It}257.xterm-dim { color: ${H.multiplyOpacity(H.opaque(e.background), 0.5).css}; }${this._terminalSelector} .${er}257 { background-color: ${e.foreground.css}; }`, this._themeStyleElement.textContent = t;
  }
  _setDefaultSpacing() {
...
var on = class extends R {
  ...
  constructor(e, t, i) {
    super(), this._textarea = e, this._window = t, this.mainDocument = i, this._isFocused = !1, this._cachedIsFocused = void 0, this._screenDprMonitor = this._register(new Ma(this._window)), this._onDprChange = this._register(new m()), this.onDprChange = this._onDprChange.event, this._onWindowChange = this._register(new m()), this.onWindowChange = this._onWindowChange.event, this._register(this.onWindowChange((s) => this._screenDprMonitor.setWindow(s))), this._register(se.forward(this._screenDprMonitor.onDprChange, this._onDprChange)), this._register(B(this._textarea, "focus", () => this._isFocused = !0)), this._register(B(this._textarea, "blur", () => this._isFocused = !1));
  }
  get window() {
    return this._window;
  }
  ...
  constructor(e) {
    super(), this._parentWindow = e, this._windowResizeListener = this._register(new rt()), this._onDprChange = this._register(new m()), this.onDprChange = this._onDprChange.event, this._outerListener = () => this._setDprAndFireIfDiffers(), this._currentDevicePixelRatio = this._parentWindow.devicePixelRatio, this._updateDpr(), this._setWindowResizeListener(), this._register(z(() => this.clearListener()));
  }
  setWindow(e) {
...
var ni = typeof process < "u" && "title" in process, Lt = ni ? "node" : navigator.userAgent, Pt = ni ? "node" : navigator.platform, hn = Lt.includes("Firefox"), Aa = Lt.includes("Edge"), ln = /^((?!chrome|android).)*safari/i.test(Lt);
function Oa() {
  if (!ln) return 0;
...
var Zt = [
  ...
  "MacPPC",
  "Mac68K"
].includes(Pt), Ia = Pt === "iPad", Na = Pt === "iPhone", cn = [
  "Windows",
  "Win16",
  "Win32",
  "WinCE"
].includes(Pt), Cs = Pt.indexOf("Linux") >= 0, dn = /\bCrOS\b/.test(Lt), un = class {
  constructor() {
...
function qa(e, t, i, s, r, n) {
  return oi(t, s, r, n).length === 0 ? "" : Dt(fn(e, t, e, t - et(t, r), !1, r).length, Et("D", n));
}
function oi(e, t, i, s) {
  let r = e - et(e, i), n = t - et(t, i);
  return Dt(Math.abs(r - n) - Ya(e, t, i), Et(_n(e, t), s));
}
function Va(e, t, i, s, r, n) {
  let o;
  oi(t, s, r, n).length > 0 ? o = s - et(s, r) : o = t;
  let h = s, l = ja(e, t, i, s, r, n);
  return Dt(fn(e, o, i, h, l === "C", r).length, Et(l, n));
}
function Ya(e, t, i) {
...
var gi = 50, Ga = 15, Ja = 50, Za = 500, Qa = new RegExp(" ", "g"), ss = class extends R {
  ...
  get selectionText() {
    ...
    return s.map((r) => r.replace(Qa, " ")).join(cn ? `\r
` : `
`);
  }
  clearSelection() {
  ...
  refresh(e) {
    this._refreshAnimationFrame || (this._refreshAnimationFrame = this._coreBrowserService.window.requestAnimationFrame(() => this._refresh())), Cs && e && this.selectionText.length && this._onLinuxMouseSelection.fire(this.selectionText);
  }
  _refresh() {
  ...
  _selectWordAtCursor(e, t) {
    ...
    if (i) return this._model.selectionStart = [i.start.x - 1, i.start.y - 1], this._model.selectionStartLength = tr(i, this._bufferService.cols), this._model.selectionEnd = void 0, !0;
  ...
  _getMouseEventScrollAmount(e) {
    let t = ys(this._coreBrowserService.window, e, this._screenElement)[1], i = this._renderService.dimensions.css.canvas.height;
  ...
  _selectLineAt(e) {
    ...
    this._model.selectionStart = [0, t.first], this._model.selectionEnd = void 0, this._model.selectionStartLength = tr(i, this._bufferService.cols);
  }
};
ss = q([
  y(3, ce),
...
var ir = class {
  ...
  constructor() {
    this._color = new ir(), this._css = new ir();
  }
  setCss(e, t, i) {
    this._css.set(e, t, i);
  }
  ...
  return e;
})()), Xe = W.toColor("#ffffff"), vt = W.toColor("#000000"), rr = W.toColor("#ffffff"), nr = vt, ut = {
  css: "rgba(255, 255, 255, 0.3)",
  rgba: 4294967117
}, eh = Xe, rs = class extends R {
  constructor(e) {
    super(), this._optionsService = e, this._contrastCache = new sr(), this._halfContrastCache = new sr(), this._onChangeColors = this._register(new m()), this.onChangeColors = this._onChangeColors.event, this._colors = {
      foreground: Xe,
      background: vt,
      cursor: rr,
      cursorAccent: nr,
      ...
      selectionBackgroundOpaque: H.blend(vt, ut),
      selectionInactiveBackgroundTransparent: ut,
      selectionInactiveBackgroundOpaque: H.blend(vt, ut),
  ...
  _setTheme(e = {}) {
    let t = this._colors;
    if (t.foreground = N(e.foreground, Xe), t.background = N(e.background, vt), t.cursor = H.blend(t.background, N(e.cursor, rr)), t.cursorAccent = H.blend(t.background, N(e.cursorAccent, nr)), t.selectionBackgroundTransparent = N(e.selectionBackground, ut), t.selectionBackgroundOpaque = H.blend(t.background, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundTransparent = N(e.selectionInactiveBackground, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundOpaque = H.blend(t.background, t.selectionInactiveBackgroundTransparent), t.selectionForeground = e.selectionForeground ? N(e.selectionForeground, Zs) : void 0, t.selectionForeground === Zs && (t.selectionForeground = void 0), H.isOpaque(t.selectionBackgroundTransparent) && (t.selectionBackgroundTransparent = H.opacity(t.selectionBackgroundTransparent, 0.3)), H.isOpaque(t.selectionInactiveBackgroundTransparent) && (t.selectionInactiveBackgroundTransparent = H.opacity(t.selectionInactiveBackgroundTransparent, 0.3)), t.scrollbarSliderBackground = N(e.scrollbarSliderBackground, H.opacity(t.foreground, 0.2)), t.scrollbarSliderHoverBackground = N(e.scrollbarSliderHoverBackground, H.opacity(t.foreground, 0.4)), t.scrollbarSliderActiveBackground = N(e.scrollbarSliderActiveBackground, H.opacity(t.foreground, 0.5)), t.overviewRulerBorder = N(e.overviewRulerBorder, eh), t.ansi = X.slice(), t.ansi[0] = N(e.black, X[0]), t.ansi[1] = N(e.red, X[1]), t.ansi[2] = N(e.green, X[2]), t.ansi[3] = N(e.yellow, X[3]), t.ansi[4] = N(e.blue, X[4]), t.ansi[5] = N(e.magenta, X[5]), t.ansi[6] = N(e.cyan, X[6]), t.ansi[7] = N(e.white, X[7]), t.ansi[8] = N(e.brightBlack, X[8]), t.ansi[9] = N(e.brightRed, X[9]), t.ansi[10] = N(e.brightGreen, X[10]), t.ansi[11] = N(e.brightYellow, X[11]), t.ansi[12] = N(e.brightBlue, X[12]), t.ansi[13] = N(e.brightMagenta, X[13]), t.ansi[14] = N(e.brightCyan, X[14]), t.ansi[15] = N(e.brightWhite, X[15]), e.extendedAnsi) {
...
var th = class {
  ...
  constructor() {
    this._services = new th(), this._services.set(_s, this);
  }
  setService(e, t) {
  ...
  error: 4,
  off: 5
}, rh = "xterm.js: ", ns = class extends R {
  constructor(e) {
...
var nh, or = class extends R {
...
}, M = 3, j = Object.freeze(new Rt()), Ht = 0, mi = 2, St = class pn {
  constructor(t, i, s = !1) {
  ...
  resize(t, i) {
    if (t === this.length) return this._data.length * 4 * mi < this._data.buffer.byteLength;
    let s = t * M;
    if (t > this.length) {
    ...
    return this.length = t, s * 4 * mi < this._data.buffer.byteLength;
  }
  cleanupMemory() {
    if (this._data.length * 4 * mi < this._data.buffer.byteLength) {
...
var gn = class mn {
  constructor(t) {
    this.line = t, this.isDisposed = !1, this._disposables = [], this._id = mn._nextId++, this._onDispose = this.register(new m()), this.onDispose = this._onDispose.event;
  }
  get id() {
    return this._id;
  }
...
var ar = 4294967295, hr = class {
  constructor(e, t, i) {
    this._hasScrollback = e, this._optionsService = t, this._bufferService = i, this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.tabs = {}, this.savedY = 0, this.savedX = 0, this.savedCurAttrData = j.clone(), this.savedCharset = Ge, this.markers = [], this._nullCell = be.fromCharData([
      ...
      1,
      32
    ]), this._isClearing = !1, this._memoryCleanupQueue = new Qt(), this._memoryCleanupPosition = 0, this._cols = this._bufferService.cols, this._rows = this._bufferService.rows, this.lines = new or(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
  }
  getNullCell(e) {
  ...
  clear() {
    this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.lines = new or(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
  }
  resize(e, t) {
  ...
  reset() {
    this._normal = new hr(!0, this._optionsService, this._bufferService), this._normal.fillViewportRows(), this._alt = new hr(!1, this._optionsService, this._bufferService), this._activeBuffer = this._normal, this._onBufferActivate.fire({
...
}, vn = 2, Sn = 1, os = class extends R {
  constructor(e) {
    super(), this.isUserScrolling = !1, this._onResize = this._register(new m()), this.onResize = this._onResize.event, this._onScroll = this._register(new m()), this.onScroll = this._onScroll.event, this.cols = Math.max(e.rawOptions.cols || 0, vn), this.rows = Math.max(e.rawOptions.rows || 0, Sn), this.buffers = this._register(new dh(e, this)), this._register(this.buffers.onBufferActivate((t) => {
...
var lr = Object.freeze({ insertMode: !1 }), cr = Object.freeze({
  ...
  constructor(e, t, i) {
    super(), this._bufferService = e, this._logService = t, this._optionsService = i, this.isCursorInitialized = !1, this.isCursorHidden = !1, this._onData = this._register(new m()), this.onData = this._onData.event, this._onUserInput = this._register(new m()), this.onUserInput = this._onUserInput.event, this._onBinary = this._register(new m()), this.onBinary = this._onBinary.event, this._onRequestScrollToBottom = this._register(new m()), this.onRequestScrollToBottom = this._onRequestScrollToBottom.event, this.modes = bt(lr), this.decPrivateModes = bt(cr);
  }
  reset() {
    this.modes = bt(lr), this.decPrivateModes = bt(cr);
  }
...
var Si = String.fromCharCode, ur = {
  ...
  SGR: (e) => {
    ...
    return `\x1B[<${vi(e, !0)};${e.col};${e.row}${t}`;
  },
  SGR_PIXELS: (e) => {
    let t = e.action === 0 && e.button !== 4 ? "m" : "M";
    return `\x1B[<${vi(e, !0)};${e.x};${e.y}${t}`;
  }
}, hs = class extends R {
  constructor(e, t, i) {
    ...
    for (let s of Object.keys(dr)) this.addProtocol(s, dr[s]);
    for (let s of Object.keys(ur)) this.addEncoding(s, ur[s]);
    this.reset();
  }
  addProtocol(e, t) {
    this._protocols[e] = t;
...
var mh = class {
  constructor() {
    if (this.version = "6", !G) {
      G = new Uint8Array(65536), G.fill(1), G[0] = 0, G.fill(0, 1, 32), G.fill(0, 127, 160), G.fill(2, 4352, 4448), G[9001] = 2, G[9002] = 2, G.fill(2, 11904, 42192), G[12351] = 1, G.fill(2, 44032, 55204), G.fill(2, 63744, 64256), G.fill(2, 65040, 65050), G.fill(2, 65072, 65136), G.fill(2, 65280, 65377), G.fill(2, 65504, 65511);
...
var _t = 2147483647, Sh = 256, bn = class ls {
  ...
  clone() {
    let t = new ls(this.maxLength, this.maxSubParamsLength);
...
var fr = class {
  ...
  return e.addMany(r, 0, 3, 0), e.addMany(r, 1, 3, 1), e.add(127, 1, 0, 1), e.addMany(r, 8, 0, 8), e.addMany(r, 3, 3, 3), e.add(127, 3, 0, 3), e.addMany(r, 4, 3, 4), e.add(127, 4, 0, 4), e.addMany(r, 6, 3, 6), e.addMany(r, 5, 3, 5), e.add(127, 5, 0, 5), e.addMany(r, 2, 3, 2), e.add(127, 2, 0, 2), e.add(93, 1, 4, 8), e.addMany(s, 8, 5, 8), e.add(127, 8, 5, 8), e.addMany([
    ...
    24,
    26
  ], 13, 14, 0), e.add(ve, 0, 2, 0), e.add(ve, 8, 5, 8), e.add(ve, 6, 0, 6), e.add(ve, 11, 0, 11), e.add(ve, 13, 13, 13), e;
})(), kh = class extends R {
  constructor(e = Ch) {
    super(), this._transitions = e, this._parseStack = {
      ...
      transition: 0,
      chunkPos: 0
    }, this.initialState = 0, this.currentState = this.initialState, this._params = new bn(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0, this._printHandlerFb = (t, i, s) => {
  ...
  parse(e, t, i) {
    ...
    for (let h = n; h < t; ++h) {
      switch (s = e[h], r = this._transitions.table[this.currentState << 8 | (s < 160 ? s : ve)], r >> 4) {
        case 2:
          for (let _ = h + 1; ; ++_) {
            if (_ >= t || (s = e[_]) < 32 || s > 126 && s < ve) {
        ...
        case 12:
          ...
          break;
        case 13:
          for (let _ = h + 1; ; ++_) if (_ >= t || (s = e[_]) === 24 || s === 26 || s === 27 || s > 127 && s < ve) {
        ...
        case 4:
          ...
          break;
        case 5:
          for (let _ = h + 1; ; _++) if (_ >= t || (s = e[_]) < 32 || s > 127 && s < ve) {
...
var vr = 5e3, Sr = 0, Rh = class extends R {
  constructor(e, t, i, s, r, n, o, h, l = new kh()) {
    super(), this._bufferService = e, this._charsetService = t, this._coreService = i, this._logService = s, this._optionsService = r, this._oscLinkService = n, this._coreMouseService = o, this._unicodeService = h, this._parser = l, this._parseBuffer = new Uint32Array(4096), this._stringDecoder = new Ln(), this._utf8Decoder = new Pn(), this._windowTitle = "", this._iconName = "", this._windowTitleStack = [], this._iconNameStack = [], this._curAttrData = j.clone(), this._eraseAttrDataInternal = j.clone(), this._onRequestBell = this._register(new m()), this.onRequestBell = this._onRequestBell.event, this._onRequestRefreshRows = this._register(new m()), this.onRequestRefreshRows = this._onRequestRefreshRows.event, this._onRequestReset = this._register(new m()), this.onRequestReset = this._onRequestReset.event, this._onRequestSendFocus = this._register(new m()), this.onRequestSendFocus = this._onRequestSendFocus.event, this._onRequestSyncScrollBar = this._register(new m()), this.onRequestSyncScrollBar = this._onRequestSyncScrollBar.event, this._onRequestWindowsOptionsReport = this._register(new m()), this.onRequestWindowsOptionsReport = this._onRequestWindowsOptionsReport.event, this._onA11yChar = this._register(new m()), this.onA11yChar = this._onA11yChar.event, this._onA11yTab = this._register(new m()), this.onA11yTab = this._onA11yTab.event, this._onCursorMove = this._register(new m()), this.onCursorMove = this._onCursorMove.event, this._onLineFeed = this._register(new m()), this.onLineFeed = this._onLineFeed.event, this._onScroll = this._register(new m()), this.onScroll = this._onScroll.event, this._onTitleChange = this._register(new m()), this.onTitleChange = this._onTitleChange.event, this._onColor = this._register(new m()), this.onColor = this._onColor.event, this._parseStack = {
      ...
      257,
      258
    ], this._register(this._parser), this._dirtyRowTracker = new cs(this._bufferService), this._activeBuffer = this._bufferService.buffer, this._register(this._bufferService.buffers.onBufferActivate((a) => this._activeBuffer = a.activeBuffer)), this._parser.setCsiHandlerFallback((a, d) => {
    ...
    this._parser.registerEscHandler({
      ...
      intermediates: "$",
      final: "q"
    }, new fr((a, d) => this.requestStatusString(a, d)));
  }
  getAttrData() {
  ...
  _logSlowResolvingAsync(e) {
    this._logService.logLevel <= 3 && Promise.race([e, new Promise((t, i) => setTimeout(() => i("#SLOW_TIMEOUT"), vr))]).catch((t) => {
      if (t !== "#SLOW_TIMEOUT") throw t;
      console.warn(`async parser handler taking longer than ${vr} ms`);
    });
  }
  _getCurrentLinkId() {
  ...
  registerCsiHandler(e, t) {
    return e.final === "t" && !e.prefix && !e.intermediates ? this._parser.registerCsiHandler(e, (i) => mr(i.params[0], this._optionsService.rawOptions.windowOptions) ? t(i) : !0) : this._parser.registerCsiHandler(e, t);
  }
  registerDcsHandler(e, t) {
    return this._parser.registerDcsHandler(e, new fr(t));
  }
  registerEscHandler(e, t) {
  ...
  windowOptions(e) {
    if (!mr(e.params[0], this._optionsService.rawOptions.windowOptions)) return !0;
    ...
    switch (e.params[0]) {
      ...
      case 18:
        ...
        break;
      case 22:
        (t === 0 || t === 2) && (this._windowTitleStack.push(this._windowTitle), this._windowTitleStack.length > gr && this._windowTitleStack.shift()), (t === 0 || t === 1) && (this._iconNameStack.push(this._iconName), this._iconNameStack.length > gr && this._iconNameStack.shift());
        break;
      case 23:
  ...
  markRangeDirty(e, t) {
    e > t && (Sr = e, e = t, t = Sr), e < this.start && (this.start = e), t > this.end && (this.end = t);
  }
  markAllDirty() {
...
var Mh = 5e7, wr = 12, Lh = 50, Ph = class extends R {
  constructor(e) {
  ...
  _innerWrite(e = 0, t = !0) {
    ...
    for (; this._writeBuffer.length > this._bufferOffset; ) {
      ...
      if (r) {
        let o = (h) => performance.now() - i >= wr ? setTimeout(() => this._innerWrite(0, h)) : this._innerWrite(i, h);
      ...
      if (n && n(), this._bufferOffset++, this._pendingData -= s.length, performance.now() - i >= wr) break;
    }
...
ds = q([y(0, ce)], ds);
var yr = !1, Th = class extends R {
  constructor(e) {
    super(), this._windowsWrappingHeuristics = this._register(new rt()), this._onBinary = this._register(new m()), this.onBinary = this._onBinary.event, this._onData = this._register(new m()), this.onData = this._onData.event, this._onLineFeed = this._register(new m()), this.onLineFeed = this._onLineFeed.event, this._onResize = this._register(new m()), this.onResize = this._onResize.event, this._onWriteParsed = this._register(new m()), this.onWriteParsed = this._onWriteParsed.event, this._onScroll = this._register(new m()), this._instantiationService = new ih(), this.optionsService = this._register(new _h(e)), this._instantiationService.setService(de, this.optionsService), this._bufferService = this._register(this._instantiationService.createInstance(os)), this._instantiationService.setService(ce, this._bufferService), this._logService = this._register(this._instantiationService.createInstance(ns)), this._instantiationService.setService(Or, this._logService), this.coreService = this._register(this._instantiationService.createInstance(as)), this._instantiationService.setService(tt, this.coreService), this.coreMouseService = this._register(this._instantiationService.createInstance(hs)), this._instantiationService.setService(Ar, this.coreMouseService), this.unicodeService = this._register(this._instantiationService.createInstance(Je)), this._instantiationService.setService(In, this.unicodeService), this._charsetService = this._instantiationService.createInstance(vh), this._instantiationService.setService(On, this._charsetService), this._oscLinkService = this._instantiationService.createInstance(ds), this._instantiationService.setService(Ir, this._oscLinkService), this._inputHandler = this._register(new Rh(this._bufferService, this._charsetService, this.coreService, this._logService, this.optionsService, this._oscLinkService, this.coreMouseService, this.unicodeService)), this._register(se.forward(this._inputHandler.onLineFeed, this._onLineFeed)), this._register(this._inputHandler), this._register(se.forward(this._bufferService.onResize, this._onResize)), this._register(se.forward(this.coreService.onData, this._onData)), this._register(se.forward(this.coreService.onBinary, this._onBinary)), this._register(this.coreService.onRequestScrollToBottom(() => this.scrollToBottom(!0))), this._register(this.coreService.onUserInput(() => this._writeBuffer.handleUserInput())), this._register(this.optionsService.onMultipleOptionChange(["windowsMode", "windowsPty"], () => this._handleWindowsPtyOptionChange())), this._register(this._bufferService.onScroll(() => {
  ...
  writeSync(e, t) {
    this._logService.logLevel <= 3 && !yr && (this._logService.warn("writeSync is unreliable and will be removed soon."), yr = !0), this._writeBuffer.writeSync(e, t);
  }
  input(e, t = !0) {
    this.coreService.triggerDataEvent(e, t);
  }
  resize(e, t) {
    isNaN(e) || isNaN(t) || (e = Math.max(e, vn), t = Math.max(t, Sn), this._bufferService.resize(e, t));
  }
  scroll(e, t = !1) {
  ...
  _enableWindowsWrappingHeuristics() {
    if (!this._windowsWrappingHeuristics.value) {
      let e = [];
      e.push(this.onLineFeed(_r.bind(null, this._bufferService))), e.push(this.registerCsiHandler({ final: "H" }, () => (_r(this._bufferService), !1))), this._windowsWrappingHeuristics.value = z(() => {
...
}, yi = 0, Cr = 0, Nh = class extends R {
  constructor() {
    super(), this._decorations = new Ih((e) => e?.marker.line), this._onDecorationRegistered = this._register(new m()), this.onDecorationRegistered = this._onDecorationRegistered.event, this._onDecorationRemoved = this._register(new m()), this.onDecorationRemoved = this._onDecorationRemoved.event, this._register(z(() => this.reset()));
  }
  get decorations() {
  ...
  *getDecorationsAtCell(e, t, i) {
  ...
  forEachDecorationAtCell(e, t, i, s) {
    this._decorations.forEachByKey(t, (r) => {
      yi = r.options.x ?? 0, Cr = yi + (r.options.width ?? 1), e >= yi && e < Cr && (!i || (r.options.layer ?? "bottom") === i) && s(r);
    });
  }
}, Hh = class extends Ve {
  constructor(e) {
  ...
  constructor(e, t, i, s) {
    ...
    xr ? (this._accessibilityContainer.classList.add("debug"), this._rowContainer.classList.add("debug"), this._debugRootContainer = r.createElement("div"), this._debugRootContainer.classList.add("xterm"), this._debugRootContainer.appendChild(r.createTextNode("------start a11y------")), this._debugRootContainer.appendChild(this._accessibilityContainer), this._debugRootContainer.appendChild(r.createTextNode("------end a11y------")), this._terminal.element.insertAdjacentElement("afterend", this._debugRootContainer)) : this._terminal.element.insertAdjacentElement("afterbegin", this._accessibilityContainer), this._register(this._terminal.onResize((n) => this._handleResize(n.rows))), this._register(this._terminal.onRender((n) => this._refreshRows(n.start, n.end))), this._register(this._terminal.onScroll(() => this._refreshRows())), this._register(this._terminal.onA11yChar((n) => this._handleChar(n))), this._register(this._terminal.onLineFeed(() => this._handleChar(`
`))), this._register(this._terminal.onA11yTab((n) => this._handleTab(n))), this._register(this._terminal.onKey((n) => this._handleKey(n.key))), this._register(this._terminal.onBlur(() => this._clearLiveRegion())), this._register(this._renderService.onDimensionsChange(() => this._refreshRowsDimensions())), this._register(B(r, "selectionchange", () => this._handleSelectionChange())), this._register(this._coreBrowserService.onDprChange(() => this._refreshRowsDimensions())), this._refreshRowsDimensions(), this._refreshRows(), this._register(z(() => {
      xr ? this._debugRootContainer.remove() : this._accessibilityContainer.remove(), this._rowElements.length = 0;
    }));
  }
  _handleTab(e) {
  ...
  _handleChar(e) {
    this._liveRegionLineCount < kr + 1 && (this._charsToConsume.length > 0 ? this._charsToConsume.shift() !== e && (this._charsToAnnounce += e) : this._charsToAnnounce += e, e === `
` && (this._liveRegionLineCount++, this._liveRegionLineCount === kr + 1 && (this._liveRegion.textContent += ki.get())));
  }
  _clearLiveRegion() {
...
var $h = class extends Th {
    ...
    if (this._themeService) for (let t of e) {
      ...
      switch (t.type) {
        case 0:
          ...
          this.coreService.triggerDataEvent(`${p.ESC}]${s};${Dh(r)}${Gi.ST}`);
          break;
        case 1:
  ...
  _initGlobal() {
    ...
    this._register(B(this.textarea, "paste", e)), this._register(B(this.element, "paste", e)), hn ? this._register(B(this.element, "mousedown", (t) => {
      t.button === 2 && Es(t, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
    })) : this._register(B(this.element, "contextmenu", (t) => {
      Es(t, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
    })), Cs && this._register(B(this.element, "auxclick", (t) => {
      t.button === 1 && Rr(t, this.textarea, this.screenElement);
    }));
  }
  _bindKeys() {
  ...
  _createRenderer() {
    return this._instantiationService.createInstance(Qi, this, this._document, this.element, this.screenElement, this._viewportElement, this._helperContainer, this.linkifier);
  }
  bindMouse() {
  ...
  paste(e) {
    Br(e, this.textarea, this.coreService, this.optionsService);
  }
...
var Uh = class {
  ...
  constructor(e) {
    super(), this._core = e, this._onBufferChange = this._register(new m()), this.onBufferChange = this._onBufferChange.event, this._normal = new Er(this._core.buffers.normal, "normal"), this._alternate = new Er(this._core.buffers.alt, "alternate"), this._core.buffers.onBufferActivate(() => this._onBufferChange.fire(this.active));
  }
  get active() {
...
`, t);
  ...
  const i = window.location.protocol === "https:" ? "wss:" : "ws:", s = wn(e), r = il(t);
...
//# sourceMappingURL=repl-panel-kCaQyUyH.js.map