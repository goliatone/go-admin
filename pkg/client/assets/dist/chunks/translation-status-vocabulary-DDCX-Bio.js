...
function z(e, t = 0) {
  return !e || t > 2 ? "" : p(e.reason_code) || p(e.textCode) || p(e.text_code) || z(e.error ?? void 0, t + 1);
}
function _(e) {
...
function $(e) {
  ...
  const t = e;
  if (!E(t)) return null;
  const s = _({ reason_code: t.reason_code }), a = { enabled: typeof t.enabled == "boolean" ? t.enabled : !1 }, n = l(t.reason), i = l(t.severity), g = l(t.kind), u = l(t.permission), b = t.metadata && typeof t.metadata == "object" && !Array.isArray(t.metadata) ? t.metadata : null, d = I(t.remediation), k = R(t.available_transitions);
  return n && (a.reason = n), s && (a.reason_code = s), i && (a.severity = i), g && (a.kind = g), u && (a.permission = u), b && (a.metadata = b), d && (a.remediation = d), k && (a.available_transitions = k), a;
}
function S(e) {
  if (!c(e)) return {};
  const t = e, s = {};
...
function H(e, t) {
  const s = l(t);
  return s && S(e._action_state)[s] || null;
}
var r = {
...
function G(e) {
  switch (e) {
    ...
    case "exchange":
      return [...Object.keys(h), ...Object.keys(A)];
    default:
      return [];
  }
}
...
function O(e, t = {}) {
  ...
  if (!s) return `<span class="inline-flex items-center px-2 py-1 text-xs rounded bg-gray-100 text-gray-500">${o(e)}</span>`;
...
function P(e, t = {}) {
  ...
  }, b = n ? `<svg class="${a === "sm" ? "w-3.5 h-3.5" : "w-4 h-4"}" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
        <path fill-rule="evenodd" d="${s.icon}" clip-rule="evenodd"/>
      </svg>` : "", d = i ? s.message : s.shortMessage;
...
//# sourceMappingURL=translation-status-vocabulary-DDCX-Bio.js.map