var l = "iconoir", o = "var(--sidebar-icon-size, 20px)", u = ["https:"], d = [
  "image/svg+xml",
  "image/png",
  "image/jpeg",
  "image/webp",
...
function f(e, t, r) {
  ...
  return `<span class="${`flex-shrink-0${r ? " " + r : ""}`}" style="${n}">${k(e)}</span>`;
}
function v(e, t, r, n) {
...
function b(e, t, r, n) {
  ...
  return `<img src="${L(i)}" class="${a}" style="${s}" alt="" aria-hidden="true">`;
}
function w(e, t) {
  if (e = e.trim(), !e || e.toLowerCase().startsWith("javascript:")) return null;
  if (e.startsWith("data:")) return $(e, t);
  try {
    const r = new URL(e);
...
//# sourceMappingURL=icon-renderer-BSHLmdoQ.js.map