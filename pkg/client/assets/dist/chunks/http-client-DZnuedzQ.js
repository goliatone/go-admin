const f = /* @__PURE__ */ new Set(["POST", "PUT", "PATCH", "DELETE"]);
function u() {
...
function p(e, r, t) {
  if (!d(r.method) || t.has("X-CSRF-Token") || !m(e))
    return;
  const o = u();
...
async function y(e, r = {}) {
  ...
  c ? n.set("Accept", c) : n.has("Accept") || n.set("Accept", "application/json"), o && o.trim() && n.set("X-Idempotency-Key", o.trim());
  let a = i.body;
  return t !== void 0 && (n.has("Content-Type") || n.set("Content-Type", "application/json"), a = JSON.stringify(t)), p(e, i, n), fetch(e, {
    ...i,
    headers: n,
    body: a
  });
...
//# sourceMappingURL=http-client-DZnuedzQ.js.map
