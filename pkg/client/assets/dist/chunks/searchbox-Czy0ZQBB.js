...
var l = {
  ...
  async search(e, s) {
    ...
    return this.items.filter((a) => this.config.searchFields.some((n) => {
      const t = a[n];
      if (t == null) return !1;
      const c = String(t);
...
//# sourceMappingURL=searchbox-Czy0ZQBB.js.map