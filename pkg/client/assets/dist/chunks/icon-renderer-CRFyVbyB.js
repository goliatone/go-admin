...
var a = d("IconRenderer"), s = "iconoir", m = "var(--sidebar-icon-size, 20px)", f = ["https:"], h = [
  "image/svg+xml",
  "image/png",
  "image/jpeg",
  "image/webp",
...
function x(e, t, r) {
  ...
  return `<span class="${`flex-shrink-0${r ? " " + r : ""}`}" style="${n}">${g(e)}</span>`;
}
function $(e, t, r, n) {
  const i = k(e, t);
...
function E(e, t, r, n) {
  ...
  return `<img src="${p(i)}" class="${c}" style="${l}" alt="" aria-hidden="true">`;
}
function S(e, t) {
...
//# sourceMappingURL=icon-renderer-CRFyVbyB.js.map