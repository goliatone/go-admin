import { s as u, t as i, u as g } from "./dom-helpers-CDdChTSn.js";
var s = "[data-lineage-card]", E = "[data-evidence-toggle]", f = '[data-evidence-item="collapsed"]', c = "[data-evidence-container]";
function d(e) {
  ...
  t._evidenceToggleCleanup = u(t, "click", () => {
...
function l(e = {}) {
  ...
  if (t.enableEvidenceToggle) {
    ...
    if (!n) return;
    n.querySelectorAll(c).forEach((a) => {
...
//# sourceMappingURL=provenance-card-Bq_8fLFt.js.map