...
import { t as m } from "./modal-coordinator-Ctk09F2l.js";
var d = Object.freeze({
  root: "go-admin-modal",
  ...
  async show() {
    ...
    try {
      ...
      this.container = r, r.className = [
        ...
        s,
        l
      ].filter(Boolean).join(" "), r.setAttribute("data-go-admin-modal", "true"), r.setAttribute("data-size", o), r.setAttribute("role", "dialog"), r.setAttribute("aria-modal", "true"), this._layer = m({
        container: r,
        zIndexTarget: i,
  ...
  _applyAccessibleName() {
    if (this.container) {
      if (this.container.removeAttribute("aria-label"), this.container.removeAttribute("aria-labelledby"), this.container.removeAttribute("aria-describedby"), this._options.labelledBy) this.container.setAttribute("aria-labelledby", this._options.labelledBy);
        ...
        e ? (e.id || (e.id = `go-admin-modal-title-${++p}`), this.container.setAttribute("aria-labelledby", e.id)) : (this.container.setAttribute("aria-label", "Dialog"), console.warn("Modal opened without labelledBy, ariaLabel, or heading; using fallback accessible name."));
      }
...
}, b = "w-full border rounded-lg bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:border-gray-600 dark:bg-slate-800 dark:text-white dark:placeholder-gray-500 px-3 py-2 text-sm border-gray-300", f = 0, k = class extends h {
  constructor(e) {
    super({
      size: "sm",
  ...
  renderContent() {
    const e = this.config.inputClass ?? b;
    return `
...
//# sourceMappingURL=modal-BQ_g-w1L.js.map