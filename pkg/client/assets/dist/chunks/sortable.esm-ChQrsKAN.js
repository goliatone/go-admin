...
function Le(o) {
  ...
  if (t = t || n && n[x], !!t) {
    ...
    var A = z(z({}, y), Ot.getEventProperties(e, t));
...
var f, S, g, _, at, Ft, D, J, ft, X, Dt, Q, At, O, ut = !1, Bt = !1, Ht = [], it, H, $t, Ut, he, pe, bt, st, St, Tt = !1, Pt = !1, Rt, I, qt = [], Jt = !1, Wt = [], Lt = typeof document < "u", Nt = oe, ge = Ct || V ? "cssFloat" : "float", je = Lt && !ve && !oe && "draggable" in document.createElement("div"), Te = (function() {
  if (Lt) {
    if (V) return !1;
...
p.prototype = {
  ...
  _prepareDragStart: function(t, n, e) {
    ...
    if (e && !f && e.parentNode === r) {
      var u = C(e);
      if (_ = r, f = e, S = f.parentNode, at = f.nextSibling, Ft = e, At = a.group, p.dragged = f, it = {
        target: f,
        clientX: (n || t).clientX,
        clientY: (n || t).clientY
  ...
  _onTouchMove: function(t) {
    if (it) {
      var n = this.options, e = n.fallbackTolerance, i = n.fallbackOffset, r = t.touches ? t.touches[0] : t, a = g && ct(g, !0), l = g && a && a.a, s = g && a && a.d, u = Nt && I && de(I), d = (r.clientX - it.clientX + i.x) / (l || 1) + (u ? u[0] - qt[0] : 0) / (l || 1), c = (r.clientY - it.clientY + i.y) / (s || 1) + (u ? u[1] - qt[1] : 0) / (s || 1);
      if (!p.active && !ut) {
  ...
  _appendGhost: function() {
    if (!g) {
      ...
      if (Nt) {
        for (I = t; h(I, "position") === "static" && h(I, "transform") === "none" && I !== document; ) I = I.parentNode;
  ...
  _onDragOver: function(t) {
    var n = this.el, e = t.target, i, r, a, l = this.options, s = l.group, u = p.active, d = At === s, c = l.sort, b = O || u, w, y = this, E = !1;
    if (Jt) return;
    function k(vt, Ne) {
      N(vt, y, z({
        evt: t,
    ...
    if (f.contains(t.target) || e.animated && e.animatingX && e.animatingY || y._ignoreWhileAnimating === e) return A(!1);
    if (Bt = !1, u && !l.disabled && (d ? c || (a = S !== _) : O === this || (this.lastPutMode = At.checkPull(this, u, f, t)) && s.checkPut(this, u, f, t))) {
      ...
      if (!M || Qe(t, w, this) && !M.animated) {
        ...
        if (e = et, r = C(e), xt(_, n, f, i, e, r, t, !1) !== !1)
          return j(), n.insertBefore(f, et), S = n, B(), A(!0);
        ...
        Z = G === 1;
        var It = xt(_, n, f, i, e, r, t, Z);
        if (It !== !1)
          return (It === 1 || It === -1) && (Z = It === 1), Jt = !0, setTimeout(Ke, 30), j(), Z && !mt ? n.appendChild(f) : e.parentNode.insertBefore(f, Z ? mt : e), K && _e(K, 0, gt - K.scrollTop), S = f.parentNode, nt !== void 0 && !Pt && (Rt = Math.abs(nt - C(e)[pt])), B(), A(!0);
      }
  ...
  _nulling: function() {
    N("nulling", this), _ = f = S = g = at = D = Ft = J = it = H = bt = X = Q = ft = Dt = st = St = O = At = p.dragged = p.ghost = p.clone = p.active = null, Wt.forEach(function(t) {
      t.checked = !0;
    }), Wt.length = $t = Ut = 0;
  },
...
var Qt = we(function(o, t, n, e) {
  if (t.scroll) {
    ...
    var c = 0, b = yt;
    do {
      var w = b, y = C(w), E = y.top, k = y.bottom, j = y.left, A = y.right, B = y.width, M = y.height, et = void 0, G = void 0, nt = w.scrollWidth, ht = w.scrollHeight, F = h(w), pt = w.scrollLeft, K = w.scrollTop;
      ...
      var gt = et && (Math.abs(A - i) <= a && pt + B < nt) - (Math.abs(j - i) <= a && !!pt), $ = G && (Math.abs(k - r) <= a && K + M < ht) - (Math.abs(E - r) <= a && !!K);
      if (!T[c])
...
//# sourceMappingURL=sortable.esm-ChQrsKAN.js.map