...
var C = "rounded-xl border px-3 py-3 text-sm", L = "font-semibold", O = "text-xs", S = {
  event: "neutral",
  review: "warning",
  qa: "error",
  success: "success"
...
var c = "rounded-xl border px-3 py-3 text-sm bg-white", I = "rounded-xl border p-5";
function ur(r) {
  return r === "blocker" ? {
...
var Nr = "iconoir:copy", Mr = "iconoir:clock", hr = "iconoir:page";
export {
  t as $,
  Ir as A,
  mr as B,
...
//# sourceMappingURL=translation-shared-DxbdCW0D.js.map