...
const X = "bg-white border border-gray-200 rounded-xl mb-4 p-4 shadow-sm", w = "h-10 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 transition-colors", we = "h-10 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-blue-500 bg-blue-50 text-blue-600 shadow-sm hover:bg-blue-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 transition-colors", U = "h-10 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-blue-600 bg-blue-600 text-white shadow-sm hover:bg-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 transition-colors", Z = "block w-full h-10 ps-9 pe-8 border border-gray-200 rounded-lg text-sm placeholder-gray-500 focus:outline-none focus:ring-0 focus:border-gray-200", B = "block w-full h-10 rounded-lg border border-gray-200 bg-white py-2 px-3 text-sm text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500", ee = "inline-flex items-center gap-2 h-10 rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-700 cursor-pointer hover:bg-gray-50", N = "bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden", g = "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", f = "px-6 py-4 align-top", ke = "rounded-lg border border-gray-200 bg-gray-50 p-4", Ce = "rounded-xl border border-gray-200 bg-white p-6";
function F(t = "refresh", e = "Refresh") {
  return `
...
function re() {
  ...
  if (!t || !e)
    return null;
  Te(document);
  const s = E("esign-page-config", null, {
    onError: (a) => console.warn("[SourceManagementRuntime] Failed to parse esign-page-config:", a)
  }), n = E("source-management-page-model", null, {
    onError: (a) => console.warn("[SourceManagementRuntime] Failed to parse source-management-page-model:", a)
  }), r = String(s?.page ?? t.dataset.esignPage ?? "").trim();
  if (!r)
    return null;
  const i = new Le({
    page: r,
...
function He() {
  ...
  const n = E("esign-page-config", null, {
    onError: (d) => console.warn("[SourceManagementRuntime] Failed to parse esign-page-config:", d)
  }), r = E("source-management-page-model", null, {
    onError: (d) => console.warn("[SourceManagementRuntime] Failed to parse source-management-page-model:", d)
  });
