...
function z(o) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? se(Object(n), !0).forEach(function(e) {
      Me(o, e, n[e]);
...
function W(o, t, n, e) {
  if (o) {
    n = n || document;
    do {
      if (t != null && (t[0] === ">" ? o.parentNode === n && kt(o, t) : kt(o, t)) || e && o === n) return o;
      if (o === n) break;
    } while (o = ye(o));
  }
  return null;
...
var fe = /\s+/g;
function R(o, t, n) {
  o && t && (o.classList ? o.classList[n ? "add" : "remove"](t) : o.className = ((" " + o.className + " ").replace(fe, " ").replace(" " + t + " ", " ") + (n ? " " + t : "")).replace(fe, " "));
}
function h(o, t, n) {
  var e = o && o.style;
  if (e) {
...
function ce(o, t, n) {
  for (var e = tt(o, !0), i = C(o)[t]; e; ) {
    var r = C(e)[n], a = void 0;
    if (n === "top" || n === "left" ? a = i >= r : a = i <= r, !a) return e;
    if (e === L()) break;
    e = tt(e, !1);
  }
  return !1;
...
function dt(o, t, n, e) {
  for (var i = 0, r = 0, a = o.children; r < a.length; ) {
    if (a[r].style.display !== "none" && a[r] !== p.ghost && (e || a[r] !== p.dragged) && W(a[r], n.draggable, o, !1)) {
      if (i === t) return a[r];
      i++;
    }
    r++;
...
function ie(o, t) {
  for (var n = o.lastElementChild; n && (n === p.ghost || h(n, "display") === "none" || t && !kt(n, t)); ) n = n.previousElementSibling;
  return n || null;
}
function Y(o, t) {
  var n = 0;
  if (!o || !o.parentNode) return -1;
  for (; o = o.previousElementSibling; ) o.nodeName.toUpperCase() !== "TEMPLATE" && o !== p.clone && (!t || kt(o, t)) && n++;
  return n;
}
function de(o) {
  var t = 0, n = 0, e = L();
...
function Ye(o, t) {
  for (var n in o)
    if (o.hasOwnProperty(n)) {
      for (var e in t) if (t.hasOwnProperty(e) && t[e] === o[n][e]) return Number(n);
    }
  return -1;
}
function tt(o, t) {
...
function Se(o, t, n) {
  ...
  return Array.from(o.children).forEach(function(i) {
    var r, a, l, s;
    if (!(!W(i, t.draggable, o, !1) || i.animated || i === n)) {
      var u = C(i);
  ...
  return {
    ...
    animateAll: function(e) {
      ...
      o.forEach(function(l) {
        ...
        E && (c.top -= E.f, c.left -= E.e), u.toRect = c, u.thisAnimationDuration && zt(b, c) && !zt(d, c) && (y.top - c.top) / (y.left - c.left) === (d.top - c.top) / (d.left - c.left) && (s = Ge(y, b, w, i.options)), zt(c, d) || (u.prevFromRect = d, u.prevToRect = c, s || (s = i.options.animation), i.animate(u, y, c, s)), s && (r = !0, a = Math.max(a, s), clearTimeout(u.animationResetTimer), u.animationResetTimer = setTimeout(function() {
    ...
    animate: function(e, i, r, a) {
      if (a) {
        ...
        e.animatingX = !!d, e.animatingY = !!c, h(e, "transform", "translate3d(" + d + "px," + c + "px,0)"), this.forRepaintDummy = We(e), h(e, "transition", "transform " + a + "ms" + (this.options.easing ? " " + this.options.easing : "")), h(e, "transform", "translate3d(0,0,0)"), typeof e.animated == "number" && clearTimeout(e.animated), e.animated = setTimeout(function() {
          h(e, "transition", ""), h(e, "transform", ""), e.animated = !1, e.animatingX = !1, e.animatingY = !1;
        }, a);
      }
    }
  };
...
var lt = [], jt = { initializeByDefault: !0 }, Ot = {
  mount: function(t) {
    for (var n in jt) jt.hasOwnProperty(n) && !(n in t) && (t[n] = jt[n]);
...
function Le(o) {
  var t = o.sortable, n = o.rootEl, e = o.name, i = o.targetEl, r = o.cloneEl, a = o.toEl, l = o.fromEl, s = o.oldIndex, u = o.newIndex, d = o.oldDraggableIndex, c = o.newDraggableIndex, b = o.originalEvent, w = o.putSortable, y = o.extraEventProperties;
  if (t = t || n && n[x], !!t) {
    var E, k = t.options, j = "on" + e.charAt(0).toUpperCase() + e.substr(1);
    window.CustomEvent && !V && !Ct ? E = new CustomEvent(e, {
      bubbles: !0,
      cancelable: !0
    }) : (E = document.createEvent("Event"), E.initEvent(e, !0, !0)), E.to = a || n, E.from = l || n, E.item = i || n, E.clone = r, E.oldIndex = s, E.newIndex = u, E.oldDraggableIndex = d, E.newDraggableIndex = c, E.originalEvent = b, E.pullMode = w ? w.lastPutMode : void 0;
    var I = z(z({}, y), Ot.getEventProperties(e, t));
    for (var B in I) E[B] = I[B];
    n && n.dispatchEvent(E), k[j] && k[j].call(t, E);
  }
}
var ze = ["evt"], N = function(t, n) {
  var e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, i = e.evt, r = Re(e, ze);
  Ot.pluginEvent.bind(p)(t, n, z({
    dragEl: f,
    parentEl: S,
    ghostEl: g,
    rootEl: _,
...
var f, S, g, _, at, Ft, D, J, ft, X, Dt, Q, It, O, ut = !1, Bt = !1, Ht = [], it, H, $t, Ut, he, pe, bt, st, St, Tt = !1, Pt = !1, Rt, A, qt = [], Jt = !1, Wt = [], Lt = typeof document < "u", Nt = oe, ge = Ct || V ? "cssFloat" : "float", je = Lt && !ve && !oe && "draggable" in document.createElement("div"), Te = (function() {
  if (Lt) {
    if (V) return !1;
  ...
  var e = {}, i = t.group;
  (!i || Mt(i) != "object") && (i = { name: i }), e.name = i.name, e.checkPull = n(i.pull, !0), e.checkPut = n(i.put), e.revertClone = i.revertClone, t.group = e;
}, Ae = function() {
...
var rt = function(t) {
  if (f) {
    ...
    if (n) {
      ...
      e.target = e.rootEl = n, e.preventDefault = void 0, e.stopPropagation = void 0, n[x]._onDragOver(e);
    }
  }
}, qe = function(t) {
...
p.prototype = {
  ...
  _onTapStart: function(t) {
    if (t.cancelable) {
      ...
      if (nn(e), !f && !(/mousedown|pointerdown/.test(a) && t.button !== 0 || i.disabled) && !u.isContentEditable && !(!this.nativeDraggable && wt && s && s.tagName.toUpperCase() === "SELECT") && (s = W(s, i.draggable, e, !1), !(s && s.animated) && Ft !== s)) {
        if (ft = Y(s), Dt = Y(s, i.draggable), typeof d == "function") {
          if (d.call(this, t, s, this)) {
            P({
              ...
              toEl: e,
              fromEl: e
            }), N("filter", n, { evt: t }), r && t.preventDefault();
            return;
          }
        } else if (d && (d = d.split(",").some(function(c) {
          if (c = W(u, c.trim(), e, !1), c)
            return P({
              sortable: n,
              rootEl: c,
              name: "filter",
        ...
        i.handle && !W(u, i.handle, e, !1) || this._prepareDragStart(t, l, s);
      }
    }
  },
  _prepareDragStart: function(t, n, e) {
    ...
    if (e && !f && e.parentNode === r) {
      var u = C(e);
      if (_ = r, f = e, S = f.parentNode, at = f.nextSibling, Ft = e, It = a.group, p.dragged = f, it = {
        target: f,
        clientX: (n || t).clientX,
        clientY: (n || t).clientY
      }, he = it.clientX - u.left, pe = it.clientY - u.top, this._lastX = (n || t).clientX, this._lastY = (n || t).clientY, f.style["will-change"] = "all", s = function() {
        if (N("delayEnded", i, { evt: t }), p.eventCanceled) {
          i._onDrop();
          return;
        }
        i._disableDelayedDragEvents(), !ue && i.nativeDraggable && (f.draggable = !0), i._triggerDragStart(t, n), P({
          sortable: i,
          name: "choose",
          originalEvent: t
        }), R(f, a.chosenClass, !0);
  ...
  _dragStarted: function(t, n) {
    if (ut = !1, _ && f) {
      N("dragStarted", this, { evt: n }), this.nativeDraggable && v(document, "dragover", qe);
      var e = this.options;
      !t && R(f, e.dragClass, !1), R(f, e.ghostClass, !0), p.active = this, t && this._appendGhost(), P({
        sortable: this,
        name: "start",
        originalEvent: n
      });
  ...
  _emulateDragOver: function() {
    if (H) {
      ...
      for (var t = document.elementFromPoint(H.clientX, H.clientY), n = t; t && t.shadowRoot && (t = t.shadowRoot.elementFromPoint(H.clientX, H.clientY), t !== n); )
        n = t;
      if (f.parentNode[x]._isOutsideThisEl(t), n) do {
        if (n[x]) {
          var e = void 0;
          if (e = n[x]._onDragOver({
            clientX: H.clientX,
            clientY: H.clientY,
            target: t,
            rootEl: n
  ...
  _onTouchMove: function(t) {
    if (it) {
      var n = this.options, e = n.fallbackTolerance, i = n.fallbackOffset, r = t.touches ? t.touches[0] : t, a = g && ct(g, !0), l = g && a && a.a, s = g && a && a.d, u = Nt && A && de(A), d = (r.clientX - it.clientX + i.x) / (l || 1) + (u ? u[0] - qt[0] : 0) / (l || 1), c = (r.clientY - it.clientY + i.y) / (s || 1) + (u ? u[1] - qt[1] : 0) / (s || 1);
      if (!p.active && !ut) {
  ...
  _appendGhost: function() {
    if (!g) {
      var t = this.options.fallbackOnBody ? document.body : _, n = C(f, !0, Nt, !0, t), e = this.options;
      if (Nt) {
        for (A = t; h(A, "position") === "static" && h(A, "transform") === "none" && A !== document; ) A = A.parentNode;
        A !== document.body && A !== document.documentElement ? (A === document && (A = L()), n.top += A.scrollTop, n.left += A.scrollLeft) : A = L(), qt = de(A);
      }
      g = f.cloneNode(!0), R(g, e.ghostClass, !1), R(g, e.fallbackClass, !0), R(g, e.dragClass, !0), h(g, "transition", ""), h(g, "transform", ""), h(g, "box-sizing", "border-box"), h(g, "margin", 0), h(g, "top", n.top), h(g, "left", n.left), h(g, "width", n.width), h(g, "height", n.height), h(g, "opacity", "0.8"), h(g, "position", Nt ? "absolute" : "fixed"), h(g, "zIndex", "100000"), h(g, "pointerEvents", "none"), p.ghost = g, t.appendChild(g), h(g, "transform-origin", he / parseInt(g.style.width) * 100 + "% " + pe / parseInt(g.style.height) * 100 + "%");
    }
  },
  _onDragStart: function(t, n) {
    ...
    N("setupClone", this), p.eventCanceled || (D = De(f), D.removeAttribute("id"), D.draggable = !1, D.style["will-change"] = "", this._hideClone(), R(D, this.options.chosenClass, !1), p.clone = D), e.cloneId = Xt(function() {
      N("clone", e), !p.eventCanceled && (e.options.removeCloneOnHide || _.insertBefore(D, f), e._hideClone(), P({
        sortable: e,
        name: "clone"
      }));
    }), !n && R(f, r.dragClass, !0), n ? (Bt = !0, e._loopId = setInterval(e._emulateDragOver, 50)) : (m(document, "mouseup", e._onDrop), m(document, "touchend", e._onDrop), m(document, "touchcancel", e._onDrop), i && (i.effectAllowed = "move", r.setData && r.setData.call(e, i, f)), v(document, "drop", e), h(f, "transform", "translateZ(0)")), ut = !0, e._dragStartId = Xt(e._dragStarted.bind(e, n, t)), v(document, "selectstart", e), bt = !0, window.getSelection().removeAllRanges(), wt && h(document.body, "user-select", "none");
  },
  _onDragOver: function(t) {
    var n = this.el, e = t.target, i, r, a, l = this.options, s = l.group, u = p.active, d = It === s, c = l.sort, b = O || u, w, y = this, E = !1;
    if (Jt) return;
    function k(vt, Ne) {
      N(vt, y, z({
        evt: t,
        ...
        target: e,
        completed: I,
        onMove: function(le, xe) {
          return xt(_, n, f, i, le, C(le), t, xe);
        },
        changed: B
      }, Ne));
    }
    ...
    function I(vt) {
      return k("dragOverCompleted", { insertion: vt }), vt && (d ? u._hideClone() : u._showClone(y), y !== b && (R(f, O ? O.options.ghostClass : u.options.ghostClass, !1), R(f, l.ghostClass, !0)), O !== y && y !== p.active ? O = y : y === p.active && O && (O = null), b === y && (y._ignoreWhileAnimating = e), y.animateAll(function() {
        k("dragOverAnimationComplete"), y._ignoreWhileAnimating = null;
      }), y !== b && (b.animateAll(), b._ignoreWhileAnimating = null)), (e === f && !f.animated || e === n && !e.animated) && (st = null), !l.dragoverBubble && !t.rootEl && e !== document && (f.parentNode[x]._isOutsideThisEl(t.target), !vt && rt(t)), !l.dragoverBubble && t.stopPropagation && t.stopPropagation(), E = !0;
    }
    function B() {
    ...
    if (t.preventDefault !== void 0 && t.cancelable && t.preventDefault(), e = W(e, l.draggable, n, !0), k("dragOver"), p.eventCanceled) return E;
    if (f.contains(t.target) || e.animated && e.animatingX && e.animatingY || y._ignoreWhileAnimating === e) return I(!1);
    if (Bt = !1, u && !l.disabled && (d ? c || (a = S !== _) : O === this || (this.lastPutMode = It.checkPull(this, u, f, t)) && s.checkPut(this, u, f, t))) {
      if (w = this._getDirection(t, e) === "vertical", i = C(f), k("dragOverValid"), p.eventCanceled) return E;
      if (a)
        return S = _, j(), this._hideClone(), k("revert"), p.eventCanceled || (at ? _.insertBefore(f, at) : _.appendChild(f)), I(!0);
      var M = ie(n, l.draggable);
      if (!M || Qe(t, w, this) && !M.animated) {
        if (M === f) return I(!1);
        if (M && n === t.target && (e = M), e && (r = C(e)), xt(_, n, f, i, e, r, t, !!e) !== !1)
          return j(), M && M.nextSibling ? n.insertBefore(f, M.nextSibling) : n.appendChild(f), S = n, B(), I(!0);
      } else if (M && Ze(t, w, this)) {
        var et = dt(n, 0, l, !0);
        if (et === f) return I(!1);
        if (e = et, r = C(e), xt(_, n, f, i, e, r, t, !1) !== !1)
          return j(), n.insertBefore(f, et), S = n, B(), I(!0);
        ...
        st !== e && (nt = r[pt], Tt = !1, Pt = !F && l.invertSwap || ht), G = Je(t, e, r, w, F ? 1 : l.swapThreshold, l.invertedSwapThreshold == null ? l.swapThreshold : l.invertedSwapThreshold, Pt, st === e);
        var $;
        if (G !== 0) {
          var ot = Y(f);
          do
        ...
        if (G === 0 || $ === e) return I(!1);
        st = e, St = G;
        var mt = e.nextElementSibling, Z = !1;
        Z = G === 1;
        var At = xt(_, n, f, i, e, r, t, Z);
        if (At !== !1)
          return (At === 1 || At === -1) && (Z = At === 1), Jt = !0, setTimeout(Ke, 30), j(), Z && !mt ? n.appendChild(f) : e.parentNode.insertBefore(f, Z ? mt : e), K && _e(K, 0, gt - K.scrollTop), S = f.parentNode, nt !== void 0 && !Pt && (Rt = Math.abs(nt - C(e)[pt])), B(), I(!0);
      }
      if (n.contains(f)) return I(!1);
    }
    return !1;
  },
  ...
  _onDrop: function(t) {
    ...
    if (X = Y(f), Q = Y(f, e.draggable), N("drop", this, { evt: t }), S = f && f.parentNode, X = Y(f), Q = Y(f, e.draggable), p.eventCanceled) {
      this._nulling();
      return;
    }
  ...
  _nulling: function() {
    N("nulling", this), _ = f = S = g = at = D = Ft = J = it = H = bt = X = Q = ft = Dt = st = St = O = It = p.dragged = p.ghost = p.clone = p.active = null, Wt.forEach(function(t) {
      t.checked = !0;
    }), Wt.length = $t = Ut = 0;
  },
  ...
  toArray: function() {
    for (var t = [], n, e = this.el.children, i = 0, r = e.length, a = this.options; i < r; i++)
      n = e[i], W(n, a.draggable, this.el, !1) && t.push(n.getAttribute(a.dataIdAttr) || en(n));
    return t;
  },
  sort: function(t, n) {
    var e = {}, i = this.el;
    this.toArray().forEach(function(r, a) {
      var l = i.children[a];
      W(l, this.options.draggable, i, !1) && (e[r] = l);
  ...
  destroy: function() {
    N("destroy", this);
    var t = this.el;
    t[x] = null, m(t, "mousedown", this._onTapStart), m(t, "touchstart", this._onTapStart), m(t, "pointerdown", this._onTapStart), this.nativeDraggable && (m(t, "dragover", this), m(t, "dragenter", this)), Array.prototype.forEach.call(t.querySelectorAll("[draggable]"), function(n) {
...
function xt(o, t, n, e, i, r, a, l) {
  var s, u = o[x], d = u.options.onMove, c;
  return window.CustomEvent && !V && !Ct ? s = new CustomEvent("move", {
    bubbles: !0,
    cancelable: !0
  }) : (s = document.createEvent("Event"), s.initEvent("move", !0, !0)), s.to = t, s.from = o, s.dragged = n, s.draggedRect = e, s.related = i || t, s.relatedRect = r || C(t), s.willInsertAfter = l, s.originalEvent = a, o.dispatchEvent(s), d && (c = d.call(u, s, a)), c;
}
function Vt(o) {
  o.draggable = !1;
}
...
function Ze(o, t, n) {
  var e = C(dt(n.el, 0, n.options, !0)), i = Se(n.el, n.options, g), r = 10;
...
function Je(o, t, n, e, i, r, a, l) {
  var s = e ? o.clientY : o.clientX, u = e ? n.height : n.width, d = e ? n.top : n.left, c = e ? n.bottom : n.right, b = !1;
  if (!a) {
    if (l && Rt < u * i) {
      if (!Tt && (St === 1 ? s > d + u * r / 2 : s < c - u * r / 2) && (Tt = !0), Tt)
        b = !0;
      else if (St === 1 ? s < d + Rt : s > c - Rt) return -St;
    } else if (s > d + u * (1 - i) / 2 && s < c - u * (1 - i) / 2) return tn(t);
  }
...
function en(o) {
  for (var t = o.tagName + o.className + o.src + o.href + o.textContent, n = t.length, e = 0; n--; ) e += t.charCodeAt(n);
...
function on() {
  ...
  return o.prototype = {
    ...
    nulling: function() {
      Gt = ee = yt = ne = Et = Kt = Zt = null, T.length = 0;
    },
    ...
    _handleAutoScroll: function(n, e) {
      ...
      if (Gt = n, e || this.options.forceAutoScrollFallback || Ct || V || wt) {
        ...
        var s = tt(l, !0);
        ne && (!Et || r !== Kt || a !== Zt) && (Et && me(), Et = setInterval(function() {
...
var Qt = we(function(o, t, n, e) {
  if (t.scroll) {
    ...
    ee !== n && (ee = n, Yt(), yt = t.scroll, d = t.scrollFn, yt === !0 && (yt = tt(n, !0)));
    var c = 0, b = yt;
    do {
      var w = b, y = C(w), E = y.top, k = y.bottom, j = y.left, I = y.right, B = y.width, M = y.height, et = void 0, G = void 0, nt = w.scrollWidth, ht = w.scrollHeight, F = h(w), pt = w.scrollLeft, K = w.scrollTop;
      ...
      var gt = et && (Math.abs(I - i) <= a && pt + B < nt) - (Math.abs(j - i) <= a && !!pt), $ = G && (Math.abs(k - r) <= a && K + M < ht) - (Math.abs(E - r) <= a && !!K);
      if (!T[c])
        for (var ot = 0; ot <= c; ot++) T[ot] || (T[ot] = {});
      (T[c].vx != gt || T[c].vy != $ || T[c].el !== w) && (T[c].el = w, T[c].vx = gt, T[c].vy = $, clearInterval(T[c].pid), (gt != 0 || $ != 0) && (u = !0, T[c].pid = setInterval(function() {
        ...
        typeof d == "function" && d.call(p.dragged.parentNode[x], Z, mt, o, Gt, T[this.layer].el) !== "continue" || _e(T[this.layer].el, Z, mt);
      }.bind({ layer: c }), 24))), c++;
...
//# sourceMappingURL=sortable.esm-G5PYYtV9.js.map