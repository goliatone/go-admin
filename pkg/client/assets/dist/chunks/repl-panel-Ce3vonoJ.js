import { escapeHTML as li } from "../shared/html.js";
import { normalizeDebugBasePath as bn } from "../debug/shared/path-helpers.js";
import { r as st } from "./icons-CAenalpJ.js";
var wn = 2, yn = 1, Cn = class {
  activate(e) {
    this._terminal = e;
  }
  dispose() {
  ...
  proposeDimensions() {
    ...
    let t = this._terminal.options.scrollback === 0 ? 0 : this._terminal.options.overviewRuler?.width || 14, i = window.getComputedStyle(this._terminal.element.parentElement), s = parseInt(i.getPropertyValue("height")), r = Math.max(0, parseInt(i.getPropertyValue("width"))), n = window.getComputedStyle(this._terminal.element), o = {
      top: parseInt(n.getPropertyValue("padding-top")),
      bottom: parseInt(n.getPropertyValue("padding-bottom")),
      right: parseInt(n.getPropertyValue("padding-right")),
      left: parseInt(n.getPropertyValue("padding-left"))
    }, h = o.top + o.bottom, l = o.right + o.left, a = s - h, d = r - l - t;
    return {
      cols: Math.max(wn, Math.floor(d / e.css.cell.width)),
      rows: Math.max(yn, Math.floor(a / e.css.cell.height))
    };
  }
}, xr = Object.defineProperty, kn = Object.getOwnPropertyDescriptor, xn = (e, t) => {
  for (var i in t) xr(e, i, {
    get: t[i],
    enumerable: !0
  });
}, q = (e, t, i, s) => {
  for (var r = s > 1 ? void 0 : s ? kn(t, i) : t, n = e.length - 1, o; n >= 0; n--) (o = e[n]) && (r = (s ? o(t, i, r) : o(r)) || r);
  return s && r && xr(t, i, r), r;
}, y = (e, t) => (i, s) => t(i, s, e), Cs = "Terminal input", Ci = {
  get: () => Cs,
  set: (e) => Cs = e
}, ks = "Too much output to announce, navigate to rows manually to read", ki = {
  get: () => ks,
  set: (e) => ks = e
};
function En(e) {
...
function Rn(e, t, i, s) {
  e.stopPropagation(), e.clipboardData && Er(e.clipboardData.getData("text/plain"), t, i, s);
}
function Er(e, t, i, s) {
  e = En(e), e = Dn(e, i.decPrivateModes.bracketedPasteMode && s.rawOptions.ignoreBracketedPasteMode !== !0), i.triggerDataEvent(e, !0), t.value = "";
}
function Dr(e, t, i) {
...
var Mn = class {
  ...
  decode(e, t) {
    ...
    for (let n = r; n < i; ++n) {
      ...
      if (55296 <= o && o <= 56319) {
        ...
        56320 <= h && h <= 57343 ? t[s++] = (o - 55296) * 1024 + h - 56320 + 65536 : (t[s++] = o, t[s++] = h);
        continue;
      }
      o !== 65279 && (t[s++] = o);
    }
  ...
  decode(e, t) {
    ...
    if (this.interim[0]) {
      ...
      let u = 0, g;
      for (; (g = this.interim[++u] & 63) && u < 4; ) f <<= 6, f |= g;
      let k = (this.interim[0] & 224) === 192 ? 2 : (this.interim[0] & 240) === 224 ? 3 : 4, D = k - u;
      for (; a < D; ) {
        if (a >= i) return 0;
        if (g = e[a++], (g & 192) !== 128) {
          a--, _ = !0;
          break;
        } else this.interim[u++] = g, f <<= 6, f |= g & 63;
      }
      _ || (k === 2 ? f < 128 ? a-- : t[s++] = f : k === 3 ? f < 2048 || f >= 55296 && f <= 57343 || f === 65279 || (t[s++] = f) : f < 65536 || f > 1114111 || (t[s++] = f)), this.interim.fill(0);
    }
    let d = i - 4, c = a;
    for (; c < i; ) {
      ...
      if (r = e[c++], r < 128) t[s++] = r;
        ...
        if (l = (r & 15) << 12 | (n & 63) << 6 | o & 63, l < 2048 || l >= 55296 && l <= 57343 || l === 65279) continue;
        t[s++] = l;
      } else if ((r & 248) === 240) {
        if (c >= i) return this.interim[0] = r, s;
        if (n = e[c++], (n & 192) !== 128) {
        ...
        if (l = (r & 7) << 18 | (n & 63) << 12 | (o & 63) << 6 | h & 63, l < 65536 || l > 1114111) continue;
        t[s++] = l;
      }
    }
    return s;
  ...
  constructor() {
    this.fg = 0, this.bg = 0, this.extended = new Xt();
  }
  static toColorRGB(t) {
    return [
      t >>> 16 & 255,
...
}, be = class Lr extends Rt {
  constructor() {
    super(...arguments), this.content = 0, this.fg = 0, this.bg = 0, this.extended = new Xt(), this.combinedData = "";
  }
  ...
  getChars() {
    return this.content & 2097152 ? this.combinedData : this.content & 2097151 ? Ue(this.content & 2097151) : "";
  }
  getCode() {
...
}, Es = "di$target", xi = "di$dependencies", ci = /* @__PURE__ */ new Map();
function Pn(e) {
  return e[xi] || [];
}
function re(e) {
...
var ce = re("BufferService"), Pr = re("CoreMouseService"), tt = re("CoreService"), An = re("CharsetService"), us = re("InstantiationService"), Tr = re("LogService"), de = re("OptionsService"), Ar = re("OscLinkService"), On = re("UnicodeService"), Mt = re("DecorationService"), Ei = class {
  constructor(e, t, i) {
  ...
  provideLinks(e, t) {
    ...
    let s = [], r = this._optionsService.rawOptions.linkHandler, n = new be(), o = i.getTrimmedLength(), h = -1, l = -1, a = !1;
      ...
      if (a || l !== -1 && d === o - 1) {
        ...
        if (c) {
          ...
          if (!r?.allowNonHttpProtocols) try {
            let u = new URL(c);
            ["http:", "https:"].includes(u.protocol) || (f = !0);
          } catch {
            f = !0;
          }
          f || s.push({
            text: c,
            range: _,
            activate: (u, g) => r ? r.activate(u, g, _) : In(u, g),
            hover: (u, g) => r?.hover?.(u, g, _),
            leave: (u, g) => r?.leave?.(u, g, _)
          });
        }
...
var ii = re("CharSizeService"), Oe = re("CoreBrowserService"), _s = re("MouseService"), Ie = re("RenderService"), Nn = re("SelectionService"), Or = re("CharacterJoinerService"), nt = re("ThemeService"), Ir = re("LinkProviderService"), Hn = class {
  constructor() {
...
function zt(e) {
  Wn(e) || zn.onUnexpectedError(e);
}
var Di = "Canceled";
function Wn(e) {
  return e instanceof Fn ? !0 : e instanceof Error && e.name === Di && e.message === Di;
}
var Fn = class extends Error {
  constructor() {
    super(Di), this.name = this.message;
  }
};
function $n(e) {
  return e ? /* @__PURE__ */ new Error(`Illegal argument: ${e}`) : /* @__PURE__ */ new Error("Illegal argument");
}
var Ds = class Bi extends Error {
  constructor(t) {
...
}, Ri = class Nr extends Error {
  constructor(t) {
    super(t || "An unexpected bug occurred."), Object.setPrototypeOf(this, Nr.prototype);
  }
};
function Kn(e, t, i = 0, s = e.length) {
  let r = i, n = s;
  for (; r < n; ) {
...
var Un = class Hr {
  ...
  findLastMonotonous(t) {
    if (Hr.assertInvariants) {
      if (this._prevFindLastPredicate) {
        for (let s of this._array) if (this._prevFindLastPredicate(s) && !t(s)) throw new Error("MonotonousArray: current predicate must be weaker than (or equal to) the previous predicate.");
      }
      this._prevFindLastPredicate = t;
    }
    let i = Kn(this._array, t, this._findLastMonotonousLastIdx);
...
var Vn = (e, t) => e - t, Bs = class Li {
  ...
  filter(t) {
    return new Li((i) => this.iterate((s) => t(s) ? i(s) : !0));
  }
  map(t) {
    return new Li((i) => this.iterate((s) => i(t(s))));
  }
  some(t) {
    let i = !1;
  ...
  findLastMaxBy(t) {
    let i, s = !0;
    return this.iterate((r) => ((s || Mi.isGreaterThan(t(r, i))) && (s = !1, i = r), !0)), i;
  }
};
Bs.empty = new Bs((e) => {
});
...
((e) => {
  ...
  e.from = o;
  function* h(E) {
    for (let P = E.length - 1; P >= 0; P--) yield E[P];
  }
  e.reverse = h;
  function l(E) {
  ...
  function d(E, P) {
    let A = 0;
    for (let ne of E) if (P(ne, A++)) return !0;
    return !1;
  }
  e.some = d;
  function c(E, P) {
    for (let A of E) if (P(A)) return A;
  }
  e.find = c;
  function* _(E, P) {
    for (let A of E) P(A) && (yield A);
  }
  e.filter = _;
  function* f(E, P) {
    let A = 0;
    for (let ne of E) yield P(ne, A++);
  }
  e.map = f;
  function* u(E, P) {
    let A = 0;
  ...
  e.flatMap = u;
  function* g(...E) {
    for (let P of E) yield* P;
  }
  e.concat = g;
  function k(E, P, A) {
    let ne = A;
    for (let we of E) ne = P(ne, we);
    return ne;
  }
  e.reduce = k;
  function* D(E, P, A = E.length) {
    for (P < 0 && (P += E.length), A < 0 ? A += E.length : A > E.length && (A = E.length); P < A; P++) yield E[P];
  }
  e.slice = D;
  function I(E, P = Number.POSITIVE_INFINITY) {
    let A = [];
    if (P === 0) return [A, E];
    let ne = E[Symbol.iterator]();
    for (let we = 0; we < P; we++) {
      let ke = ne.next();
      if (ke.done) return [A, e.empty()];
      A.push(ke.value);
    }
  ...
  async function L(E) {
    let P = [];
    for await (let A of E) P.push(A);
    return Promise.resolve(P);
  }
  e.asyncToArray = L;
})(Pi || (Pi = {}));
var Gn = !1, Ze = null, Jn = class zr {
  constructor() {
  ...
  trackDisposable(t) {
    ...
    i.source || (i.source = (/* @__PURE__ */ new Error()).stack);
  }
  setParent(t, i) {
    let s = this.getDisposableData(t);
    s.parent = i;
  }
  markAsDisposed(t) {
  ...
  getRootParent(t, i) {
    let s = i.get(t);
    if (s) return s;
    let r = t.parent ? this.getRootParent(this.getDisposableData(t.parent), i) : t;
    return i.set(t, r), r;
  }
  ...
  computeLeakingDisposables(t = 10, i) {
    ...
    if (i) s = i;
      ...
      let l = /* @__PURE__ */ new Map(), a = [...this.livingDisposables.values()].filter((c) => c.source !== null && !this.getRootParent(c, l).isSingleton);
      if (a.length === 0) return;
      let d = new Set(a.map((c) => c.value));
      if (s = a.filter((c) => !(c.parent && d.has(c.parent))), s.length === 0) throw new Error("There are cyclic diposable chains!");
    }
    if (!s) return;
    function r(l) {
      function a(c, _) {
        for (; c.length > 0 && _.some((f) => typeof f == "string" ? f === c[0] : c[0].match(f)); ) c.shift();
      }
      let d = l.source.split(`
`).map((c) => c.trim().replace("at ", "")).filter((c) => c !== "");
    ...
    for (let l of s) {
      let a = r(l);
      for (let d = 0; d <= a.length; d++) n.add(a.slice(0, d).join(`
`), l);
    }
    s.sort(qn((l) => l.idx, Vn));
    let o = "", h = 0;
    for (let l of s.slice(0, t)) {
      h++;
      let a = r(l), d = [];
      for (let c = 0; c < a.length; c++) {
        let _ = a[c];
        _ = `(shared with ${n.get(a.slice(0, c + 1).join(`
`)).size}/${s.length} leaks) at ${_}`;
        let f = Yn([...n.get(a.slice(0, c).join(`
`))].map((u) => r(u)[c]), (u) => u);
        delete f[a[c]];
        for (let [u, g] of Object.entries(f)) d.unshift(`    - stacktraces of ${g.length} other leaks continue with ${u}`);
        d.unshift(_);
      }
      o += `


==================== Leaking disposable ${h}/${s.length}: ${l.value.constructor.name} ====================
${d.join(`
`)}
============================================================
...
if (Gn) {
  ...
  Zn(new class {
    trackDisposable(t) {
      let i = (/* @__PURE__ */ new Error("Potentially leaked disposable")).stack;
      setTimeout(() => {
        t[e] || console.log(i);
      }, 3e3);
    }
...
function Qn(e, t) {
  if (Ze) for (let i of e) Ze.setParent(i, t);
}
function Rs(e) {
  return Ze?.markAsSingleton(e), e;
}
function Qe(e) {
  if (Pi.is(e)) {
    let t = [];
...
var Wr = class Fr {
  constructor() {
    this._toDispose = /* @__PURE__ */ new Set(), this._isDisposed = !1, si(this);
  }
  dispose() {
  ...
  add(t) {
    ...
    return xt(t, this), this._isDisposed ? Fr.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(t), t;
  }
  delete(t) {
    if (t) {
  ...
  deleteAndLeak(t) {
    t && this._toDispose.has(t) && (this._toDispose.delete(t), xt(t, null));
  }
};
Wr.DISABLE_DISPOSED_WARNING = !1;
var Ve = Wr, R = class {
  constructor() {
    this._store = new Ve(), si(this), xt(this._store, this);
  }
  dispose() {
...
R.None = Object.freeze({ dispose() {
} });
var rt = class {
  constructor() {
    this._isDisposed = !1, si(this);
  }
  get value() {
    return this._isDisposed ? void 0 : this._value;
  }
  set value(e) {
    this._isDisposed || e === this._value || (this._value?.dispose(), e && xt(e, this), this._value = e);
  }
  clear() {
    this.value = void 0;
  }
  ...
  clearAndLeak() {
    let e = this._value;
    return this._value = void 0, e && xt(e, null), e;
  }
}, Se = typeof window == "object" ? window : globalThis, Ti = class Ai {
  constructor(t) {
    this.element = t, this.next = Ai.Undefined, this.prev = Ai.Undefined;
  }
};
Ti.Undefined = new Ti(void 0);
var K = Ti, Ms = class {
  constructor() {
...
}, to = globalThis.performance && typeof globalThis.performance.now == "function", io = class $r {
  static create(t) {
    return new $r(t);
  }
  constructor(t) {
    this._now = to && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
((e) => {
  ...
  function t(b) {
    if (no) {
      let { onDidAddListener: m } = b, C = qr.create(), w = 0;
      b.onDidAddListener = () => {
        ++w === 2 && (console.warn("snapshotted emitter LIKELY used public and SHOULD HAVE BEEN created with DisposableStore. snapshotted here"), C.print()), m?.();
      };
    }
  }
  function i(b, m) {
  ...
  function s(b) {
    return (m, C = null, w) => {
      let x = !1, S;
      return S = b((T) => {
        if (!x) return S ? S.dispose() : x = !0, m.call(C, T);
      }, null, w), x && S.dispose(), S;
    };
  }
  e.once = s;
  function r(b, m, C) {
    return d((w, x = null, S) => b((T) => w.call(x, m(T)), null, S), C);
  }
  e.map = r;
  function n(b, m, C) {
    return d((w, x = null, S) => b((T) => {
      m(T), w.call(x, T);
    }, null, S), C);
  }
  e.forEach = n;
  function o(b, m, C) {
    return d((w, x = null, S) => b((T) => m(T) && w.call(x, T), null, S), C);
  }
  e.filter = o;
  function h(b) {
    return b;
  ...
  e.signal = h;
  function l(...b) {
    return (m, C = null, w) => c(eo(...b.map((x) => x((S) => m.call(C, S)))), w);
  }
  e.any = l;
  function a(b, m, C, w) {
    let x = C;
    return r(b, (S) => (x = m(x, S), x), w);
  }
  e.reduce = a;
  function d(b, m) {
    let C, w = {
    ...
    m || t(w);
    let x = new v(w);
    return m?.add(x), x.event;
  }
  function c(b, m) {
    return m instanceof Array ? m.push(b) : m && m.add(b), b;
  }
  function _(b, m, C = 100, w = !1, x = !1, S, T) {
    let $, oe, xe, Me = 0, Z, Ne = {
      leakWarningThreshold: S,
      onWillAddFirstListener() {
        $ = b((Ye) => {
          Me++, oe = m(oe, Ye), w && !xe && (le.fire(oe), oe = void 0), Z = () => {
            let at = oe;
            oe = void 0, xe = void 0, (!w || Me > 1) && le.fire(at), Me = 0;
          }, typeof C == "number" ? (clearTimeout(xe), xe = setTimeout(Z, C)) : xe === void 0 && (xe = 0, queueMicrotask(Z));
        });
      },
    ...
    T || t(Ne);
    let le = new v(Ne);
    return T?.add(le), le.event;
  }
  e.debounce = _;
  function f(b, m = 0, C) {
    return e.debounce(b, (w, x) => w ? (w.push(x), w) : [x], m, void 0, !0, void 0, C);
  }
  e.accumulate = f;
  function u(b, m = (w, x) => w === x, C) {
    let w = !0, x;
    return o(b, (S) => {
      let T = w || !m(S, x);
      return w = !1, x = S, T;
  ...
  e.latch = u;
  function g(b, m, C) {
    return [e.filter(b, m, C), e.filter(b, (w) => !m(w), C)];
  }
  e.split = g;
  function k(b, m = !1, C = [], w) {
    let x = C.slice(), S = b((oe) => {
      x ? x.push(oe) : $.fire(oe);
    });
    w && w.add(S);
    let T = () => {
      x?.forEach((oe) => $.fire(oe)), x = null;
    }, $ = new v({
      onWillAddFirstListener() {
        S || (S = b((oe) => $.fire(oe)), w && w.add(S));
      },
  ...
  e.chain = D;
  let I = /* @__PURE__ */ Symbol("HaltChainable");
  class L {
    constructor() {
      this.steps = [];
    }
    ...
    forEach(m) {
      return this.steps.push((C) => (m(C), C)), this;
    }
    filter(m) {
      return this.steps.push((C) => m(C) ? C : I), this;
    }
    reduce(m, C) {
      let w = C;
      return this.steps.push((x) => (w = m(w, x), w)), this;
    }
    latch(m = (C, w) => C === w) {
      let C = !0, w;
      return this.steps.push((x) => {
        let S = C || !m(x, w);
        return C = !1, w = x, S ? x : I;
      }), this;
    }
    evaluate(m) {
      for (let C of this.steps) if (m = C(m), m === I) break;
      return m;
    }
  }
  function E(b, m, C = (w) => w) {
    let w = (...$) => T.fire(C(...$)), x = () => b.on(m, w), S = () => b.removeListener(m, w), T = new v({
      onWillAddFirstListener: x,
      onDidRemoveLastListener: S
    });
    return T.event;
  }
  e.fromNodeEventEmitter = E;
  function P(b, m, C = (w) => w) {
    let w = (...$) => T.fire(C(...$)), x = () => b.addEventListener(m, w), S = () => b.removeEventListener(m, w), T = new v({
      onWillAddFirstListener: x,
      onDidRemoveLastListener: S
    });
    return T.event;
  ...
  class Tt {
    constructor(m, C) {
      ...
      C || t(w), this.emitter = new v(w), C && C.add(this.emitter);
    }
    beginUpdate(m) {
      this._counter++;
    }
  ...
  function F(b, m) {
    return new Tt(b, m).emitter.event;
  }
  e.fromObservable = F;
  function ai(b) {
    return (m, C, w) => {
      let x = 0, S = !1, T = {
        ...
        endUpdate() {
          x--, x === 0 && (b.reportChanges(), S && (S = !1, m.call(C)));
        },
      ...
      return w instanceof Ve ? w.add($) : Array.isArray(w) && w.push($), $;
    };
  }
  e.fromObservableLight = ai;
})(se || (se = {}));
var Oi = class Ii {
  constructor(t) {
    this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${t}_${Ii._idPool++}`, Ii.all.add(this);
  }
  start(t) {
    this._stopWatch = new io(), this.listenerCount = t;
  }
  stop() {
    if (this._stopWatch) {
...
Oi.all = /* @__PURE__ */ new Set(), Oi._idPool = 0;
var oo = Oi, Ls = -1, Kr = class Ur {
  constructor(t, i, s = (Ur._idPool++).toString(16).padStart(3, "0")) {
  ...
  check(t, i) {
    ...
    if (this._stacks.set(t.value, r + 1), this._warnCountdown -= 1, this._warnCountdown <= 0) {
      ...
      let [n, o] = this.getMostFrequentStack(), h = `[${this.name}] potential listener LEAK detected, having ${i} listeners already. MOST frequent listener (${o}):`;
      console.warn(h), console.warn(n);
      let l = new ho(h, n);
...
Kr._idPool = 1;
var ao = Kr, qr = class Vr {
  constructor(t) {
    this.value = t;
  }
  static create() {
    return new Vr((/* @__PURE__ */ new Error()).stack ?? "");
  }
  print() {
...
`));
  ...
  constructor(e) {
    this.value = e, this.id = co++;
  }
}, uo = 2, _o = (e, t) => {
  if (e instanceof Wt) t(e);
...
`)), e.length = 0);
  }, 3e3), Ft = new FinalizationRegistry((t) => {
    typeof t == "string" && e.push(t);
  });
}
var v = class {
  constructor(e) {
    this._size = 0, this._options = e, this._leakageMon = Ls > 0 || this._options?.leakWarningThreshold ? new ao(e?.onListenerError ?? zt, this._options?.leakWarningThreshold ?? Ls) : void 0, this._perfMon = this._options?._profName ? new oo(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
    if (!this._disposed) {
  ...
  get event() {
    return this._event ?? (this._event = (e, t, i) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(o);
        let h = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], l = new lo(`${o}. HINT: Stack shows most frequent listener (${h[1]}-times)`, h[0]);
        return (this._options?.onListenerError || zt)(l), R.None;
      }
      if (this._disposed) return R.None;
      t && (e = e.bind(t));
      let s = new Wt(e), r;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (s.stack = qr.create(), r = this._leakageMon.check(s.stack, this._size + 1)), this._listeners ? this._listeners instanceof Wt ? (this._deliveryQueue ?? (this._deliveryQueue = new fo()), this._listeners = [this._listeners, s]) : this._listeners.push(s) : (this._options?.onWillAddFirstListener?.(this), this._listeners = s, this._options?.onDidAddFirstListener?.(this)), this._size++;
      let n = z(() => {
        Ft?.unregister(n), r?.(), this._removeListener(s);
      });
      if (i instanceof Ve ? i.add(n) : Array.isArray(i) && i.push(n), Ft) {
        let o = (/* @__PURE__ */ new Error()).stack.split(`
`).slice(2, 3).join(`
`).trim(), h = /(file:|vscode-file:\/\/vscode-app)?(\/[^:]*:\d+:\d+)/.exec(o);
        Ft.register(n, h?.[2] ?? o, n);
      }
      return n;
    }), this._event;
  }
  ...
  fire(e) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof Wt) this._deliver(this._listeners, e);
    else {
...
fs.INSTANCE.onDidChangeZoomLevel;
function go(e) {
  return fs.INSTANCE.getZoomFactor(e);
}
fs.INSTANCE.onDidChangeFullscreen;
var ot = typeof navigator == "object" ? navigator.userAgent : "", Hi = ot.indexOf("Firefox") >= 0, $t = ot.indexOf("AppleWebKit") >= 0, ps = ot.indexOf("Chrome") >= 0, vo = !ps && ot.indexOf("Safari") >= 0;
ot.indexOf("Electron/");
ot.indexOf("Android");
var Kt = !1;
if (typeof Se.matchMedia == "function") {
  let e = Se.matchMedia("(display-mode: standalone) or (display-mode: window-controls-overlay)"), t = Se.matchMedia("(display-mode: fullscreen)");
  Kt = e.matches, po(Se, e, ({ matches: i }) => {
    Kt && t.matches || (Kt = i);
  });
}
function mo() {
...
var Ut = "en", zi = !1, Wi = !1, qt = !1, Yr = !1, jr = !1, Vt = Ut, Pe, Ae = globalThis, pe;
typeof Ae.vscode < "u" && typeof Ae.vscode.process < "u" ? pe = Ae.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (pe = process);
var So = typeof pe?.versions?.electron == "string" && pe?.type === "renderer";
if (typeof pe == "object") {
  zi = pe.platform === "win32", Wi = pe.platform === "darwin", qt = pe.platform === "linux", qt && pe.env.SNAP && pe.env.SNAP_REVISION, pe.env.CI || pe.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Vt = Ut;
  let e = pe.env.VSCODE_NLS_CONFIG;
  if (e) try {
    let t = JSON.parse(e);
    t.userLocale, t.osLocale, Vt = t.resolvedLanguage || Ut, t.languagePack?.translationsConfigFile;
  } catch {
  }
  Yr = !0;
} else typeof navigator == "object" && !So ? (Pe = navigator.userAgent, zi = Pe.indexOf("Windows") >= 0, Wi = Pe.indexOf("Macintosh") >= 0, (Pe.indexOf("Macintosh") >= 0 || Pe.indexOf("iPad") >= 0 || Pe.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, qt = Pe.indexOf("Linux") >= 0, Pe?.indexOf("Mobi"), jr = !0, Vt = globalThis._VSCODE_NLS_LANGUAGE || Ut, navigator.language.toLowerCase()) : console.error("Unable to resolve platform.");
var Xr = zi, Be = Wi, bo = qt, di = Yr;
jr && typeof Ae.importScripts == "function" && Ae.origin;
var Re = Pe, We = Vt, Ps;
((e) => {
  function t() {
    return We;
...
var wo = typeof Ae.postMessage == "function" && !Ae.importScripts;
(() => {
  if (wo) {
    let e = [];
    Ae.addEventListener("message", (i) => {
...
var yo = !!(Re && Re.indexOf("Chrome") >= 0);
Re && Re.indexOf("Firefox");
!yo && Re && Re.indexOf("Safari");
Re && Re.indexOf("Edg/");
Re && Re.indexOf("Android");
var Fe = typeof navigator == "object" ? navigator : {};
di || document.queryCommandSupported && document.queryCommandSupported("copy") || Fe && Fe.clipboard && Fe.clipboard.writeText, di || Fe && Fe.clipboard && Fe.clipboard.readText, di || mo() || Fe.keyboard, "ontouchstart" in Se || Fe.maxTouchPoints, Se.PointerEvent && ("ontouchstart" in Se || navigator.maxTouchPoints);
var gs = class {
  constructor() {
...
}, ui = new gs(), Ts = new gs(), As = new gs(), Co = new Array(230), Fi;
((e) => {
  function t(h) {
    return ui.keyCodeToStr(h);
  }
  e.toString = t;
  function i(h) {
    return ui.strToKeyCode(h);
  }
  e.fromString = i;
  function s(h) {
    return Ts.keyCodeToStr(h);
  }
  e.toUserSettingsUS = s;
  function r(h) {
    return As.keyCodeToStr(h);
  }
  e.toUserSettingsGeneral = r;
  function n(h) {
    return Ts.strToKeyCode(h) || As.strToKeyCode(h);
  }
  e.fromUserSettings = n;
  function o(h) {
    if (h >= 98 && h <= 113) return null;
    switch (h) {
      case 16:
        return "Up";
      case 18:
...
var ko = class Gr {
  ...
  equals(t) {
    return t instanceof Gr && this.ctrlKey === t.ctrlKey && this.shiftKey === t.shiftKey && this.altKey === t.altKey && this.metaKey === t.metaKey && this.keyCode === t.keyCode;
  }
  getHashCode() {
...
var Do = Be ? 256 : 2048, Bo = 512, Ro = 1024, Mo = Be ? 2048 : 256, $i = class {
  ...
  _computeKeybinding() {
    ...
    let t = 0;
    return this.ctrlKey && (t |= Do), this.altKey && (t |= Bo), this.shiftKey && (t |= Ro), this.metaKey && (t |= Mo), t |= e, t;
  }
  _computeKeyCodeChord() {
    let e = 0;
    return this.keyCode !== 5 && this.keyCode !== 4 && this.keyCode !== 6 && this.keyCode !== 57 && (e = this.keyCode), new ko(this.ctrlKey, this.shiftKey, this.altKey, this.metaKey, e);
  }
...
var Po = class {
  ...
  static getPositionOfChildWindowRelativeToAncestorWindow(e, t) {
    ...
    for (let n of r) {
      ...
      let h = n.iframeElement.getBoundingClientRect();
      i += h.top, s += h.left;
    }
    return {
      top: i,
  ...
  constructor(e, t) {
    ...
    let i = Po.getPositionOfChildWindowRelativeToAncestorWindow(e, t.view);
  ...
  constructor(e, t = 0, i = 0) {
    ...
    if (e) {
      ...
      if (typeof r.wheelDeltaY < "u") s ? this.deltaY = r.wheelDeltaY / (120 * o) : this.deltaY = r.wheelDeltaY / 120;
        ...
        let h = e;
        h.deltaMode === h.DOM_DELTA_LINE ? Hi && !Be ? this.deltaY = -e.deltaY / 3 : this.deltaY = -e.deltaY : this.deltaY = -e.deltaY / 40;
      }
      if (typeof r.wheelDeltaX < "u") vo && Xr ? this.deltaX = -(r.wheelDeltaX / 120) : s ? this.deltaX = r.wheelDeltaX / (120 * o) : this.deltaX = r.wheelDeltaX / 120;
      else if (typeof n.HORIZONTAL_AXIS < "u" && n.axis === n.HORIZONTAL_AXIS) this.deltaX = -e.detail / 3;
      else if (e.type === "wheel") {
        let h = e;
        h.deltaMode === h.DOM_DELTA_LINE ? Hi && !Be ? this.deltaX = -e.deltaX / 3 : this.deltaX = -e.deltaX : this.deltaX = -e.deltaX / 40;
      }
...
((e) => {
  function t(i) {
    return i === e.None || i === e.Cancelled || i instanceof To ? !0 : !i || typeof i != "object" ? !1 : typeof i.isCancellationRequested == "boolean" && typeof i.onCancellationRequested == "function";
  }
...
var To = class {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? Jr : (this._emitter || (this._emitter = new v()), this._emitter.event);
  }
  dispose() {
  ...
  cancelAndSet(e, t) {
    if (this._isDisposed) throw new Ri("Calling 'cancelAndSet' on a disposed TimeoutTimer");
    this.cancel(), this._token = setTimeout(() => {
      this._token = -1, e();
    }, t);
  }
  setIfNotSet(e, t) {
    if (this._isDisposed) throw new Ri("Calling 'setIfNotSet' on a disposed TimeoutTimer");
  ...
  cancelAndSet(e, t, i = globalThis) {
    if (this.isDisposed) throw new Ri("Calling 'cancelAndSet' on a disposed IntervalTimer");
    this.cancel();
    let s = i.setInterval(() => {
      e();
    }, t);
...
((e) => {
  async function t(s) {
    let r, n = await Promise.all(s.map((o) => o.then((h) => h, (h) => {
      r || (r = h);
    })));
...
var zs = class ve {
  ...
  constructor(t, i) {
    this._state = 0, this._results = [], this._error = null, this._onReturn = i, this._onStateChanged = new v(), queueMicrotask(async () => {
      let s = {
    ...
    return {
      next: async () => {
        do {
          ...
          await se.toPromise(this._onStateChanged.event);
        } while (!0);
      },
...
function ms(e, t) {
  switch (typeof e) {
    case "object":
      return e === null ? Te(349, t) : Array.isArray(e) ? zo(e, t) : Wo(e, t);
    case "string":
      return Zr(e, t);
    case "boolean":
      return Ho(e, t);
...
function Ho(e, t) {
  return Te(e ? 433 : 863, t);
}
function Zr(e, t) {
  t = Te(149417, t);
  for (let i = 0, s = e.length; i < s; i++) t = Te(e.charCodeAt(i), t);
  return t;
}
function zo(e, t) {
  return t = Te(104579, t), e.reduce((i, s) => ms(s, i), t);
}
function Wo(e, t) {
  return t = Te(181387, t), Object.keys(e).sort().reduce((i, s) => (i = Zr(s, i), ms(e[s], i)), t);
}
function _i(e, t, i = 32) {
  let s = i - t, r = ~((1 << s) - 1);
  return (e << t | (r & e) >>> s) >>> 0;
}
function Fs(e, t = 0, i = e.byteLength, s = 0) {
...
function lt(e, t = 32) {
  return e instanceof ArrayBuffer ? Array.from(new Uint8Array(e)).map((i) => i.toString(16).padStart(2, "0")).join("") : Fo((e >>> 0).toString(16), t / 4);
}
var $o = class Qr {
  constructor() {
  ...
  update(t) {
    let i = t.length;
    if (i === 0) return;
    let s = this._buff, r = this._buffLen, n = this._leftoverHighSurrogate, o, h;
    for (n !== 0 ? (o = n, h = -1, n = 0) : (o = t.charCodeAt(0), h = 0); ; ) {
      let l = o;
      if (Oo(o)) if (h + 1 < i) {
        let a = t.charCodeAt(h + 1);
        Ws(a) ? (h++, l = Io(o, a)) : l = 65533;
      } else {
        n = o;
        break;
      }
      else Ws(o) && (l = 65533);
      if (r = this._push(s, r, l), h++, h < i) o = t.charCodeAt(h);
      else break;
    }
  ...
  digest() {
    return this._finished || (this._finished = !0, this._leftoverHighSurrogate && (this._leftoverHighSurrogate = 0, this._buffLen = this._push(this._buff, this._buffLen, 65533)), this._totalLen += this._buffLen, this._wrapUp()), lt(this._h0) + lt(this._h1) + lt(this._h2) + lt(this._h3) + lt(this._h4);
  }
  _wrapUp() {
    this._buff[this._buffLen++] = 128, Fs(this._buff, this._buffLen), this._buffLen > 56 && (this._step(), Fs(this._buff));
  ...
  _step() {
    let t = Qr._bigBlock32, i = this._buffDV;
    for (let c = 0; c < 64; c += 4) t.setUint32(c, i.getUint32(c, !1), !1);
    for (let c = 64; c < 320; c += 4) t.setUint32(c, _i(t.getUint32(c - 12, !1) ^ t.getUint32(c - 32, !1) ^ t.getUint32(c - 56, !1) ^ t.getUint32(c - 64, !1), 1), !1);
    let s = this._h0, r = this._h1, n = this._h2, o = this._h3, h = this._h4, l, a, d;
    for (let c = 0; c < 80; c++) c < 20 ? (l = r & n | ~r & o, a = 1518500249) : c < 40 ? (l = r ^ n ^ o, a = 1859775393) : c < 60 ? (l = r & n | r & o | n & o, a = 2400959708) : (l = r ^ n ^ o, a = 3395469782), d = _i(s, 5) + l + h + a + t.getUint32(c * 4, !1) & 4294967295, h = o, o = n, n = _i(r, 30), r = s, s = d;
    this._h0 = this._h0 + s & 4294967295, this._h1 = this._h1 + r & 4294967295, this._h2 = this._h2 + n & 4294967295, this._h3 = this._h3 + o & 4294967295, this._h4 = this._h4 + h & 4294967295;
  }
};
$o._bigBlock32 = /* @__PURE__ */ new DataView(/* @__PURE__ */ new ArrayBuffer(320));
var { registerWindow: gl, getWindow: Ce, getDocument: vl, getWindows: ml, getWindowsCount: Sl, getWindowId: Ko, getWindowById: bl, hasWindow: wl, onDidRegisterWindow: Uo, onWillUnregisterWindow: yl, onDidUnregisterWindow: Cl } = (function() {
  let e = /* @__PURE__ */ new Map(), t = {
    window: Se,
    disposables: new Ve()
  };
  e.set(Se.vscodeWindowId, t);
  let i = new v(), s = new v(), r = new v();
  function n(o, h) {
  ...
  return {
    ...
    registerWindow(o) {
      if (e.has(o.vscodeWindowId)) return R.None;
      let h = new Ve(), l = {
        window: o,
        disposables: h.add(new Ve())
      };
      return e.set(o.vscodeWindowId, l), h.add(z(() => {
        e.delete(o.vscodeWindowId), s.fire(o);
      })), h.add(B(o, Q.BEFORE_UNLOAD, () => {
        r.fire(o);
      })), i.fire(l), h;
    },
    getWindows() {
    ...
    getWindow(o) {
      let h = o;
      if (h?.ownerDocument?.defaultView) return h.ownerDocument.defaultView.window;
      let l = o;
      return l?.view ? l.view.window : Se;
    },
    getDocument(o) {
      return Ce(o).document;
    }
  };
})(), qo = class {
  constructor(e, t, i, s) {
...
var $s = function(e, t, i, s) {
  let r = i;
  return t === "click" || t === "mousedown" || t === "contextmenu" ? r = Vo(Ce(e), i) : (t === "keydown" || t === "keypress" || t === "keyup") && (r = Yo(i)), B(e, t, r, s);
}, Ss, jo = class extends Ao {
  constructor(e) {
    super(), this.defaultTarget = e && Ce(e);
  }
  cancelAndSet(e, t, i) {
...
(function() {
  let e = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map(), r = (n) => {
    i.set(n, !1);
    let o = e.get(n) ?? [];
    for (t.set(n, o), e.set(n, []), s.set(n, !0); o.length > 0; ) o.sort(Ks.sort), o.shift().execute();
    s.set(n, !1);
  };
  Ss = (n, o, h = 0) => {
    let l = Ko(n), a = new Ks(o, h), d = e.get(l);
...
var Us = class Yt {
  ...
  with(t = this.width, i = this.height) {
    return t !== this.width || i !== this.height ? new Yt(t, i) : this;
  }
  static is(t) {
    return typeof t == "object" && typeof t.height == "number" && typeof t.width == "number";
  }
  static lift(t) {
    return t instanceof Yt ? t : new Yt(t.width, t.height);
  }
  static equals(t, i) {
...
Us.None = new Us(0, 0);
function Xo(e) {
  let t = e.getBoundingClientRect(), i = Ce(e);
  return {
...
new class {
  ...
  observe(e, t, i) {
    ...
    let r = No(i), n = s.get(r);
    if (n) n.users += 1;
    else {
      let o = new v(), h = new MutationObserver((a) => o.fire(a));
      h.observe(e, i);
      let l = n = {
        users: 1,
        observer: h,
      ...
      t.add(z(() => {
        l.users -= 1, l.users === 0 && (o.dispose(), h.disconnect(), s?.delete(r), s?.size === 0 && this.mutationObservers.delete(e));
      })), s.set(r, n);
    }
...
var Q = {
  ...
  DROP: "drop",
  DRAG_END: "dragend",
  ANIMATION_START: $t ? "webkitAnimationStart" : "animationstart",
  ANIMATION_END: $t ? "webkitAnimationEnd" : "animationend",
  ANIMATION_ITERATION: $t ? "webkitAnimationIteration" : "animationiteration"
}, Go = /([\w\-]+)?(#([\w\-]+))?((\.([\w\-]+))*)/;
function en(e, t, i, ...s) {
  let r = Go.exec(t);
  if (!r) throw new Error("Bad use of emmet");
  let n = r[1] || "div", o;
  return e !== "http://www.w3.org/1999/xhtml" ? o = document.createElementNS(e, n) : o = document.createElement(n), r[3] && (o.id = r[3]), r[4] && (o.className = r[4].replace(/\./g, " ").trim()), i && Object.entries(i).forEach(([h, l]) => {
    typeof l > "u" || (/^on\w+$/.test(h) ? o[h] = l : h === "selected" ? l && o.setAttribute(h, "true") : o.setAttribute(h, l));
  }), o.append(...s), o;
}
function Jo(e, t, ...i) {
  return en("http://www.w3.org/1999/xhtml", e, t, ...i);
}
Jo.SVG = function(e, t, ...i) {
  return en("http://www.w3.org/2000/svg", e, t, ...i);
};
var Zo = class {
  constructor(e) {
...
var tn = class {
  constructor() {
    this._hooks = new Ve(), this._pointerMoveCallback = null, this._onStopCallback = null;
  }
  dispose() {
  ...
  startMonitoring(e, t, i, s, r) {
    ...
    let n = e;
    try {
      e.setPointerCapture(t), this._hooks.add(z(() => {
        try {
    ...
    this._hooks.add(B(n, Q.POINTER_MOVE, (o) => {
      if (o.buttons !== i) {
        this.stopMonitoring(!0);
        return;
      }
      o.preventDefault(), this._pointerMoveCallback(o);
    })), this._hooks.add(B(n, Q.POINTER_UP, (o) => this.stopMonitoring(!0)));
  }
};
function Qo(e, t, i) {
  let s = null, r = null;
...
var ye;
((e) => (e.Tap = "-xterm-gesturetap", e.Change = "-xterm-gesturechange", e.Start = "-xterm-gesturestart", e.End = "-xterm-gesturesend", e.Contextmenu = "-xterm-gesturecontextmenu"))(ye || (ye = {}));
var vt = class ae extends R {
  constructor() {
    super(), this.dispatched = !1, this.targets = new Ms(), this.ignoreTargets = new Ms(), this.activeTouches = {}, this.handle = null, this._lastSetTapCountTime = 0, this._register(se.runAndSubscribe(Uo, ({ window: t, disposables: i }) => {
      i.add(B(t.document, "touchstart", (s) => this.onTouchStart(s), { passive: !1 })), i.add(B(t.document, "touchend", (s) => this.onTouchEnd(t, s))), i.add(B(t.document, "touchmove", (s) => this.onTouchMove(s), { passive: !1 }));
    }, {
      window: Se,
  ...
  static addTarget(t) {
    return ae.isTouchDevice() ? (ae.INSTANCE || (ae.INSTANCE = Rs(new ae())), z(ae.INSTANCE.targets.push(t))) : R.None;
  }
  static ignoreTarget(t) {
    return ae.isTouchDevice() ? (ae.INSTANCE || (ae.INSTANCE = Rs(new ae())), z(ae.INSTANCE.ignoreTargets.push(t))) : R.None;
  }
  static isTouchDevice() {
    return "ontouchstart" in Se || navigator.maxTouchPoints > 0;
  }
  dispose() {
  ...
  onTouchStart(t) {
    ...
    for (let s = 0, r = t.targetTouches.length; s < r; s++) {
      ...
      this.activeTouches[n.identifier] = {
        id: n.identifier,
        initialTarget: n.target,
        initialTimeStamp: i,
        initialPageX: n.pageX,
        initialPageY: n.pageY,
        rollingTimestamps: [i],
        rollingPageX: [n.pageX],
        rollingPageY: [n.pageY]
      };
      let o = this.newGestureEvent(ye.Start, n.target);
  ...
  onTouchEnd(t, i) {
    ...
    for (let n = 0, o = i.changedTouches.length; n < o; n++) {
      let h = i.changedTouches.item(n);
      if (!this.activeTouches.hasOwnProperty(String(h.identifier))) {
        console.warn("move of an UNKNOWN touch", h);
        continue;
      }
      let l = this.activeTouches[h.identifier], a = Date.now() - l.initialTimeStamp;
      if (a < ae.HOLD_DELAY && Math.abs(l.initialPageX - _e(l.rollingPageX)) < 30 && Math.abs(l.initialPageY - _e(l.rollingPageY)) < 30) {
        let d = this.newGestureEvent(ye.Tap, l.initialTarget);
        d.pageX = _e(l.rollingPageX), d.pageY = _e(l.rollingPageY), this.dispatchEvent(d);
      } else if (a >= ae.HOLD_DELAY && Math.abs(l.initialPageX - _e(l.rollingPageX)) < 30 && Math.abs(l.initialPageY - _e(l.rollingPageY)) < 30) {
        let d = this.newGestureEvent(ye.Contextmenu, l.initialTarget);
        d.pageX = _e(l.rollingPageX), d.pageY = _e(l.rollingPageY), this.dispatchEvent(d);
      } else if (r === 1) {
        let d = _e(l.rollingPageX), c = _e(l.rollingPageY), _ = _e(l.rollingTimestamps) - l.rollingTimestamps[0], f = d - l.rollingPageX[0], u = c - l.rollingPageY[0], g = [...this.targets].filter((k) => l.initialTarget instanceof Node && k.contains(l.initialTarget));
        this.inertia(t, g, s, Math.abs(f) / _, f > 0 ? 1 : -1, d, Math.abs(u) / _, u > 0 ? 1 : -1, c);
      }
      this.dispatchEvent(this.newGestureEvent(ye.End, l.initialTarget)), delete this.activeTouches[h.identifier];
    }
  ...
  dispatchEvent(t) {
    ...
    } else (t.type === ye.Change || t.type === ye.Contextmenu) && (this._lastSetTapCountTime = 0);
  ...
  inertia(t, i, s, r, n, o, h, l, a) {
    this.handle = Ss(t, () => {
      let d = Date.now(), c = d - s, _ = 0, f = 0, u = !0;
      r += ae.SCROLL_FRICTION * c, h += ae.SCROLL_FRICTION * c, r > 0 && (u = !1, _ = n * r * c), h > 0 && (u = !1, f = l * h * c);
      let g = this.newGestureEvent(ye.Change);
      g.translationX = _, g.translationY = f, i.forEach((k) => k.dispatchEvent(g)), u || this.inertia(t, i, d, r, n, o + _, h, l, a + f);
    });
  }
  onTouchMove(t) {
    let i = Date.now();
    for (let s = 0, r = t.changedTouches.length; s < r; s++) {
      ...
      let o = this.activeTouches[n.identifier], h = this.newGestureEvent(ye.Change, o.initialTarget);
      h.translationX = n.pageX - _e(o.rollingPageX), h.translationY = n.pageY - _e(o.rollingPageY), h.pageX = n.pageX, h.pageY = n.pageY, this.dispatchEvent(h), o.rollingPageX.length > 3 && (o.rollingPageX.shift(), o.rollingPageY.shift(), o.rollingTimestamps.shift()), o.rollingPageX.push(n.pageX), o.rollingPageY.push(n.pageY), o.rollingTimestamps.push(i);
    }
    this.dispatched && (t.preventDefault(), t.stopPropagation(), this.dispatched = !1);
  }
};
vt.SCROLL_FRICTION = -5e-3, vt.HOLD_DELAY = 700, vt.CLEAR_TAP_COUNT_TIME = 400, q([Qo], vt, "isTouchDevice", 1);
var ea = vt, bs = class extends R {
  onclick(e, t) {
    this._register(B(e, Q.CLICK, (i) => t(new gt(Ce(e), i))));
  }
  onmousedown(e, t) {
    this._register(B(e, Q.MOUSE_DOWN, (i) => t(new gt(Ce(e), i))));
  }
  onmouseover(e, t) {
    this._register(B(e, Q.MOUSE_OVER, (i) => t(new gt(Ce(e), i))));
  }
  onmouseleave(e, t) {
    this._register(B(e, Q.MOUSE_LEAVE, (i) => t(new gt(Ce(e), i))));
  }
  onkeydown(e, t) {
    this._register(B(e, Q.KEY_DOWN, (i) => t(new $i(i))));
  }
  onkeyup(e, t) {
    this._register(B(e, Q.KEY_UP, (i) => t(new $i(i))));
  }
  oninput(e, t) {
    this._register(B(e, Q.INPUT, t));
  }
  onblur(e, t) {
    this._register(B(e, Q.BLUR, t));
  }
  onfocus(e, t) {
    this._register(B(e, Q.FOCUS, t));
  }
  onchange(e, t) {
    this._register(B(e, Q.CHANGE, t));
  }
  ignoreGesture(e) {
    return ea.ignoreTarget(e);
  }
}, qs = 11, ta = class extends bs {
  constructor(e) {
    super(), this._onActivate = e.onActivate, this.bgDomNode = document.createElement("div"), this.bgDomNode.className = "arrow-background", this.bgDomNode.style.position = "absolute", this.bgDomNode.style.width = e.bgWidth + "px", this.bgDomNode.style.height = e.bgHeight + "px", typeof e.top < "u" && (this.bgDomNode.style.top = "0px"), typeof e.left < "u" && (this.bgDomNode.style.left = "0px"), typeof e.bottom < "u" && (this.bgDomNode.style.bottom = "0px"), typeof e.right < "u" && (this.bgDomNode.style.right = "0px"), this.domNode = document.createElement("div"), this.domNode.className = e.className, this.domNode.style.position = "absolute", this.domNode.style.width = qs + "px", this.domNode.style.height = qs + "px", typeof e.top < "u" && (this.domNode.style.top = e.top + "px"), typeof e.left < "u" && (this.domNode.style.left = e.left + "px"), typeof e.bottom < "u" && (this.domNode.style.bottom = e.bottom + "px"), typeof e.right < "u" && (this.domNode.style.right = e.right + "px"), this._pointerMoveMonitor = this._register(new tn()), this._register($s(this.bgDomNode, Q.POINTER_DOWN, (t) => this._arrowPointerDown(t))), this._register($s(this.domNode, Q.POINTER_DOWN, (t) => this._arrowPointerDown(t))), this._pointerdownRepeatTimer = this._register(new jo()), this._pointerdownScheduleRepeatTimer = this._register(new vs());
  }
  _arrowPointerDown(e) {
    if (!e.target || !(e.target instanceof Element)) return;
    let t = () => {
      this._pointerdownRepeatTimer.cancelAndSet(() => this._onActivate(), 1e3 / 24, Ce(e));
    };
  ...
  constructor(t, i, s, r, n, o, h) {
    this._forceIntegerValues = t, this._scrollStateBrand = void 0, this._forceIntegerValues && (i = i | 0, s = s | 0, r = r | 0, n = n | 0, o = o | 0, h = h | 0), this.rawScrollLeft = r, this.rawScrollTop = h, i < 0 && (i = 0), r + i > s && (r = s - i), r < 0 && (r = 0), n < 0 && (n = 0), h + n > o && (h = o - n), h < 0 && (h = 0), this.width = i, this.scrollWidth = s, this.scrollLeft = r, this.height = n, this.scrollHeight = o, this.scrollTop = h;
  }
  equals(t) {
  ...
  withScrollDimensions(t, i) {
    return new Ki(this._forceIntegerValues, typeof t.width < "u" ? t.width : this.width, typeof t.scrollWidth < "u" ? t.scrollWidth : this.scrollWidth, i ? this.rawScrollLeft : this.scrollLeft, typeof t.height < "u" ? t.height : this.height, typeof t.scrollHeight < "u" ? t.scrollHeight : this.scrollHeight, i ? this.rawScrollTop : this.scrollTop);
  }
  withScrollPosition(t) {
    return new Ki(this._forceIntegerValues, this.width, this.scrollWidth, typeof t.scrollLeft < "u" ? t.scrollLeft : this.rawScrollLeft, this.height, this.scrollHeight, typeof t.scrollTop < "u" ? t.scrollTop : this.rawScrollTop);
  }
  createScrollEvent(t, i) {
    ...
    return {
      ...
      scrollLeftChanged: n,
      heightChanged: o,
      scrollHeightChanged: h,
      scrollTopChanged: l
    };
  }
}, sa = class extends R {
  constructor(e) {
    super(), this._scrollableBrand = void 0, this._onScroll = this._register(new v()), this.onScroll = this._onScroll.event, this._smoothScrollDuration = e.smoothScrollDuration, this._scheduleAtNextAnimationFrame = e.scheduleAtNextAnimationFrame, this._state = new ia(e.forceIntegerValues, 0, 0, 0, 0, 0, 0), this._smoothScrolling = null;
  }
  dispose() {
  ...
  setScrollPositionSmooth(e, t) {
    ...
    if (this._smoothScrolling) {
      ...
      let s;
      t ? s = new Ys(this._smoothScrolling.from, i, this._smoothScrolling.startTime, this._smoothScrolling.duration) : s = this._smoothScrolling.combine(this._state, i, this._smoothScrollDuration), this._smoothScrolling.dispose(), this._smoothScrolling = s;
    } else {
      let i = this._state.withScrollPosition(e);
      this._smoothScrolling = Ys.start(this._state, i, this._smoothScrollDuration);
    }
...
var Ys = class Ui {
  ...
  _initAnimation(t, i, s) {
    if (Math.abs(t - i) > 2.5 * s) {
      let r, n;
      return t < i ? (r = t + 0.75 * s, n = i - 0.75 * s) : (r = t - 0.75 * s, n = i + 0.75 * s), ra(fi(t, r), fi(n, i), 0.33);
    }
    return fi(t, i);
  }
  dispose() {
  ...
  _tick(t) {
    ...
    return i < 1 ? new Vs(this.scrollLeft(i), this.scrollTop(i), !1) : new Vs(this.to.scrollLeft, this.to.scrollTop, !0);
  }
  combine(t, i, s) {
    return Ui.start(t, i, s);
  }
  static start(t, i, s) {
    s = s + 10;
    let r = Date.now() - 10;
    return new Ui(t, i, r, s);
  }
};
function na(e) {
  return Math.pow(e, 3);
...
var aa = class extends R {
  constructor(e, t, i) {
    super(), this._visibility = e, this._visibleClassName = t, this._invisibleClassName = i, this._domNode = null, this._isVisible = !1, this._isNeeded = !1, this._rawShouldBeVisible = !1, this._shouldBeVisible = !1, this._revealTimer = this._register(new vs());
  }
  setVisibility(e) {
...
}, ha = 140, sn = class extends bs {
  constructor(e) {
    super(), this._lazyRender = e.lazyRender, this._host = e.host, this._scrollable = e.scrollable, this._scrollByPage = e.scrollByPage, this._scrollbarState = e.scrollbarState, this._visibilityController = this._register(new aa(e.visibility, "visible scrollbar " + e.extraScrollbarClassName, "invisible scrollbar " + e.extraScrollbarClassName)), this._visibilityController.setIsNeeded(this._scrollbarState.isNeeded()), this._pointerMoveMonitor = this._register(new tn()), this._shouldRender = !0, this.domNode = yt(document.createElement("div")), this.domNode.setAttribute("role", "presentation"), this.domNode.setAttribute("aria-hidden", "true"), this._visibilityController.setDomNode(this.domNode), this.domNode.setPosition("absolute"), this._register(B(this.domNode.domNode, Q.POINTER_DOWN, (t) => this._domNodePointerDown(t)));
  }
  _createArrow(e) {
    let t = this._register(new ta(e));
    this.domNode.domNode.appendChild(t.bgDomNode), this.domNode.domNode.appendChild(t.domNode);
  }
  _createSlider(e, t, i, s) {
    this.slider = yt(document.createElement("div")), this.slider.setClassName("slider"), this.slider.setPosition("absolute"), this.slider.setTop(e), this.slider.setLeft(t), typeof i == "number" && this.slider.setWidth(i), typeof s == "number" && this.slider.setHeight(s), this.slider.setLayerHinting(!0), this.slider.setContain("strict"), this.domNode.domNode.appendChild(this.slider.domNode), this._register(B(this.slider.domNode, Q.POINTER_DOWN, (r) => {
  ...
  _sliderPointerDown(e) {
    ...
    this.slider.toggleClassName("active", !0), this._pointerMoveMonitor.startMonitoring(e.target, e.pointerId, e.buttons, (r) => {
      ...
      let h = this._sliderPointerPosition(r) - t;
      this._setDesiredScrollPositionNow(s.getDesiredScrollPositionFromDelta(h));
    }, () => {
  ...
  clone() {
    return new qi(this._arrowSize, this._scrollbarSize, this._oppositeScrollbarSize, this._visibleSize, this._scrollSize, this._scrollPosition);
  }
  setVisibleSize(t) {
    let i = Math.round(t);
  ...
  _refreshComputedValues() {
    let t = qi._computeValues(this._oppositeScrollbarSize, this._arrowSize, this._visibleSize, this._scrollSize, this._scrollPosition);
  ...
  constructor(e, t, i) {
    ...
    if (super({
      ...
      host: i,
      scrollbarState: new rn(t.horizontalHasArrows ? t.arrowSize : 0, t.horizontal === 2 ? 0 : t.horizontalScrollbarSize, t.vertical === 2 ? 0 : t.verticalScrollbarSize, s.width, s.scrollWidth, r.scrollLeft),
  ...
  constructor(e, t, i) {
    ...
    if (super({
      lazyRender: t.lazyRender,
      host: i,
      scrollbarState: new rn(t.verticalHasArrows ? t.arrowSize : 0, t.vertical === 2 ? 0 : t.verticalScrollbarSize, 0, s.height, s.scrollHeight, r.scrollTop),
...
Vi.INSTANCE = new Vi();
var _a = Vi, fa = class extends bs {
  constructor(e, t, i) {
    super(), this._onScroll = this._register(new v()), this.onScroll = this._onScroll.event, this._onWillScroll = this._register(new v()), this.onWillScroll = this._onWillScroll.event, this._options = ga(t), this._scrollable = i, this._register(this._scrollable.onScroll((r) => {
    ...
    this._verticalScrollbar = this._register(new ca(this._scrollable, this._options, s)), this._horizontalScrollbar = this._register(new la(this._scrollable, this._options, s)), this._domNode = document.createElement("div"), this._domNode.className = "xterm-scrollable-element " + this._options.className, this._domNode.setAttribute("role", "presentation"), this._domNode.style.position = "relative", this._domNode.appendChild(e), this._domNode.appendChild(this._horizontalScrollbar.domNode.domNode), this._domNode.appendChild(this._verticalScrollbar.domNode.domNode), this._options.useShadows ? (this._leftShadowDomNode = yt(document.createElement("div")), this._leftShadowDomNode.setClassName("shadow"), this._domNode.appendChild(this._leftShadowDomNode.domNode), this._topShadowDomNode = yt(document.createElement("div")), this._topShadowDomNode.setClassName("shadow"), this._domNode.appendChild(this._topShadowDomNode.domNode), this._topLeftShadowDomNode = yt(document.createElement("div")), this._topLeftShadowDomNode.setClassName("shadow"), this._domNode.appendChild(this._topLeftShadowDomNode.domNode)) : (this._leftShadowDomNode = null, this._topShadowDomNode = null, this._topLeftShadowDomNode = null), this._listenOnDomNode = this._options.listenOnDomNode || this._domNode, this._mouseWheelToDispose = [], this._setListeningToMouseWheel(this._options.handleMouseWheel), this.onmouseover(this._listenOnDomNode, (r) => this._onMouseOver(r)), this.onmouseleave(this._listenOnDomNode, (r) => this._onMouseLeave(r)), this._hideTimeout = this._register(new vs()), this._isDragging = !1, this._mouseIsOver = !1, this._shouldRender = !0, this._revealOnScroll = !0;
  }
  get options() {
  ...
  updateClassName(e) {
    this._options.className = e, Be && (this._options.className += " mac"), this._domNode.className = "xterm-scrollable-element " + this._options.className;
  }
  updateOptions(e) {
  ...
  delegateScrollFromMouseWheelEvent(e) {
    this._onMouseWheel(new Is(e));
  }
  _setListeningToMouseWheel(e) {
    if (this._mouseWheelToDispose.length > 0 !== e && (this._mouseWheelToDispose = Qe(this._mouseWheelToDispose), e)) {
      let t = (i) => {
        this._onMouseWheel(new Is(i));
      };
      this._mouseWheelToDispose.push(B(this._listenOnDomNode, Q.MOUSE_WHEEL, t, { passive: !1 }));
    }
  }
  _onMouseWheel(e) {
    if (e.browserEvent?.defaultPrevented) return;
    let t = _a.INSTANCE;
    Xs && t.acceptStandardWheelEvent(e);
    let i = !1;
    if (e.deltaY || e.deltaX) {
      ...
      let o = !Be && e.browserEvent && e.browserEvent.shiftKey;
      ...
      if (r) {
        let a = js * r, d = h.scrollTop - (a < 0 ? Math.floor(a) : Math.ceil(a));
        this._verticalScrollbar.writeScrollPosition(l, d);
      }
      if (n) {
        let a = js * n, d = h.scrollLeft - (a < 0 ? Math.floor(a) : Math.ceil(a));
        this._horizontalScrollbar.writeScrollPosition(l, d);
      }
      l = this._scrollable.validateScrollPosition(l), (h.scrollLeft !== l.scrollLeft || h.scrollTop !== l.scrollTop) && (Xs && this._options.mouseWheelSmoothScroll && t.isPhysicalMouseWheel() ? this._scrollable.setScrollPositionSmooth(l) : this._scrollable.setScrollPositionNow(l), i = !0);
    }
    let s = i;
  ...
  _scheduleHide() {
    !this._mouseIsOver && !this._isDragging && this._hideTimeout.cancelAndSet(() => this._hide(), da);
  }
}, pa = class extends fa {
  constructor(e, t, i) {
    super(e, t, i);
...
function ga(e) {
  ...
  return t.horizontalSliderSize = typeof e.horizontalSliderSize < "u" ? e.horizontalSliderSize : t.horizontalScrollbarSize, t.verticalSliderSize = typeof e.verticalSliderSize < "u" ? e.verticalSliderSize : t.verticalScrollbarSize, Be && (t.className += " mac"), t;
}
var Yi = class extends R {
  constructor(e, t, i, s, r, n, o, h) {
    super(), this._bufferService = i, this._optionsService = o, this._renderService = h, this._onRequestScrollLines = this._register(new v()), this.onRequestScrollLines = this._onRequestScrollLines.event, this._isSyncing = !1, this._isHandlingScroll = !1, this._suppressOnScrollHandler = !1;
    let l = this._register(new sa({
      forceIntegerValues: !1,
      smoothScrollDuration: this._optionsService.rawOptions.smoothScrollDuration,
      scheduleAtNextAnimationFrame: (a) => Ss(s.window, a)
    }));
    ...
    })), this._scrollableElement = this._register(new pa(t, {
      vertical: 1,
      horizontal: 2,
      useShadows: !1,
      mouseWheelSmoothScroll: !0,
      ...this._getChangeOptions()
    }, l)), this._register(this._optionsService.onMultipleOptionChange([
      "scrollSensitivity",
      "fastScrollSensitivity",
      "overviewRuler"
    ], () => this._scrollableElement.updateOptions(this._getChangeOptions()))), this._register(r.onProtocolChange((a) => {
      this._scrollableElement.updateOptions({ handleMouseWheel: !(a & 16) });
    })), this._scrollableElement.setScrollDimensions({
      height: 0,
      scrollHeight: 0
    }), this._register(se.runAndSubscribe(n.onChangeColors, () => {
      this._scrollableElement.getDomNode().style.backgroundColor = n.colors.background.css;
    })), e.appendChild(this._scrollableElement.getDomNode()), this._register(z(() => this._scrollableElement.getDomNode().remove())), this._styleElement = s.mainDocument.createElement("style"), t.appendChild(this._styleElement), this._register(z(() => this._styleElement.remove())), this._register(se.runAndSubscribe(n.onChangeColors, () => {
...
`);
    ...
    })), this._register(this._bufferService.onScroll(() => this._sync())), this._register(this._scrollableElement.onScroll((a) => this._handleScroll(a)));
  }
  scrollLines(e) {
...
var ji = class extends R {
  constructor(e, t, i, s, r) {
    ...
    })), this._register(this._decorationService.onDecorationRegistered(() => this._queueRefresh())), this._register(this._decorationService.onDecorationRemoved((n) => this._removeDecoration(n))), this._register(z(() => {
...
var va = class {
  ...
  constructor(e, t, i, s, r, n, o, h) {
    super(), this._viewportElement = e, this._screenElement = t, this._bufferService = i, this._decorationService = s, this._renderService = r, this._optionsService = n, this._themeService = o, this._coreBrowserService = h, this._colorZoneStore = new va(), this._shouldUpdateDimensions = !0, this._shouldUpdateAnchor = !0, this._lastKnownBufferLength = 0, this._canvas = this._coreBrowserService.mainDocument.createElement("canvas"), this._canvas.classList.add("xterm-decoration-overview-ruler"), this._refreshCanvasDimensions(), this._viewportElement.parentElement?.insertBefore(this._canvas, this._viewportElement), this._register(z(() => this._canvas?.remove()));
  ...
  _refreshDrawConstants() {
    ...
    $e.full = this._canvas.width, $e.left = e, $e.center = t, $e.right = e, this._refreshDrawHeightConstants(), ct.full = 1, ct.left = 1, ct.center = 1 + $e.left, ct.right = 1 + $e.left + $e.center;
  }
  _refreshDrawHeightConstants() {
    Ee.full = Math.round(2 * this._coreBrowserService.dpr);
    ...
    Ee.left = t, Ee.center = t, Ee.right = t;
  }
  _refreshColorZonePadding() {
    this._colorZoneStore.setPadding({
      full: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Ee.full),
      left: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Ee.left),
      center: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Ee.center),
      right: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Ee.right)
  ...
  _renderColorZone(e) {
    this._ctx.fillStyle = e.color, this._ctx.fillRect(ct[e.position || "full"], Math.round((this._canvas.height - 1) * (e.startBufferLine / this._bufferService.buffers.active.lines.length) - Ee[e.position || "full"] / 2), $e[e.position || "full"], Math.round((this._canvas.height - 1) * ((e.endBufferLine - e.startBufferLine) / this._bufferService.buffers.active.lines.length) + Ee[e.position || "full"]));
  }
  _queueRefresh(e, t) {
...
`, e.VT = "\v", e.FF = "\f", e.CR = "\r", e.SO = "", e.SI = "", e.DLE = "", e.DC1 = "", e.DC2 = "", e.DC3 = "", e.DC4 = "", e.NAK = "", e.SYN = "", e.ETB = "", e.CAN = "", e.EM = "", e.SUB = "", e.ESC = "\x1B", e.FS = "", e.GS = "", e.RS = "", e.US = "", e.SP = " ", e.DEL = ""))(p || (p = {}));
var Ct;
((e) => (e.PAD = "", e.HOP = "", e.BPH = "", e.NBH = "", e.IND = "", e.NEL = "", e.SSA = "", e.ESA = "", e.HTS = "", e.HTJ = "", e.VTS = "", e.PLD = "", e.PLU = "", e.RI = "", e.SS2 = "", e.SS3 = "", e.DCS = "", e.PU1 = "", e.PU2 = "", e.STS = "", e.CCH = "", e.MW = "", e.SPA = "", e.EPA = "", e.SOS = "", e.SGCI = "", e.SCI = "", e.CSI = "", e.ST = "", e.OSC = "", e.PM = "", e.APC = ""))(Ct || (Ct = {}));
var Xi;
((e) => e.ST = `${p.ESC}\\`)(Xi || (Xi = {}));
var Gi = class {
  ...
  _handleAnyTextareaChanges() {
    ...
    setTimeout(() => {
      if (!this._isComposing) {
        ...
        this._dataAlreadySent = i, t.length > e.length ? this._coreService.triggerDataEvent(i, !0) : t.length < e.length ? this._coreService.triggerDataEvent(`${p.DEL}`, !0) : t.length === e.length && t !== e && this._coreService.triggerDataEvent(t, !0);
      }
    }, 0);
  }
...
var ee = 0, te = 0, ie = 0, U = 0, Gs = {
  css: "#00000000",
  rgba: 0
}, Y;
((e) => {
  function t(r, n, o, h) {
    return h !== void 0 ? `#${je(r)}${je(n)}${je(o)}${je(h)}` : `#${je(r)}${je(n)}${je(o)}`;
  }
  e.toCss = t;
  function i(r, n, o, h = 255) {
    return (r << 24 | n << 16 | o << 8 | h) >>> 0;
  }
  e.toRgba = i;
  function s(r, n, o, h) {
    return {
      css: e.toCss(r, n, o, h),
      rgba: e.toRgba(r, n, o, h)
    };
  }
  e.toColor = s;
})(Y || (Y = {}));
...
((e) => {
  function t(l, a) {
    if (U = (a.rgba & 255) / 255, U === 1) return {
      css: a.css,
      rgba: a.rgba
    };
    let d = a.rgba >> 24 & 255, c = a.rgba >> 16 & 255, _ = a.rgba >> 8 & 255, f = l.rgba >> 24 & 255, u = l.rgba >> 16 & 255, g = l.rgba >> 8 & 255;
    return ee = f + Math.round((d - f) * U), te = u + Math.round((c - u) * U), ie = g + Math.round((_ - g) * U), {
      css: Y.toCss(ee, te, ie),
      rgba: Y.toRgba(ee, te, ie)
    };
  }
  e.blend = t;
  function i(l) {
  ...
  e.isOpaque = i;
  function s(l, a, d) {
    let c = kt.ensureContrastRatio(l.rgba, a.rgba, d);
    if (c) return Y.toColor(c >> 24 & 255, c >> 16 & 255, c >> 8 & 255);
  }
  e.ensureContrastRatio = s;
  function r(l) {
    let a = (l.rgba | 255) >>> 0;
    return [ee, te, ie] = kt.toChannels(a), {
      css: Y.toCss(ee, te, ie),
      rgba: a
    };
  }
  e.opaque = r;
  function n(l, a) {
    return U = Math.round(a * 255), [ee, te, ie] = kt.toChannels(l.rgba), {
      css: Y.toCss(ee, te, ie, U),
      rgba: Y.toRgba(ee, te, ie, U)
    };
  }
  e.opacity = n;
  function o(l, a) {
    return U = l.rgba & 255, n(l, U * a / 255);
  }
  e.multiplyOpacity = o;
  function h(l) {
    return [
...
((e) => {
  ...
  function s(r) {
    if (r.match(/#[\da-f]{3,8}/i)) switch (r.length) {
      case 4:
        return ee = parseInt(r.slice(1, 2).repeat(2), 16), te = parseInt(r.slice(2, 3).repeat(2), 16), ie = parseInt(r.slice(3, 4).repeat(2), 16), Y.toColor(ee, te, ie);
      case 5:
        return ee = parseInt(r.slice(1, 2).repeat(2), 16), te = parseInt(r.slice(2, 3).repeat(2), 16), ie = parseInt(r.slice(3, 4).repeat(2), 16), U = parseInt(r.slice(4, 5).repeat(2), 16), Y.toColor(ee, te, ie, U);
      case 7:
        return {
          css: r,
    ...
    if (n) return ee = parseInt(n[1]), te = parseInt(n[2]), ie = parseInt(n[3]), U = Math.round((n[5] === void 0 ? 1 : parseFloat(n[5])) * 255), Y.toColor(ee, te, ie, U);
    ...
    if (t.fillRect(0, 0, 1, 1), [ee, te, ie, U] = t.getImageData(0, 0, 1, 1).data, U !== 255) throw new Error("css.toColor: Unsupported css format");
    return {
      rgba: Y.toRgba(ee, te, ie, U),
      css: r
    };
...
((e) => {
  function t(o, h) {
    if (U = (h & 255) / 255, U === 1) return h;
    let l = h >> 24 & 255, a = h >> 16 & 255, d = h >> 8 & 255, c = o >> 24 & 255, _ = o >> 16 & 255, f = o >> 8 & 255;
    return ee = c + Math.round((l - c) * U), te = _ + Math.round((a - _) * U), ie = f + Math.round((d - f) * U), Y.toRgba(ee, te, ie);
  }
  e.blend = t;
  function i(o, h, l) {
    let a = he.relativeLuminance(o >> 8), d = he.relativeLuminance(h >> 8);
    if (Le(a, d) < l) {
      if (d < a) {
        let f = s(o, h, l), u = Le(a, he.relativeLuminance(f >> 8));
        if (u < l) {
          let g = r(o, h, l);
          return u > Le(a, he.relativeLuminance(g >> 8)) ? f : g;
        }
        return f;
      }
      let c = r(o, h, l), _ = Le(a, he.relativeLuminance(c >> 8));
      if (_ < l) {
        let f = s(o, h, l);
        return _ > Le(a, he.relativeLuminance(f >> 8)) ? c : f;
      }
      return c;
    }
  }
  ...
  function s(o, h, l) {
    let a = o >> 24 & 255, d = o >> 16 & 255, c = o >> 8 & 255, _ = h >> 24 & 255, f = h >> 16 & 255, u = h >> 8 & 255, g = Le(he.relativeLuminance2(_, f, u), he.relativeLuminance2(a, d, c));
    for (; g < l && (_ > 0 || f > 0 || u > 0); ) _ -= Math.max(0, Math.ceil(_ * 0.1)), f -= Math.max(0, Math.ceil(f * 0.1)), u -= Math.max(0, Math.ceil(u * 0.1)), g = Le(he.relativeLuminance2(_, f, u), he.relativeLuminance2(a, d, c));
    return (_ << 24 | f << 16 | u << 8 | 255) >>> 0;
  }
  e.reduceLuminance = s;
  function r(o, h, l) {
    let a = o >> 24 & 255, d = o >> 16 & 255, c = o >> 8 & 255, _ = h >> 24 & 255, f = h >> 16 & 255, u = h >> 8 & 255, g = Le(he.relativeLuminance2(_, f, u), he.relativeLuminance2(a, d, c));
    for (; g < l && (_ < 255 || f < 255 || u < 255); ) _ = Math.min(255, _ + Math.ceil((255 - _) * 0.1)), f = Math.min(255, f + Math.ceil((255 - f) * 0.1)), u = Math.min(255, u + Math.ceil((255 - u) * 0.1)), g = Le(he.relativeLuminance2(_, f, u), he.relativeLuminance2(a, d, c));
    return (_ << 24 | f << 16 | u << 8 | 255) >>> 0;
  }
...
var ma = class extends Rt {
  ...
  constructor(e) {
    this._bufferService = e, this._characterJoiners = [], this._nextCharacterJoinerId = 0, this._workCell = new be();
  }
  register(e) {
    let t = {
  ...
  getJoinedCharacters(e) {
    ...
    let i = [], s = t.translateToString(!0), r = 0, n = 0, o = 0, h = t.getFg(0), l = t.getBg(0);
    for (let a = 0; a < t.getTrimmedLength(); a++) if (t.loadCell(a, this._workCell), this._workCell.getWidth() !== 0) {
      ...
      n += this._workCell.getChars().length || qe.length;
    }
  ...
  _getJoinedRanges(e, t, i, s, r) {
    ...
    for (let h = 1; h < this._characterJoiners.length; h++) try {
      let l = this._characterJoiners[h].handler(n);
      for (let a = 0; a < l.length; a++) Jt._mergeRanges(o, l[a]);
    } catch (l) {
      console.error(l);
    }
  ...
  _stringRangesToCellRanges(e, t, i) {
    ...
    if (o) {
      for (let h = i; h < this._bufferService.cols; h++) {
        let l = t.getWidth(h), a = t.getString(h).length || qe.length;
        if (l !== 0) {
          if (!r && o[0] <= n && (o[0] = h, r = !0), o[1] <= n) {
            if (o[1] = h, o = e[++s], !o) break;
            o[0] <= n ? (o[0] = h, r = !0) : r = !1;
          }
          n += a;
        }
...
var Ji = class {
  constructor(e, t, i, s, r, n, o) {
    this._document = e, this._characterJoinerService = t, this._optionsService = i, this._coreBrowserService = s, this._coreService = r, this._decorationService = n, this._themeService = o, this._workCell = new be(), this._columnSelectMode = !1, this.defaultSpacing = 0;
  }
  ...
  createRow(e, t, i, s, r, n, o, h, l, a, d) {
    let c = [], _ = this._characterJoinerService.getJoinedCharacters(t), f = this._themeService.colors, u = e.getNoBgTrimmedLength();
    i && u < n + 1 && (u = n + 1);
    let g, k = 0, D = "", I = 0, L = 0, E = 0, P = 0, A = !1, ne = 0, we = !1, ke = 0, Tt = 0, F = [], ai = a !== -1 && d !== -1;
    for (let b = 0; b < u; b++) {
      e.loadCell(b, this._workCell);
      let m = this._workCell.getWidth();
      if (m === 0) continue;
      let C = !1, w = b >= Tt, x = b, S = this._workCell;
      if (_.length > 0 && b === _[0][0] && w) {
        let O = _.shift(), hi = this._isCellInSelection(O[0], t);
        for (I = O[0] + 1; I < O[1]; I++) w && (w = hi === this._isCellInSelection(I, t));
        w && (w = !i || n < O[0] || n >= O[1]), w ? (C = !0, S = new ma(this._workCell, e.translateToString(!0, O[0], O[1]), O[1] - O[0]), x = O[1] - 1, m = S.getWidth()) : Tt = O[1];
      }
      let T = this._isCellInSelection(b, t), $ = i && b === n, oe = ai && b >= a && b <= d, xe = !1;
      this._decorationService.forEachDecorationAtCell(b, t, void 0, (O) => {
        xe = !0;
      });
      let Me = S.getChars() || qe;
      if (Me === " " && (S.isUnderline() || S.isOverline()) && (Me = " "), ke = m * h - l.get(Me, S.isBold(), S.isItalic()), !g) g = this._document.createElement("span");
      else if (k && (T && we || !T && !we && S.bg === L) && (T && we && f.selectionForeground || S.fg === E) && S.extended.ext === P && oe === A && ke === ne && !$ && !C && !xe && w) {
        S.isInvisible() ? D += qe : D += Me, k++;
        continue;
      } else k && (g.textContent = D), g = this._document.createElement("span"), k = 0, D = "";
      if (L = S.bg, E = S.fg, P = S.extended.ext, A = oe, ne = ke, we = T, C && n >= b && n <= x && (n = b), !this._coreService.isCursorHidden && $ && this._coreService.isCursorInitialized) {
        if (F.push("xterm-cursor"), this._coreBrowserService.isFocused) o && F.push("xterm-cursor-blink"), F.push(s === "bar" ? "xterm-cursor-bar" : s === "underline" ? "xterm-cursor-underline" : "xterm-cursor-block");
        else if (r) switch (r) {
          case "outline":
            F.push("xterm-cursor-outline");
            break;
          case "block":
            F.push("xterm-cursor-block");
            break;
          case "bar":
            F.push("xterm-cursor-bar");
            break;
          case "underline":
            F.push("xterm-cursor-underline");
            break;
          default:
            break;
        }
      }
      if (S.isBold() && F.push("xterm-bold"), S.isItalic() && F.push("xterm-italic"), S.isDim() && F.push("xterm-dim"), S.isInvisible() ? D = qe : D = S.getChars() || qe, S.isUnderline() && (F.push(`xterm-underline-${S.extended.underlineStyle}`), D === " " && (D = " "), !S.isUnderlineColorDefault())) if (S.isUnderlineColorRGB()) g.style.textDecorationColor = `rgb(${Rt.toColorRGB(S.getUnderlineColor()).join(",")})`;
      else {
        let O = S.getUnderlineColor();
        this._optionsService.rawOptions.drawBoldTextInBrightColors && S.isBold() && O < 8 && (O += 8), g.style.textDecorationColor = f.ansi[O].css;
      }
      S.isOverline() && (F.push("xterm-overline"), D === " " && (D = " ")), S.isStrikethrough() && F.push("xterm-strikethrough"), oe && (g.style.textDecoration = "underline");
      let Z = S.getFgColor(), Ne = S.getFgColorMode(), le = S.getBgColor(), Ye = S.getBgColorMode(), at = !!S.isInverse();
      if (at) {
        let O = Z;
        Z = le, le = O;
        let hi = Ne;
      ...
      let He, At, ht = !1;
      this._decorationService.forEachDecorationAtCell(b, t, void 0, (O) => {
        O.options.layer !== "top" && ht || (O.backgroundColorRGB && (Ye = 50331648, le = O.backgroundColorRGB.rgba >> 8 & 16777215, He = O.backgroundColorRGB), O.foregroundColorRGB && (Ne = 50331648, Z = O.foregroundColorRGB.rgba >> 8 & 16777215, At = O.foregroundColorRGB), ht = O.options.layer === "top");
      }), !ht && T && (He = this._coreBrowserService.isFocused ? f.selectionBackgroundOpaque : f.selectionInactiveBackgroundOpaque, le = He.rgba >> 8 & 16777215, Ye = 50331648, ht = !0, f.selectionForeground && (Ne = 50331648, Z = f.selectionForeground.rgba >> 8 & 16777215, At = f.selectionForeground)), ht && F.push("xterm-decoration-top");
      let ze;
      switch (Ye) {
        case 16777216:
        case 33554432:
          ze = f.ansi[le], F.push(`xterm-bg-${le}`);
          break;
        case 50331648:
          ze = Y.toColor(le >> 16, le >> 8 & 255, le & 255), this._addStyle(g, `background-color:#${Js((le >>> 0).toString(16), "0", 6)}`);
          break;
        default:
          at ? (ze = f.foreground, F.push("xterm-bg-257")) : ze = f.background;
      }
      switch (He || S.isDim() && (He = H.multiplyOpacity(ze, 0.5)), Ne) {
        case 16777216:
        case 33554432:
          S.isBold() && Z < 8 && this._optionsService.rawOptions.drawBoldTextInBrightColors && (Z += 8), this._applyMinimumContrast(g, ze, f.ansi[Z], S, He, void 0) || F.push(`xterm-fg-${Z}`);
          break;
        case 50331648:
          let O = Y.toColor(Z >> 16 & 255, Z >> 8 & 255, Z & 255);
          this._applyMinimumContrast(g, ze, O, S, He, At) || this._addStyle(g, `color:#${Js(Z.toString(16), "0", 6)}`);
          break;
        default:
          this._applyMinimumContrast(g, ze, f.foreground, S, He, At) || at && F.push("xterm-fg-257");
      }
      F.length && (g.className = F.join(" "), F.length = 0), !$ && !C && !xe && w ? k++ : g.textContent = D, ke !== this.defaultSpacing && (g.style.letterSpacing = `${ke}px`), c.push(g), b = x;
    }
    return g && k && (g.textContent = D), c;
  }
  _applyMinimumContrast(e, t, i, s, r, n) {
    if (this._optionsService.rawOptions.minimumContrastRatio === 1 || wa(s.getCode())) return !1;
    ...
    if (!r && !n && (h = o.getColor(t.rgba, i.rgba)), h === void 0) {
      ...
      h = H.ensureContrastRatio(r || t, n || i, l), o.setColor((r || t).rgba, (n || i).rgba, h ?? null);
    }
...
var Ca = class {
  ...
  update(e, t, i, s = !1) {
    ...
    let r = e.buffers.active.ydisp, n = t[1] - r, o = i[1] - r, h = Math.max(n, 0), l = Math.min(o, e.rows - 1);
    if (h >= e.rows || l < 0) {
      this.clear();
      return;
    }
    this.hasSelection = !0, this.columnSelectMode = s, this.viewportStartRow = n, this.viewportEndRow = o, this.viewportCappedStartRow = h, this.viewportCappedEndRow = l, this.startCol = t[0], this.endCol = i[0];
  }
...
var pi = "xterm-dom-renderer-owner-", ge = "xterm-rows", It = "xterm-fg-", Zs = "xterm-bg-", dt = "xterm-focus", Nt = "xterm-selection", Ea = 1, Zi = class extends R {
  constructor(e, t, i, s, r, n, o, h, l, a, d, c, _, f) {
    super(), this._terminal = e, this._document = t, this._element = i, this._screenElement = s, this._viewportElement = r, this._helperContainer = n, this._linkifier2 = o, this._charSizeService = l, this._optionsService = a, this._bufferService = d, this._coreService = c, this._coreBrowserService = _, this._themeService = f, this._terminalClass = Ea++, this._rowElements = [], this._selectionRenderModel = xa(), this.onRequestRedraw = this._register(new v()).event, this._rowContainer = this._document.createElement("div"), this._rowContainer.classList.add(ge), this._rowContainer.style.lineHeight = "normal", this._rowContainer.setAttribute("aria-hidden", "true"), this._refreshRowElements(this._bufferService.cols, this._bufferService.rows), this._selectionContainer = this._document.createElement("div"), this._selectionContainer.classList.add(Nt), this._selectionContainer.setAttribute("aria-hidden", "true"), this.dimensions = ya(), this._updateDimensions(), this._register(this._optionsService.onOptionChange(() => this._handleOptionsChanged())), this._register(this._themeService.onChangeColors((u) => this._injectCss(u))), this._injectCss(this._themeService.colors), this._rowFactory = h.createInstance(Ji, document), this._element.classList.add(pi + this._terminalClass), this._screenElement.appendChild(this._rowContainer), this._screenElement.appendChild(this._selectionContainer), this._register(this._linkifier2.onShowLinkUnderline((u) => this._handleLinkHover(u))), this._register(this._linkifier2.onHideLinkUnderline((u) => this._handleLinkLeave(u))), this._register(z(() => {
      this._element.classList.remove(pi + this._terminalClass), this._rowContainer.remove(), this._selectionContainer.remove(), this._widthCache.dispose(), this._themeStyleElement.remove(), this._dimensionsStyleElement.remove();
    })), this._widthCache = new Ca(this._document, this._helperContainer), this._widthCache.setFont(this._optionsService.rawOptions.fontFamily, this._optionsService.rawOptions.fontSize, this._optionsService.rawOptions.fontWeight, this._optionsService.rawOptions.fontWeightBold), this._setDefaultSpacing();
  }
  _updateDimensions() {
    ...
    let t = `${this._terminalSelector} .${ge} span { display: inline-block; height: 100%; vertical-align: top;}`;
  ...
  _injectCss(e) {
    ...
    let t = `${this._terminalSelector} .${ge} { pointer-events: none; color: ${e.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px; font-kerning: none; white-space: pre}`;
    t += `${this._terminalSelector} .${ge} .xterm-dim { color: ${H.multiplyOpacity(e.foreground, 0.5).css};}`, t += `${this._terminalSelector} span:not(.xterm-bold) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.xterm-bold { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.xterm-italic { font-style: italic;}`;
    let i = `blink_underline_${this._terminalClass}`, s = `blink_bar_${this._terminalClass}`, r = `blink_block_${this._terminalClass}`;
    t += `@keyframes ${i} { 50% {  border-bottom-style: hidden; }}`, t += `@keyframes ${s} { 50% {  box-shadow: none; }}`, t += `@keyframes ${r} { 0% {  background-color: ${e.cursor.css};  color: ${e.cursorAccent.css}; } 50% {  background-color: inherit;  color: ${e.cursor.css}; }}`, t += `${this._terminalSelector} .${ge}.${dt} .xterm-cursor.xterm-cursor-blink.xterm-cursor-underline { animation: ${i} 1s step-end infinite;}${this._terminalSelector} .${ge}.${dt} .xterm-cursor.xterm-cursor-blink.xterm-cursor-bar { animation: ${s} 1s step-end infinite;}${this._terminalSelector} .${ge}.${dt} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: ${r} 1s step-end infinite;}${this._terminalSelector} .${ge} .xterm-cursor.xterm-cursor-block { background-color: ${e.cursor.css}; color: ${e.cursorAccent.css};}${this._terminalSelector} .${ge} .xterm-cursor.xterm-cursor-block:not(.xterm-cursor-blink) { background-color: ${e.cursor.css} !important; color: ${e.cursorAccent.css} !important;}${this._terminalSelector} .${ge} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${e.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${ge} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${e.cursor.css} inset;}${this._terminalSelector} .${ge} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${e.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`, t += `${this._terminalSelector} .${Nt} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${Nt} div { position: absolute; background-color: ${e.selectionBackgroundOpaque.css};}${this._terminalSelector} .${Nt} div { position: absolute; background-color: ${e.selectionInactiveBackgroundOpaque.css};}`;
    for (let [n, o] of e.ansi.entries()) t += `${this._terminalSelector} .${It}${n} { color: ${o.css}; }${this._terminalSelector} .${It}${n}.xterm-dim { color: ${H.multiplyOpacity(o, 0.5).css}; }${this._terminalSelector} .${Zs}${n} { background-color: ${o.css}; }`;
    t += `${this._terminalSelector} .${It}257 { color: ${H.opaque(e.background).css}; }${this._terminalSelector} .${It}257.xterm-dim { color: ${H.multiplyOpacity(H.opaque(e.background), 0.5).css}; }${this._terminalSelector} .${Zs}257 { background-color: ${e.foreground.css}; }`, this._themeStyleElement.textContent = t;
  }
  _setDefaultSpacing() {
  ...
  handleBlur() {
    this._rowContainer.classList.remove(dt), this.renderRows(0, this._bufferService.rows - 1);
  }
  handleFocus() {
    this._rowContainer.classList.add(dt), this.renderRows(this._bufferService.buffer.y, this._bufferService.buffer.y);
  }
  handleSelectionChanged(e, t, i) {
    ...
    let s = this._selectionRenderModel.viewportStartRow, r = this._selectionRenderModel.viewportEndRow, n = this._selectionRenderModel.viewportCappedStartRow, o = this._selectionRenderModel.viewportCappedEndRow, h = this._document.createDocumentFragment();
    if (i) {
      let l = e[0] > t[0];
      h.appendChild(this._createSelectionElement(n, l ? t[0] : e[0], l ? e[0] : t[0], o - n + 1));
    } else {
  ...
  _setCellUnderline(e, t, i, s, r, n) {
    ...
    for (let f = i; f <= s; ++f) {
      let u = f + h.ydisp, g = this._rowElements[f], k = h.lines.get(u);
      if (!g || !k) break;
      g.replaceChildren(...this._rowFactory.createRow(k, u, u === l, c, _, a, d, this.dimensions.css.cell.width, this._widthCache, n ? f === i ? e : 0 : -1, n ? (f === s ? t : r) - 1 : -1));
    }
  }
};
Zi = q([
...
var Qi = class extends R {
  constructor(e, t, i) {
    super(), this._optionsService = i, this.width = 0, this.height = 0, this._onCharSizeChange = this._register(new v()), this.onCharSizeChange = this._onCharSizeChange.event;
    try {
      this._measureStrategy = this._register(new Ba(this._optionsService));
    } catch {
      this._measureStrategy = this._register(new Da(e, t, this._optionsService));
    }
...
var nn = class extends R {
  ...
  constructor(e, t, i) {
    super(), this._textarea = e, this._window = t, this.mainDocument = i, this._isFocused = !1, this._cachedIsFocused = void 0, this._screenDprMonitor = this._register(new Ma(this._window)), this._onDprChange = this._register(new v()), this.onDprChange = this._onDprChange.event, this._onWindowChange = this._register(new v()), this.onWindowChange = this._onWindowChange.event, this._register(this.onWindowChange((s) => this._screenDprMonitor.setWindow(s))), this._register(se.forward(this._screenDprMonitor.onDprChange, this._onDprChange)), this._register(B(this._textarea, "focus", () => this._isFocused = !0)), this._register(B(this._textarea, "blur", () => this._isFocused = !1));
  }
  get window() {
    return this._window;
  }
  ...
  _setWindowResizeListener() {
    this._windowResizeListener.value = B(this._parentWindow, "resize", () => this._setDprAndFireIfDiffers());
  }
  ...
  constructor() {
    super(), this.linkProviders = [], this._register(z(() => this.linkProviders.length = 0));
  }
...
function Pa(e, t, i, s, r, n, o, h, l) {
  if (!n) return;
  let a = ws(e, t, i);
  if (a) return a[0] = Math.ceil((a[0] + (l ? o / 2 : 0)) / o), a[1] = Math.ceil(a[1] / h), a[0] = Math.min(Math.max(a[0], 1), s + (l ? 1 : 0)), a[1] = Math.min(Math.max(a[1], 1), r), a;
}
var es = class {
  constructor(e, t) {
  ...
  getCoords(e, t, i, s, r) {
    return Pa(window, e, t, i, s, this._charSizeService.hasValidSize, this._renderService.dimensions.css.cell.width, this._renderService.dimensions.css.cell.height, r);
  }
...
var ni = typeof process < "u" && "title" in process, Lt = ni ? "node" : navigator.userAgent, Pt = ni ? "node" : navigator.platform, an = Lt.includes("Firefox"), Aa = Lt.includes("Edge"), hn = /^((?!chrome|android).)*safari/i.test(Lt);
function Oa() {
  if (!hn) return 0;
...
var Zt = [
  ...
  "MacPPC",
  "Mac68K"
].includes(Pt), Ia = Pt === "iPad", Na = Pt === "iPhone", ln = [
  "Windows",
  "Win16",
  "Win32",
  "WinCE"
].includes(Pt), ys = Pt.indexOf("Linux") >= 0, cn = /\bCrOS\b/.test(Lt), dn = class {
  constructor() {
...
}, Qt = !ni && "requestIdleCallback" in window ? za : Ha, Wa = class {
  constructor() {
    this._queue = new Qt();
  }
  set(e) {
  ...
  constructor(e, t, i, s, r, n, o, h, l) {
    super(), this._rowCount = e, this._optionsService = i, this._charSizeService = s, this._coreService = r, this._coreBrowserService = h, this._renderer = this._register(new rt()), this._pausedResizeTask = new Wa(), this._observerDisposable = this._register(new rt()), this._isPaused = !1, this._needsFullRefresh = !1, this._isNextRenderRedrawOnly = !0, this._needsSelectionRefresh = !1, this._canvasWidth = 0, this._canvasHeight = 0, this._selectionState = {
      start: void 0,
      end: void 0,
      columnSelectMode: !1
    }, this._onDimensionsChange = this._register(new v()), this.onDimensionsChange = this._onDimensionsChange.event, this._onRenderedViewportChange = this._register(new v()), this.onRenderedViewportChange = this._onRenderedViewportChange.event, this._onRender = this._register(new v()), this.onRender = this._onRender.event, this._onRefreshRequest = this._register(new v()), this.onRefreshRequest = this._onRefreshRequest.event, this._renderDebouncer = new Ta((a, d) => this._renderRows(a, d), this._coreBrowserService), this._register(this._renderDebouncer), this._syncOutputHandler = new Fa(this._coreBrowserService, this._coreService, () => this._fullRefresh()), this._register(z(() => this._syncOutputHandler.dispose())), this._register(this._coreBrowserService.onDprChange(() => this.handleDevicePixelRatioChange())), this._register(o.onResize(() => this._fullRefresh())), this._register(o.buffers.onBufferActivate(() => this._renderer.value?.clear())), this._register(this._optionsService.onOptionChange(() => this._handleOptionsChanged())), this._register(this._charSizeService.onCharSizeChange(() => this.handleCharSizeChanged())), this._register(n.onDecorationRegistered(() => this._fullRefresh())), this._register(n.onDecorationRemoved(() => this._fullRefresh())), this._register(this._optionsService.onMultipleOptionChange([
      "customGlyphs",
  ...
  _registerIntersectionObserver(e, t) {
    if ("IntersectionObserver" in e) {
      ...
      i.observe(t), this._observerDisposable.value = z(() => i.disconnect());
    }
  }
...
function $a(e, t, i, s) {
  ...
  if (!i.buffer.hasScrollback) return qa(r, n, e, t, i, s) + oi(n, t, i, s) + Va(r, n, e, t, i, s);
  let o;
  if (n === t) return o = r > e ? "D" : "C", Dt(Math.abs(r - e), Et(o, s));
  o = n > t ? "D" : "C";
  let h = Math.abs(n - t);
  return Dt(Ua(n > t ? e : r, i) + (h - 1) * i.cols + 1 + Ka(n > t ? r : e, i), Et(o, s));
}
function Ka(e, t) {
  return e - 1;
}
...
function qa(e, t, i, s, r, n) {
  return oi(t, s, r, n).length === 0 ? "" : Dt(_n(e, t, e, t - et(t, r), !1, r).length, Et("D", n));
}
function oi(e, t, i, s) {
  let r = e - et(e, i), n = t - et(t, i);
  return Dt(Math.abs(r - n) - Ya(e, t, i), Et(un(e, t), s));
}
function Va(e, t, i, s, r, n) {
  let o;
  oi(t, s, r, n).length > 0 ? o = s - et(s, r) : o = t;
  let h = s, l = ja(e, t, i, s, r, n);
  return Dt(_n(e, o, i, h, l === "C", r).length, Et(l, n));
}
function Ya(e, t, i) {
  let s = 0, r = e - et(e, i), n = t - et(t, i);
  for (let o = 0; o < Math.abs(r - n); o++) {
    let h = un(e, t) === "A" ? -1 : 1;
    i.buffer.lines.get(r + h * o)?.isWrapped && s++;
  }
  return s;
}
function et(e, t) {
...
function ja(e, t, i, s, r, n) {
  let o;
  return oi(i, s, r, n).length > 0 ? o = s - et(s, r) : o = t, e < i && o <= s || e >= i && o < s ? "C" : "D";
}
function un(e, t) {
  return e > t ? "A" : "B";
}
function _n(e, t, i, s, r, n) {
  let o = e, h = t, l = "";
  for (; (o !== i || h !== s) && h >= 0 && h < n.buffer.lines.length; ) o += r ? 1 : -1, r && o > n.cols - 1 ? (l += n.buffer.translateBufferLineToString(h, !1, e, o), o = 0, e = 0, h++) : !r && o < 0 && (l += n.buffer.translateBufferLineToString(h, !1, 0, e + 1), o = n.cols - 1, e = o, h--);
  return l + n.buffer.translateBufferLineToString(h, !1, e, o);
}
function Et(e, t) {
  let i = t ? "O" : "[";
  return p.ESC + i + e;
  ...
  get selectionText() {
    ...
    if (this._activeSelectionMode === 3) {
      ...
      for (let o = e[1]; o <= t[1]; o++) {
        let h = i.translateBufferLineToString(o, !0, r, n);
        s.push(h);
      }
    } else {
      ...
      for (let n = e[1] + 1; n <= t[1] - 1; n++) {
        let o = i.lines.get(n), h = i.translateBufferLineToString(n, !0);
        o?.isWrapped ? s[s.length - 1] += h : s.push(h);
      }
      if (e[1] !== t[1]) {
    ...
    return s.map((r) => r.replace(Qa, " ")).join(ln ? `\r
` : `
`);
  }
  clearSelection() {
  ...
  refresh(e) {
    this._refreshAnimationFrame || (this._refreshAnimationFrame = this._coreBrowserService.window.requestAnimationFrame(() => this._refresh())), ys && e && this.selectionText.length && this._onLinuxMouseSelection.fire(this.selectionText);
  }
  _refresh() {
  ...
  _selectWordAtCursor(e, t) {
    ...
    if (i) return this._model.selectionStart = [i.start.x - 1, i.start.y - 1], this._model.selectionStartLength = Qs(i, this._bufferService.cols), this._model.selectionEnd = void 0, !0;
  ...
  _getMouseEventScrollAmount(e) {
    let t = ws(this._coreBrowserService.window, e, this._screenElement)[1], i = this._renderService.dimensions.css.canvas.height;
    return t >= 0 && t <= i ? 0 : (t > i && (t -= i), t = Math.min(Math.max(t, -gi), gi), t /= gi, t / Math.abs(t) + Math.round(t * (Ga - 1)));
  }
  ...
  _handleMouseUp(e) {
    ...
    if (this._removeMouseDownListeners(), this.selectionText.length <= 1 && t < Za && e.altKey && this._optionsService.rawOptions.altClickMovesCursor) {
      if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
        ...
        if (i && i[0] !== void 0 && i[1] !== void 0) {
          let s = $a(i[0] - 1, i[1] - 1, this._bufferService, this._coreService.decPrivateModes.applicationCursorKeys);
  ...
  _getWordAt(e, t, i = !0, s = !0) {
    ...
    if (!n) return;
    let o = r.translateBufferLineToString(e[1], !1), h = this._convertViewportColToCharacterIndex(n, e[0]), l = h, a = e[0] - h, d = 0, c = 0, _ = 0, f = 0;
    if (o.charAt(h) === " ") {
      for (; h > 0 && o.charAt(h - 1) === " "; ) h--;
      for (; l < o.length && o.charAt(l + 1) === " "; ) l++;
    } else {
      let k = e[0], D = e[0];
      n.getWidth(k) === 0 && (d++, k--), n.getWidth(D) === 2 && (c++, D++);
      let I = n.getString(D).length;
      for (I > 1 && (f += I - 1, l += I - 1); k > 0 && h > 0 && !this._isCharWordSeparator(n.loadCell(k - 1, this._workCell)); ) {
        n.loadCell(k - 1, this._workCell);
        let L = this._workCell.getChars().length;
        this._workCell.getWidth() === 0 ? (d++, k--) : L > 1 && (_ += L - 1, h -= L - 1), h--, k--;
      }
      for (; D < n.length && l + 1 < o.length && !this._isCharWordSeparator(n.loadCell(D + 1, this._workCell)); ) {
        n.loadCell(D + 1, this._workCell);
        let L = this._workCell.getChars().length;
        this._workCell.getWidth() === 2 ? (c++, D++) : L > 1 && (f += L - 1, l += L - 1), l++, D++;
      }
    }
    l++;
    let u = h + a - d + _, g = Math.min(this._bufferService.cols, l - h + d + c - _ - f);
    if (!(!t && o.slice(h, l).trim() === "")) {
      if (i && u === 0 && n.getCodePoint(0) !== 32) {
        let k = r.lines.get(e[1] - 1);
        if (k && n.isWrapped && k.getCodePoint(this._bufferService.cols - 1) !== 32) {
          let D = this._getWordAt([this._bufferService.cols - 1, e[1] - 1], !1, !0, !1);
          if (D) {
            let I = this._bufferService.cols - D.start;
            u -= I, g += I;
          }
        }
      }
      if (s && u + g === this._bufferService.cols && n.getCodePoint(this._bufferService.cols - 1) !== 32) {
        let k = r.lines.get(e[1] + 1);
  ...
  _selectLineAt(e) {
    let t = this._bufferService.buffer.getWrappedRangeForLine(e), i = {
      start: {
        x: 0,
        y: t.first
      },
    ...
    this._model.selectionStart = [0, t.first], this._model.selectionEnd = void 0, this._model.selectionStartLength = Qs(i, this._bufferService.cols);
  }
};
is = q([
  y(3, ce),
...
var er = class {
  ...
  constructor() {
    this._color = new er(), this._css = new er();
  }
  setCss(e, t, i) {
    this._css.set(e, t, i);
  }
  ...
  return e;
})()), Xe = W.toColor("#ffffff"), mt = W.toColor("#000000"), ir = W.toColor("#ffffff"), sr = mt, ut = {
  css: "rgba(255, 255, 255, 0.3)",
  rgba: 4294967117
}, eh = Xe, ss = class extends R {
  constructor(e) {
    super(), this._optionsService = e, this._contrastCache = new tr(), this._halfContrastCache = new tr(), this._onChangeColors = this._register(new v()), this.onChangeColors = this._onChangeColors.event, this._colors = {
      foreground: Xe,
      background: mt,
      cursor: ir,
      cursorAccent: sr,
      selectionForeground: void 0,
      selectionBackgroundTransparent: ut,
      selectionBackgroundOpaque: H.blend(mt, ut),
      selectionInactiveBackgroundTransparent: ut,
      selectionInactiveBackgroundOpaque: H.blend(mt, ut),
      scrollbarSliderBackground: H.opacity(Xe, 0.2),
      scrollbarSliderHoverBackground: H.opacity(Xe, 0.4),
      scrollbarSliderActiveBackground: H.opacity(Xe, 0.5),
  ...
  _setTheme(e = {}) {
    let t = this._colors;
    if (t.foreground = N(e.foreground, Xe), t.background = N(e.background, mt), t.cursor = H.blend(t.background, N(e.cursor, ir)), t.cursorAccent = H.blend(t.background, N(e.cursorAccent, sr)), t.selectionBackgroundTransparent = N(e.selectionBackground, ut), t.selectionBackgroundOpaque = H.blend(t.background, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundTransparent = N(e.selectionInactiveBackground, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundOpaque = H.blend(t.background, t.selectionInactiveBackgroundTransparent), t.selectionForeground = e.selectionForeground ? N(e.selectionForeground, Gs) : void 0, t.selectionForeground === Gs && (t.selectionForeground = void 0), H.isOpaque(t.selectionBackgroundTransparent) && (t.selectionBackgroundTransparent = H.opacity(t.selectionBackgroundTransparent, 0.3)), H.isOpaque(t.selectionInactiveBackgroundTransparent) && (t.selectionInactiveBackgroundTransparent = H.opacity(t.selectionInactiveBackgroundTransparent, 0.3)), t.scrollbarSliderBackground = N(e.scrollbarSliderBackground, H.opacity(t.foreground, 0.2)), t.scrollbarSliderHoverBackground = N(e.scrollbarSliderHoverBackground, H.opacity(t.foreground, 0.4)), t.scrollbarSliderActiveBackground = N(e.scrollbarSliderActiveBackground, H.opacity(t.foreground, 0.5)), t.overviewRulerBorder = N(e.overviewRulerBorder, eh), t.ansi = X.slice(), t.ansi[0] = N(e.black, X[0]), t.ansi[1] = N(e.red, X[1]), t.ansi[2] = N(e.green, X[2]), t.ansi[3] = N(e.yellow, X[3]), t.ansi[4] = N(e.blue, X[4]), t.ansi[5] = N(e.magenta, X[5]), t.ansi[6] = N(e.cyan, X[6]), t.ansi[7] = N(e.white, X[7]), t.ansi[8] = N(e.brightBlack, X[8]), t.ansi[9] = N(e.brightRed, X[9]), t.ansi[10] = N(e.brightGreen, X[10]), t.ansi[11] = N(e.brightYellow, X[11]), t.ansi[12] = N(e.brightBlue, X[12]), t.ansi[13] = N(e.brightMagenta, X[13]), t.ansi[14] = N(e.brightCyan, X[14]), t.ansi[15] = N(e.brightWhite, X[15]), e.extendedAnsi) {
      let i = Math.min(t.ansi.length - 16, e.extendedAnsi.length);
      for (let s = 0; s < i; s++) t.ansi[s + 16] = N(e.extendedAnsi[s], X[s + 16]);
    }
...
var th = class {
  ...
  constructor() {
    this._services = new th(), this._services.set(us, this);
  }
  setService(e, t) {
  ...
  createInstance(e, ...t) {
    let i = Pn(e).sort((n, o) => n.index - o.index), s = [];
    for (let n of i) {
  ...
  error: 4,
  off: 5
}, rh = "xterm.js: ", rs = class extends R {
  constructor(e) {
    super(), this._optionsService = e, this._logLevel = 5, this._updateLogLevel(), this._register(this._optionsService.onSpecificOptionChange("logLevel", () => this._updateLogLevel())), nh = this;
  }
  get logLevel() {
    return this._logLevel;
  }
  _updateLogLevel() {
    this._logLevel = sh[this._optionsService.rawOptions.logLevel];
  }
  _evalLazyOptionalParams(e) {
    for (let t = 0; t < e.length; t++) typeof e[t] == "function" && (e[t] = e[t]());
  }
  _log(e, t, i) {
    this._evalLazyOptionalParams(i), e.call(console, (this._optionsService.options.logger ? "" : rh) + t, ...i);
  }
  trace(e, ...t) {
...
var nh, rr = class extends R {
  ...
  get(t) {
    ...
    return [
      this._data[t * M + 1],
      i & 2097152 ? this._combined[t] : s ? Ue(s) : "",
      i >> 22,
      i & 2097152 ? this._combined[t].charCodeAt(this._combined[t].length - 1) : s
    ];
  }
  set(t, i) {
  ...
  getString(t) {
    let i = this._data[t * M + 0];
    return i & 2097152 ? this._combined[t] : i & 2097151 ? Ue(i & 2097151) : "";
  }
  isProtected(t) {
    return this._data[t * M + 2] & 536870912;
  }
  loadCell(t, i) {
    return Ht = t * M, i.content = this._data[Ht + 0], i.fg = this._data[Ht + 1], i.bg = this._data[Ht + 2], i.content & 2097152 && (i.combinedData = this._combined[t]), i.bg & 268435456 && (i.extended = this._extendedAttrs[t]), i;
  }
  setCell(t, i) {
  ...
  addCodepointToCell(t, i, s) {
    ...
    r & 2097152 ? this._combined[t] += Ue(i) : r & 2097151 ? (this._combined[t] = Ue(r & 2097151) + Ue(i), r &= -2097152, r |= 2097152) : r = i | 1 << 22, s && (r &= -12582913, r |= s << 22), this._data[t * M + 0] = r;
  }
  insertCells(t, i, s) {
  ...
  resize(t, i) {
    if (t === this.length) return this._data.length * 4 * vi < this._data.buffer.byteLength;
    let s = t * M;
    if (t > this.length) {
      ...
      for (let o = 0; o < r.length; o++) {
        let h = parseInt(r[o], 10);
        h >= t && delete this._combined[h];
      }
      let n = Object.keys(this._extendedAttrs);
      for (let o = 0; o < n.length; o++) {
        let h = parseInt(n[o], 10);
        h >= t && delete this._extendedAttrs[h];
      }
    }
    return this.length = t, s * 4 * vi < this._data.buffer.byteLength;
  }
  cleanupMemory() {
    if (this._data.length * 4 * vi < this._data.buffer.byteLength) {
  ...
  copyCellsFrom(t, i, s, r, n) {
    ...
    if (n) for (let l = r - 1; l >= 0; l--) {
      for (let a = 0; a < M; a++) this._data[(s + l) * M + a] = o[(i + l) * M + a];
      o[(i + l) * M + 2] & 268435456 && (this._extendedAttrs[s + l] = t._extendedAttrs[i + l]);
    }
    ...
    for (let l = 0; l < h.length; l++) {
      let a = parseInt(h[l], 10);
      a >= i && (this._combined[a - i + s] = t._combined[a]);
    }
  }
  translateToString(t, i, s, r) {
    ...
    let n = "";
    for (; i < s; ) {
      let o = this._data[i * M + 0], h = o & 2097151, l = o & 2097152 ? this._combined[i] : h ? Ue(h) : qe;
...
function oh(e, t, i, s, r, n) {
  ...
  for (let h = 0; h < e.length - 1; h++) {
    ...
    let c = 0, _ = Bt(d, c, t), f = 1, u = 0;
    for (; f < d.length; ) {
      let k = Bt(d, f, t), D = k - u, I = i - _, L = Math.min(D, I);
      d[c].copyCellsFrom(d[f], u, _, L, !1), _ += L, _ === i && (c++, _ = 0), u += L, u === k && (f++, u = 0), _ === 0 && c !== 0 && d[c - 1].getWidth(i - 1) === 2 && (d[c].copyCellsFrom(d[c - 1], i - 1, _++, 1, !1), d[c - 1].setCell(i - 1, r));
    }
    d[c].replaceCells(_, i, r);
    let g = 0;
    for (let k = d.length - 1; k > 0 && (k > c || d[k].getTrimmedLength() === 0); k--) g++;
    g > 0 && (o.push(h + d.length - g), o.push(g)), h += d.length - 1;
  }
  return o;
}
function ah(e, t) {
...
function lh(e, t, i) {
  let s = [], r = e.map((l, a) => Bt(e, a, t)).reduce((l, a) => l + a), n = 0, o = 0, h = 0;
  for (; h < r; ) {
    if (r - h < i) {
      s.push(r - h);
      break;
...
var pn = class gn {
  constructor(t) {
    this.line = t, this.isDisposed = !1, this._disposables = [], this._id = gn._nextId++, this._onDispose = this.register(new v()), this.onDispose = this._onDispose.event;
  }
  get id() {
    return this._id;
  }
...
var nr = 4294967295, or = class {
  constructor(e, t, i) {
    this._hasScrollback = e, this._optionsService = t, this._bufferService = i, this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.tabs = {}, this.savedY = 0, this.savedX = 0, this.savedCurAttrData = j.clone(), this.savedCharset = Ge, this.markers = [], this._nullCell = be.fromCharData([
      0,
      Br,
      1,
      0
    ]), this._whitespaceCell = be.fromCharData([
      0,
      qe,
      1,
      32
    ]), this._isClearing = !1, this._memoryCleanupQueue = new Qt(), this._memoryCleanupPosition = 0, this._cols = this._bufferService.cols, this._rows = this._bufferService.rows, this.lines = new rr(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
  }
  getNullCell(e) {
    return e ? (this._nullCell.fg = e.fg, this._nullCell.bg = e.bg, this._nullCell.extended = e.extended) : (this._nullCell.fg = 0, this._nullCell.bg = 0, this._nullCell.extended = new Xt()), this._nullCell;
  }
  getWhitespaceCell(e) {
    return e ? (this._whitespaceCell.fg = e.fg, this._whitespaceCell.bg = e.bg, this._whitespaceCell.extended = e.extended) : (this._whitespaceCell.fg = 0, this._whitespaceCell.bg = 0, this._whitespaceCell.extended = new Xt()), this._whitespaceCell;
  }
  getBlankLine(e, t) {
    return new St(this._bufferService.cols, this.getNullCell(e), t);
  }
  get hasScrollback() {
  ...
  clear() {
    this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.lines = new rr(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
  }
  resize(e, t) {
    let i = this.getNullCell(j), s = 0, r = this._getCorrectBufferLength(t);
    if (r > this.lines.maxLength && (this.lines.maxLength = r), this.lines.length > 0) {
      ...
      let n = 0;
      if (this._rows < t) for (let o = this._rows; o < t; o++) this.lines.length < t + this.ybase && (this._optionsService.rawOptions.windowsMode || this._optionsService.rawOptions.windowsPty.backend !== void 0 || this._optionsService.rawOptions.windowsPty.buildNumber !== void 0 ? this.lines.push(new St(e, i)) : this.ybase > 0 && this.lines.length <= this.ybase + this.y + n + 1 ? (this.ybase--, n++, this.ydisp > 0 && this.ydisp--) : this.lines.push(new St(e, i)));
  ...
  _reflowLarger(e, t) {
    let i = this._optionsService.rawOptions.reflowCursorLine, s = oh(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(j), i);
    if (s.length > 0) {
      let r = ah(this.lines, s);
      hh(this.lines, r.layout), this._reflowLargerAdjustViewport(e, t, r.countRemoved);
    }
  }
  _reflowLargerAdjustViewport(e, t, i) {
    let s = this.getNullCell(j), r = i;
    for (; r-- > 0; ) this.ybase === 0 ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new St(e, s))) : (this.ydisp === this.ybase && this.ydisp--, this.ybase--);
    this.savedY = Math.max(this.savedY - i, 0);
  }
  _reflowSmaller(e, t) {
    let i = this._optionsService.rawOptions.reflowCursorLine, s = this.getNullCell(j), r = [], n = 0;
    for (let o = this.lines.length - 1; o >= 0; o--) {
      ...
      let a = l[l.length - 1].getTrimmedLength(), d = lh(l, this._cols, e), c = d.length - l.length, _;
      ...
      let u = d.length - 1, g = d[u];
      g === 0 && (u--, g = d[u]);
      let k = l.length - c - 1, D = a;
      for (; k >= 0; ) {
        let L = Math.min(D, g);
        if (l[u] === void 0) break;
        l[u].copyCellsFrom(l[k], D - L, g - L, L, !0), g -= L, g === 0 && (u--, g = d[u]), D -= L, D === 0 && (k--, D = Bt(l, Math.max(k, 0), this._cols));
      }
    ...
    if (r.length > 0) {
      let o = [], h = [];
      for (let g = 0; g < this.lines.length; g++) h.push(this.lines.get(g));
      let l = this.lines.length, a = l - 1, d = 0, c = r[d];
      this.lines.length = Math.min(this.lines.maxLength, this.lines.length + n);
      let _ = 0;
      for (let g = Math.min(this.lines.maxLength - 1, l + n - 1); g >= 0; g--) if (c && c.start > a + _) {
        for (let k = c.newLines.length - 1; k >= 0; k--) this.lines.set(g--, c.newLines[k]);
        g++, o.push({
          index: a + 1,
          amount: c.newLines.length
        }), _ += c.newLines.length, c = r[++d];
      } else this.lines.set(g, h[a--]);
      let f = 0;
      for (let g = o.length - 1; g >= 0; g--) o[g].index += f, this.lines.onInsertEmitter.fire(o[g]), f += o[g].amount;
  ...
  prevStop(e) {
    for (e ?? (e = this.x); !this.tabs[--e] && e > 0; ) ;
    return e >= this._cols ? this._cols - 1 : e < 0 ? 0 : e;
  }
  nextStop(e) {
    for (e ?? (e = this.x); !this.tabs[++e] && e < this._cols; ) ;
    return e >= this._cols ? this._cols - 1 : e < 0 ? 0 : e;
  }
  clearMarkers(e) {
    this._isClearing = !0;
  ...
  reset() {
    this._normal = new or(!0, this._optionsService, this._bufferService), this._normal.fillViewportRows(), this._alt = new or(!1, this._optionsService, this._bufferService), this._activeBuffer = this._normal, this._onBufferActivate.fire({
...
}, vn = 2, mn = 1, ns = class extends R {
  constructor(e) {
    super(), this.isUserScrolling = !1, this._onResize = this._register(new v()), this.onResize = this._onResize.event, this._onScroll = this._register(new v()), this.onScroll = this._onScroll.event, this.cols = Math.max(e.rawOptions.cols || 0, vn), this.rows = Math.max(e.rawOptions.rows || 0, mn), this.buffers = this._register(new dh(e, this)), this._register(this.buffers.onBufferActivate((t) => {
...
var it = {
  ...
  constructor(e) {
    ...
    this.rawOptions = t, this.options = { ...t }, this._setupOptions(), this._register(z(() => {
  ...
  _setupOptions() {
    let e = (i) => {
      if (!(i in it)) throw new Error(`No option with key "${i}"`);
  ...
  _sanitizeAndValidateOption(e, t) {
    switch (e) {
      case "cursorStyle":
        if (t || (t = it[e]), !fh(t)) throw new Error(`"${t}" is not a valid value for ${e}`);
        break;
      case "wordSeparator":
        t || (t = it[e]);
        break;
...
function bt(e, t = 5) {
  ...
  for (let s in e) i[s] = t <= 1 ? e[s] : e[s] && bt(e[s], t - 1);
  return i;
}
var ar = Object.freeze({ insertMode: !1 }), hr = Object.freeze({
  ...
  constructor(e, t, i) {
    super(), this._bufferService = e, this._logService = t, this._optionsService = i, this.isCursorInitialized = !1, this.isCursorHidden = !1, this._onData = this._register(new v()), this.onData = this._onData.event, this._onUserInput = this._register(new v()), this.onUserInput = this._onUserInput.event, this._onBinary = this._register(new v()), this.onBinary = this._onBinary.event, this._onRequestScrollToBottom = this._register(new v()), this.onRequestScrollToBottom = this._onRequestScrollToBottom.event, this.modes = bt(ar), this.decPrivateModes = bt(hr);
  }
  reset() {
    this.modes = bt(ar), this.decPrivateModes = bt(hr);
  }
...
var Si = String.fromCharCode, cr = {
  DEFAULT: (e) => {
    ...
    return t[0] > 255 || t[1] > 255 || t[2] > 255 ? "" : `\x1B[M${Si(t[0])}${Si(t[1])}${Si(t[2])}`;
  },
  SGR: (e) => {
    let t = e.action === 0 && e.button !== 4 ? "m" : "M";
    return `\x1B[<${mi(e, !0)};${e.col};${e.row}${t}`;
  },
  SGR_PIXELS: (e) => {
    let t = e.action === 0 && e.button !== 4 ? "m" : "M";
    return `\x1B[<${mi(e, !0)};${e.x};${e.y}${t}`;
  }
}, as = class extends R {
  constructor(e, t, i) {
    super(), this._bufferService = e, this._coreService = t, this._optionsService = i, this._protocols = {}, this._encodings = {}, this._activeProtocol = "", this._activeEncoding = "", this._lastEvent = null, this._wheelPartialScroll = 0, this._onProtocolChange = this._register(new v()), this.onProtocolChange = this._onProtocolChange.event;
    for (let s of Object.keys(lr)) this.addProtocol(s, lr[s]);
    for (let s of Object.keys(cr)) this.addEncoding(s, cr[s]);
    this.reset();
  }
  addProtocol(e, t) {
    this._protocols[e] = t;
...
var vh = class {
  constructor() {
    if (this.version = "6", !G) {
      G = /* @__PURE__ */ new Uint8Array(65536), G.fill(1), G[0] = 0, G.fill(0, 1, 32), G.fill(0, 127, 160), G.fill(2, 4352, 4448), G[9001] = 2, G[9002] = 2, G.fill(2, 11904, 42192), G[12351] = 1, G.fill(2, 44032, 55204), G.fill(2, 63744, 64256), G.fill(2, 65040, 65050), G.fill(2, 65072, 65136), G.fill(2, 65280, 65377), G.fill(2, 65504, 65511);
      for (let e = 0; e < bi.length; ++e) G.fill(0, bi[e][0], bi[e][1] + 1);
    }
  }
  wcwidth(e) {
    return e < 32 ? 0 : e < 127 ? 1 : e < 65536 ? G[e] : gh(e, ph) ? 0 : e >= 131072 && e <= 196605 || e >= 196608 && e <= 262141 ? 2 : 1;
  }
  charProperties(e, t) {
    let i = this.wcwidth(e), s = i === 0 && t !== 0;
    if (s) {
      let r = Je.extractWidth(t);
      r === 0 ? s = !1 : r > i && (i = r);
    }
    return Je.createPropertyValue(0, i, s);
  }
}, Je = class jt {
  constructor() {
  ...
  getStringCellWidth(t) {
    ...
    for (let n = 0; n < r; ++n) {
      ...
      if (55296 <= o && o <= 56319) {
        ...
        56320 <= a && a <= 57343 ? o = (o - 55296) * 1024 + a - 56320 + 65536 : i += this.wcwidth(a);
      }
      let h = this.charProperties(o, s), l = jt.extractWidth(h);
      jt.extractShouldJoin(h) && (l -= jt.extractWidth(s)), i += l, s = h;
    }
    return i;
  }
  charProperties(t, i) {
...
var _t = 2147483647, Sh = 256, Sn = class hs {
  constructor(t = 32, i = 32) {
    if (this.maxLength = t, this.maxSubParamsLength = i, i > Sh) throw new Error("maxSubParamsLength must not be greater than 256");
  ...
  clone() {
    let t = new hs(this.maxLength, this.maxSubParamsLength);
  ...
  addParam(t) {
    ...
    this._subParamsIdx[this.length] = this._subParamsLength << 8 | this._subParamsLength, this.params[this.length++] = t > _t ? _t : t;
  }
  addSubParam(t) {
    if (this._digitIsSub = !0, !!this.length) {
      ...
      if (t < -1) throw new Error("values lesser than -1 are not allowed");
      this._subParams[this._subParamsLength++] = t > _t ? _t : t, this._subParamsIdx[this.length - 1]++;
    }
  }
  hasSubParams(t) {
  ...
  addDigit(t) {
    ...
    s[i - 1] = ~r ? Math.min(r * 10 + t, _t) : t;
  }
}, ft = [], bh = class {
  constructor() {
    this._state = 0, this._active = ft, this._id = -1, this._handlers = /* @__PURE__ */ Object.create(null), this._handlerFb = () => {
    }, this._stack = {
      paused: !1,
      loopPosition: 0,
      fallThrough: !1
  ...
  reset() {
    ...
    this._stack.paused = !1, this._active = ft, this._id = -1, this._state = 0;
  }
  _start() {
    if (this._active = this._handlers[this._id] || ft, !this._active.length) this._handlerFb(this._id, "START");
    else for (let e = this._active.length - 1; e >= 0; e--) this._active[e].start();
  }
  _put(e, t, i) {
    if (!this._active.length) this._handlerFb(this._id, "PUT", ti(e, t, i));
  ...
  put(e, t, i) {
    ...
    if (this._state !== 0) {
      ...
      this._active = ft, this._id = -1, this._state = 0;
    }
  }
}, fe = class {
  constructor(e) {
  ...
  put(e, t, i) {
    this._hitLimit || (this._data += ti(e, t, i), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
  }
  end(e) {
    let t = !1;
  ...
  constructor() {
    this._handlers = /* @__PURE__ */ Object.create(null), this._active = pt, this._ident = 0, this._handlerFb = () => {
    }, this._stack = {
      paused: !1,
      loopPosition: 0,
      fallThrough: !1
  ...
  reset() {
    ...
    this._stack.paused = !1, this._active = pt, this._ident = 0;
  }
  hook(e, t) {
    if (this.reset(), this._ident = e, this._active = this._handlers[e] || pt, !this._active.length) this._handlerFb(this._ident, "HOOK", t);
    else for (let i = this._active.length - 1; i >= 0; i--) this._active[i].hook(t);
  }
  put(e, t, i) {
    if (!this._active.length) this._handlerFb(this._ident, "PUT", ti(e, t, i));
    else for (let s = this._active.length - 1; s >= 0; s--) this._active[s].put(e, t, i);
  }
  unhook(e, t = !0) {
    ...
    this._active = pt, this._ident = 0;
  }
}, wt = new Sn();
wt.addParam(0);
var ur = class {
  constructor(e) {
    this._handler = e, this._data = "", this._params = wt, this._hitLimit = !1;
  }
  hook(e) {
    this._params = e.length > 1 || e.params[0] ? e.clone() : wt, this._data = "", this._hitLimit = !1;
  }
  put(e, t, i) {
    this._hitLimit || (this._data += ti(e, t, i), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
  }
  unhook(e) {
    let t = !1;
    if (this._hitLimit) t = !1;
    else if (e && (t = this._handler(this._data, this._params), t instanceof Promise)) return t.then((i) => (this._params = wt, this._data = "", this._hitLimit = !1, i));
    return this._params = wt, this._data = "", this._hitLimit = !1, t;
  }
}, yh = class {
  constructor(e) {
  ...
  let e = new yh(4095), t = Array.apply(null, Array(256)).map((h, l) => l), i = (h, l) => t.slice(h, l), s = i(32, 127), r = i(0, 24);
  r.push(25), r.push.apply(r, i(28, 32));
  let n = i(0, 14), o;
  e.setDefault(1, 0), e.addMany(s, 0, 2, 0);
  for (o in n) e.addMany([
    24,
    26,
    153,
    154
  ...
  return e.addMany(r, 0, 3, 0), e.addMany(r, 1, 3, 1), e.add(127, 1, 0, 1), e.addMany(r, 8, 0, 8), e.addMany(r, 3, 3, 3), e.add(127, 3, 0, 3), e.addMany(r, 4, 3, 4), e.add(127, 4, 0, 4), e.addMany(r, 6, 3, 6), e.addMany(r, 5, 3, 5), e.add(127, 5, 0, 5), e.addMany(r, 2, 3, 2), e.add(127, 2, 0, 2), e.add(93, 1, 4, 8), e.addMany(s, 8, 5, 8), e.add(127, 8, 5, 8), e.addMany([
    ...
    24,
    26
  ], 13, 14, 0), e.add(me, 0, 2, 0), e.add(me, 8, 5, 8), e.add(me, 6, 0, 6), e.add(me, 11, 0, 11), e.add(me, 13, 13, 13), e;
})(), kh = class extends R {
  constructor(e = Ch) {
    super(), this._transitions = e, this._parseStack = {
      ...
      transition: 0,
      chunkPos: 0
    }, this.initialState = 0, this.currentState = this.initialState, this._params = new Sn(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0, this._printHandlerFb = (t, i, s) => {
    }, this._executeHandlerFb = (t) => {
    }, this._csiHandlerFb = (t, i) => {
    }, this._escHandlerFb = (t) => {
    }, this._errorHandlerFb = (t) => t, this._printHandler = this._printHandlerFb, this._executeHandlers = /* @__PURE__ */ Object.create(null), this._csiHandlers = /* @__PURE__ */ Object.create(null), this._escHandlers = /* @__PURE__ */ Object.create(null), this._register(z(() => {
      this._csiHandlers = /* @__PURE__ */ Object.create(null), this._executeHandlers = /* @__PURE__ */ Object.create(null), this._escHandlers = /* @__PURE__ */ Object.create(null);
    })), this._oscParser = this._register(new bh()), this._dcsParser = this._register(new wh()), this._errorHandler = this._errorHandlerFb, this.registerEscHandler({ final: "\\" }, () => !0);
  }
  ...
  parse(e, t, i) {
    ...
    if (this._parseStack.state) if (this._parseStack.state === 2) this._parseStack.state = 0, n = this._parseStack.chunkPos + 1;
      ...
      switch (this._parseStack.state) {
        case 3:
          if (i === !1 && l > -1) {
            for (; l >= 0 && (o = h[l](this._params), o !== !0); l--) if (o instanceof Promise) return this._parseStack.handlerPos = l, o;
          }
          this._parseStack.handlers = [];
          break;
        case 4:
          if (i === !1 && l > -1) {
            for (; l >= 0 && (o = h[l](), o !== !0); l--) if (o instanceof Promise) return this._parseStack.handlerPos = l, o;
          }
          this._parseStack.handlers = [];
          break;
        case 6:
    ...
    for (let h = n; h < t; ++h) {
      switch (s = e[h], r = this._transitions.table[this.currentState << 8 | (s < 160 ? s : me)], r >> 4) {
        case 2:
          for (let _ = h + 1; ; ++_) {
            if (_ >= t || (s = e[_]) < 32 || s > 126 && s < me) {
        ...
        case 1:
          ...
          break;
        case 7:
          let l = this._csiHandlers[this._collect << 8 | s], a = l ? l.length - 1 : -1;
          for (; a >= 0 && (o = l[a](this._params), o !== !0); a--) if (o instanceof Promise) return this._preserveStack(3, l, a, r, h), o;
        ...
        case 12:
          ...
          break;
        case 13:
          for (let _ = h + 1; ; ++_) if (_ >= t || (s = e[_]) === 24 || s === 26 || s === 27 || s > 127 && s < me) {
            this._dcsParser.put(e, h, _), h = _ - 1;
            break;
          }
          break;
        case 14:
          if (o = this._dcsParser.unhook(s !== 24 && s !== 26), o) return this._preserveStack(6, [], 0, r, h), o;
        ...
        case 4:
          ...
          break;
        case 5:
          for (let _ = h + 1; ; _++) if (_ >= t || (s = e[_]) < 32 || s > 127 && s < me) {
            this._oscParser.put(e, h, _), h = _ - 1;
            break;
          }
          break;
        case 6:
          if (o = this._oscParser.end(s !== 24 && s !== 26), o) return this._preserveStack(5, [], 0, r, h), o;
          s === 27 && (r |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0;
      }
      this.currentState = r & 15;
    }
  }
}, xh = /^([\da-f])\/([\da-f])\/([\da-f])$|^([\da-f]{2})\/([\da-f]{2})\/([\da-f]{2})$|^([\da-f]{3})\/([\da-f]{3})\/([\da-f]{3})$|^([\da-f]{4})\/([\da-f]{4})\/([\da-f]{4})$/, Eh = /^[\da-f]+$/;
function _r(e) {
  if (!e) return;
  let t = e.toLowerCase();
  if (t.indexOf("rgb:") === 0) {
    ...
    if (i) {
      ...
      return [
        Math.round(parseInt(i[1] || i[4] || i[7] || i[10], 16) / s * 255),
        Math.round(parseInt(i[2] || i[5] || i[8] || i[11], 16) / s * 255),
        Math.round(parseInt(i[3] || i[6] || i[9] || i[12], 16) / s * 255)
      ];
    }
  } else if (t.indexOf("#") === 0 && (t = t.slice(1), Eh.exec(t) && [
    3,
    6,
    9,
    12
...
function Dh(e, t = 16) {
  let [i, s, r] = e;
  return `rgb:${wi(i, t)}/${wi(s, t)}/${wi(r, t)}`;
}
var Bh = {
  "(": 0,
  ")": 1,
...
var gr = 5e3, vr = 0, Rh = class extends R {
  constructor(e, t, i, s, r, n, o, h, l = new kh()) {
    super(), this._bufferService = e, this._charsetService = t, this._coreService = i, this._logService = s, this._optionsService = r, this._oscLinkService = n, this._coreMouseService = o, this._unicodeService = h, this._parser = l, this._parseBuffer = /* @__PURE__ */ new Uint32Array(4096), this._stringDecoder = new Mn(), this._utf8Decoder = new Ln(), this._windowTitle = "", this._iconName = "", this._windowTitleStack = [], this._iconNameStack = [], this._curAttrData = j.clone(), this._eraseAttrDataInternal = j.clone(), this._onRequestBell = this._register(new v()), this.onRequestBell = this._onRequestBell.event, this._onRequestRefreshRows = this._register(new v()), this.onRequestRefreshRows = this._onRequestRefreshRows.event, this._onRequestReset = this._register(new v()), this.onRequestReset = this._onRequestReset.event, this._onRequestSendFocus = this._register(new v()), this.onRequestSendFocus = this._onRequestSendFocus.event, this._onRequestSyncScrollBar = this._register(new v()), this.onRequestSyncScrollBar = this._onRequestSyncScrollBar.event, this._onRequestWindowsOptionsReport = this._register(new v()), this.onRequestWindowsOptionsReport = this._onRequestWindowsOptionsReport.event, this._onA11yChar = this._register(new v()), this.onA11yChar = this._onA11yChar.event, this._onA11yTab = this._register(new v()), this.onA11yTab = this._onA11yTab.event, this._onCursorMove = this._register(new v()), this.onCursorMove = this._onCursorMove.event, this._onLineFeed = this._register(new v()), this.onLineFeed = this._onLineFeed.event, this._onScroll = this._register(new v()), this.onScroll = this._onScroll.event, this._onTitleChange = this._register(new v()), this.onTitleChange = this._onTitleChange.event, this._onColor = this._register(new v()), this.onColor = this._onColor.event, this._parseStack = {
      paused: !1,
      cursorStartX: 0,
      cursorStartY: 0,
      decodedLength: 0,
      ...
      257,
      258
    ], this._register(this._parser), this._dirtyRowTracker = new ls(this._bufferService), this._activeBuffer = this._bufferService.buffer, this._register(this._bufferService.buffers.onBufferActivate((a) => this._activeBuffer = a.activeBuffer)), this._parser.setCsiHandlerFallback((a, d) => {
      this._logService.debug("Unknown CSI code: ", {
        identifier: this._parser.identToString(a),
        params: d.toArray()
      });
      ...
      d === "HOOK" && (c = c.toArray()), this._logService.debug("Unknown DCS code: ", {
        identifier: this._parser.identToString(a),
        action: d,
        payload: c
      });
    }), this._parser.setPrintHandler((a, d, c) => this.print(a, d, c)), this._parser.registerCsiHandler({ final: "@" }, (a) => this.insertChars(a)), this._parser.registerCsiHandler({
      intermediates: " ",
      final: "@"
    }, (a) => this.scrollLeft(a)), this._parser.registerCsiHandler({ final: "A" }, (a) => this.cursorUp(a)), this._parser.registerCsiHandler({
      intermediates: " ",
      final: "A"
    }, (a) => this.scrollRight(a)), this._parser.registerCsiHandler({ final: "B" }, (a) => this.cursorDown(a)), this._parser.registerCsiHandler({ final: "C" }, (a) => this.cursorForward(a)), this._parser.registerCsiHandler({ final: "D" }, (a) => this.cursorBackward(a)), this._parser.registerCsiHandler({ final: "E" }, (a) => this.cursorNextLine(a)), this._parser.registerCsiHandler({ final: "F" }, (a) => this.cursorPrecedingLine(a)), this._parser.registerCsiHandler({ final: "G" }, (a) => this.cursorCharAbsolute(a)), this._parser.registerCsiHandler({ final: "H" }, (a) => this.cursorPosition(a)), this._parser.registerCsiHandler({ final: "I" }, (a) => this.cursorForwardTab(a)), this._parser.registerCsiHandler({ final: "J" }, (a) => this.eraseInDisplay(a, !1)), this._parser.registerCsiHandler({
      prefix: "?",
      final: "J"
    }, (a) => this.eraseInDisplay(a, !0)), this._parser.registerCsiHandler({ final: "K" }, (a) => this.eraseInLine(a, !1)), this._parser.registerCsiHandler({
      prefix: "?",
      final: "K"
    }, (a) => this.eraseInLine(a, !0)), this._parser.registerCsiHandler({ final: "L" }, (a) => this.insertLines(a)), this._parser.registerCsiHandler({ final: "M" }, (a) => this.deleteLines(a)), this._parser.registerCsiHandler({ final: "P" }, (a) => this.deleteChars(a)), this._parser.registerCsiHandler({ final: "S" }, (a) => this.scrollUp(a)), this._parser.registerCsiHandler({ final: "T" }, (a) => this.scrollDown(a)), this._parser.registerCsiHandler({ final: "X" }, (a) => this.eraseChars(a)), this._parser.registerCsiHandler({ final: "Z" }, (a) => this.cursorBackwardTab(a)), this._parser.registerCsiHandler({ final: "`" }, (a) => this.charPosAbsolute(a)), this._parser.registerCsiHandler({ final: "a" }, (a) => this.hPositionRelative(a)), this._parser.registerCsiHandler({ final: "b" }, (a) => this.repeatPrecedingCharacter(a)), this._parser.registerCsiHandler({ final: "c" }, (a) => this.sendDeviceAttributesPrimary(a)), this._parser.registerCsiHandler({
      prefix: ">",
      final: "c"
    }, (a) => this.sendDeviceAttributesSecondary(a)), this._parser.registerCsiHandler({ final: "d" }, (a) => this.linePosAbsolute(a)), this._parser.registerCsiHandler({ final: "e" }, (a) => this.vPositionRelative(a)), this._parser.registerCsiHandler({ final: "f" }, (a) => this.hVPosition(a)), this._parser.registerCsiHandler({ final: "g" }, (a) => this.tabClear(a)), this._parser.registerCsiHandler({ final: "h" }, (a) => this.setMode(a)), this._parser.registerCsiHandler({
      prefix: "?",
      final: "h"
    }, (a) => this.setModePrivate(a)), this._parser.registerCsiHandler({ final: "l" }, (a) => this.resetMode(a)), this._parser.registerCsiHandler({
      prefix: "?",
      final: "l"
    }, (a) => this.resetModePrivate(a)), this._parser.registerCsiHandler({ final: "m" }, (a) => this.charAttributes(a)), this._parser.registerCsiHandler({ final: "n" }, (a) => this.deviceStatus(a)), this._parser.registerCsiHandler({
      prefix: "?",
      final: "n"
    }, (a) => this.deviceStatusPrivate(a)), this._parser.registerCsiHandler({
      intermediates: "!",
      final: "p"
    }, (a) => this.softReset(a)), this._parser.registerCsiHandler({
      intermediates: " ",
      final: "q"
    }, (a) => this.setCursorStyle(a)), this._parser.registerCsiHandler({ final: "r" }, (a) => this.setScrollRegion(a)), this._parser.registerCsiHandler({ final: "s" }, (a) => this.saveCursor(a)), this._parser.registerCsiHandler({ final: "t" }, (a) => this.windowOptions(a)), this._parser.registerCsiHandler({ final: "u" }, (a) => this.restoreCursor(a)), this._parser.registerCsiHandler({
      intermediates: "'",
      final: "}"
    }, (a) => this.insertColumns(a)), this._parser.registerCsiHandler({
      intermediates: "'",
      final: "~"
    }, (a) => this.deleteColumns(a)), this._parser.registerCsiHandler({
      intermediates: '"',
      final: "q"
    }, (a) => this.selectProtected(a)), this._parser.registerCsiHandler({
      intermediates: "$",
      final: "p"
    }, (a) => this.requestMode(a, !0)), this._parser.registerCsiHandler({
      prefix: "?",
      intermediates: "$",
      final: "p"
    }, (a) => this.requestMode(a, !1)), this._parser.setExecuteHandler(p.BEL, () => this.bell()), this._parser.setExecuteHandler(p.LF, () => this.lineFeed()), this._parser.setExecuteHandler(p.VT, () => this.lineFeed()), this._parser.setExecuteHandler(p.FF, () => this.lineFeed()), this._parser.setExecuteHandler(p.CR, () => this.carriageReturn()), this._parser.setExecuteHandler(p.BS, () => this.backspace()), this._parser.setExecuteHandler(p.HT, () => this.tab()), this._parser.setExecuteHandler(p.SO, () => this.shiftOut()), this._parser.setExecuteHandler(p.SI, () => this.shiftIn()), this._parser.setExecuteHandler(Ct.IND, () => this.index()), this._parser.setExecuteHandler(Ct.NEL, () => this.nextLine()), this._parser.setExecuteHandler(Ct.HTS, () => this.tabSet()), this._parser.registerOscHandler(0, new fe((a) => (this.setTitle(a), this.setIconName(a), !0))), this._parser.registerOscHandler(1, new fe((a) => this.setIconName(a))), this._parser.registerOscHandler(2, new fe((a) => this.setTitle(a))), this._parser.registerOscHandler(4, new fe((a) => this.setOrReportIndexedColor(a))), this._parser.registerOscHandler(8, new fe((a) => this.setHyperlink(a))), this._parser.registerOscHandler(10, new fe((a) => this.setOrReportFgColor(a))), this._parser.registerOscHandler(11, new fe((a) => this.setOrReportBgColor(a))), this._parser.registerOscHandler(12, new fe((a) => this.setOrReportCursorColor(a))), this._parser.registerOscHandler(104, new fe((a) => this.restoreIndexedColor(a))), this._parser.registerOscHandler(110, new fe((a) => this.restoreFgColor(a))), this._parser.registerOscHandler(111, new fe((a) => this.restoreBgColor(a))), this._parser.registerOscHandler(112, new fe((a) => this.restoreCursorColor(a))), this._parser.registerEscHandler({ final: "7" }, () => this.saveCursor()), this._parser.registerEscHandler({ final: "8" }, () => this.restoreCursor()), this._parser.registerEscHandler({ final: "D" }, () => this.index()), this._parser.registerEscHandler({ final: "E" }, () => this.nextLine()), this._parser.registerEscHandler({ final: "H" }, () => this.tabSet()), this._parser.registerEscHandler({ final: "M" }, () => this.reverseIndex()), this._parser.registerEscHandler({ final: "=" }, () => this.keypadApplicationMode()), this._parser.registerEscHandler({ final: ">" }, () => this.keypadNumericMode()), this._parser.registerEscHandler({ final: "c" }, () => this.fullReset()), this._parser.registerEscHandler({ final: "n" }, () => this.setgLevel(2)), this._parser.registerEscHandler({ final: "o" }, () => this.setgLevel(3)), this._parser.registerEscHandler({ final: "|" }, () => this.setgLevel(3)), this._parser.registerEscHandler({ final: "}" }, () => this.setgLevel(2)), this._parser.registerEscHandler({ final: "~" }, () => this.setgLevel(1)), this._parser.registerEscHandler({
      intermediates: "%",
      final: "@"
    ...
    for (let a in J) this._parser.registerEscHandler({
      intermediates: "(",
      final: a
    }, () => this.selectCharset("(" + a)), this._parser.registerEscHandler({
      intermediates: ")",
      final: a
    }, () => this.selectCharset(")" + a)), this._parser.registerEscHandler({
      intermediates: "*",
      ...
      intermediates: "/",
      final: a
    }, () => this.selectCharset("/" + a));
    this._parser.registerEscHandler({
      intermediates: "#",
      final: "8"
    }, () => this.screenAlignmentPattern()), this._parser.setErrorHandler((a) => (this._logService.error("Parsing error: ", a), a)), this._parser.registerDcsHandler({
      intermediates: "$",
      final: "q"
    }, new ur((a, d) => this.requestStatusString(a, d)));
  }
  getAttrData() {
  ...
  _logSlowResolvingAsync(e) {
    this._logService.logLevel <= 3 && Promise.race([e, new Promise((t, i) => setTimeout(() => i("#SLOW_TIMEOUT"), gr))]).catch((t) => {
      if (t !== "#SLOW_TIMEOUT") throw t;
      console.warn(`async parser handler taking longer than ${gr} ms`);
    });
  }
  _getCurrentLinkId() {
  ...
  parse(e, t) {
    ...
    if (o) {
      ...
      s = this._parseStack.cursorStartX, r = this._parseStack.cursorStartY, this._parseStack.paused = !1, e.length > Ke && (n = this._parseStack.position + Ke);
    }
    if (this._logService.logLevel <= 1 && this._logService.debug(`parsing data ${typeof e == "string" ? ` "${e}"` : ` "${Array.prototype.map.call(e, (a) => String.fromCharCode(a)).join("")}"`}`), this._logService.logLevel === 0 && this._logService.trace("parsing data (codes)", typeof e == "string" ? e.split("").map((a) => a.charCodeAt(0)) : e), this._parseBuffer.length < e.length && this._parseBuffer.length < Ke && (this._parseBuffer = new Uint32Array(Math.min(e.length, Ke))), o || this._dirtyRowTracker.clearRange(), e.length > Ke) for (let a = n; a < e.length; a += Ke) {
      let d = a + Ke < e.length ? a + Ke : e.length, c = typeof e == "string" ? this._stringDecoder.decode(e.substring(a, d), this._parseBuffer) : this._utf8Decoder.decode(e.subarray(a, d), this._parseBuffer);
      if (i = this._parser.parse(this._parseBuffer, c)) return this._preserveStack(s, r, c, a), this._logSlowResolvingAsync(i), i;
    }
    else if (!o) {
      let a = typeof e == "string" ? this._stringDecoder.decode(e, this._parseBuffer) : this._utf8Decoder.decode(e, this._parseBuffer);
      if (i = this._parser.parse(this._parseBuffer, a)) return this._preserveStack(s, r, a, 0), this._logSlowResolvingAsync(i), i;
    }
    (this._activeBuffer.x !== s || this._activeBuffer.y !== r) && this._onCursorMove.fire();
    let h = this._dirtyRowTracker.end + (this._bufferService.buffer.ybase - this._bufferService.buffer.ydisp), l = this._dirtyRowTracker.start + (this._bufferService.buffer.ybase - this._bufferService.buffer.ydisp);
    l < this._bufferService.rows && this._onRequestRefreshRows.fire({
      start: Math.min(l, this._bufferService.rows - 1),
      end: Math.min(h, this._bufferService.rows - 1)
    });
  }
  print(e, t, i) {
    ...
    for (let f = t; f < i; ++f) {
      if (s = e[f], s < 127 && n) {
        let D = n[String.fromCharCode(s)];
        D && (s = D.charCodeAt(0));
      }
      let u = this._unicodeService.charProperties(s, _);
      r = Je.extractWidth(u);
      let g = Je.extractShouldJoin(u), k = g ? Je.extractWidth(_) : 0;
      if (_ = u, o && this._onA11yChar.fire(Ue(s)), this._getCurrentLinkId() && this._oscLinkService.addLineToLink(this._getCurrentLinkId(), this._activeBuffer.ybase + this._activeBuffer.y), this._activeBuffer.x + r - k > h) {
        if (l) {
          let D = c, I = this._activeBuffer.x - k;
          for (this._activeBuffer.x = k, this._activeBuffer.y++, this._activeBuffer.y === this._activeBuffer.scrollBottom + 1 ? (this._activeBuffer.y--, this._bufferService.scroll(this._eraseAttrData(), !0)) : (this._activeBuffer.y >= this._bufferService.rows && (this._activeBuffer.y = this._bufferService.rows - 1), this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).isWrapped = !0), c = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y), k > 0 && c instanceof St && c.copyCellsFrom(D, I, 0, k, !1); I < h; ) D.setCellFromCodepoint(I++, 0, 1, d);
        } else if (this._activeBuffer.x = h - 1, r === 2) continue;
      }
      if (g && this._activeBuffer.x) {
        let D = c.getWidth(this._activeBuffer.x - 1) ? 1 : 2;
        c.addCodepointToCell(this._activeBuffer.x - D, s, r);
        for (let I = r - k; --I >= 0; ) c.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, d);
        continue;
      }
      if (a && (c.insertCells(this._activeBuffer.x, r - k, this._activeBuffer.getNullCell(d)), c.getWidth(h - 1) === 2 && c.setCellFromCodepoint(h - 1, 0, 1, d)), c.setCellFromCodepoint(this._activeBuffer.x++, s, r, d), r > 0) for (; --r; ) c.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, d);
    }
  ...
  registerCsiHandler(e, t) {
    return e.final === "t" && !e.prefix && !e.intermediates ? this._parser.registerCsiHandler(e, (i) => pr(i.params[0], this._optionsService.rawOptions.windowOptions) ? t(i) : !0) : this._parser.registerCsiHandler(e, t);
  }
  registerDcsHandler(e, t) {
    return this._parser.registerDcsHandler(e, new ur(t));
  }
  registerEscHandler(e, t) {
    return this._parser.registerEscHandler(e, t);
  }
  registerOscHandler(e, t) {
    return this._parser.registerOscHandler(e, new fe(t));
  }
  bell() {
  ...
  scrollDown(e) {
    let t = e.params[0] || 1;
    for (; t--; ) this._activeBuffer.lines.splice(this._activeBuffer.ybase + this._activeBuffer.scrollBottom, 1), this._activeBuffer.lines.splice(this._activeBuffer.ybase + this._activeBuffer.scrollTop, 0, this._activeBuffer.getBlankLine(j));
    return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), !0;
  }
  scrollLeft(e) {
    if (this._activeBuffer.y > this._activeBuffer.scrollBottom || this._activeBuffer.y < this._activeBuffer.scrollTop) return !0;
  ...
  sendDeviceAttributesPrimary(e) {
    return e.params[0] > 0 || (this._is("xterm") || this._is("rxvt-unicode") || this._is("screen") ? this._coreService.triggerDataEvent(p.ESC + "[?1;2c") : this._is("linux") && this._coreService.triggerDataEvent(p.ESC + "[?6c")), !0;
  }
  sendDeviceAttributesSecondary(e) {
    return e.params[0] > 0 || (this._is("xterm") ? this._coreService.triggerDataEvent(p.ESC + "[>0;276;0c") : this._is("rxvt-unicode") ? this._coreService.triggerDataEvent(p.ESC + "[>85;95;0c") : this._is("linux") ? this._coreService.triggerDataEvent(e.params[0] + "c") : this._is("screen") && this._coreService.triggerDataEvent(p.ESC + "[>83;40003;0c")), !0;
  }
  _is(e) {
  ...
  setModePrivate(e) {
    for (let t = 0; t < e.length; t++) switch (e.params[t]) {
      case 1:
        ...
        break;
      case 2:
        this._charsetService.setgCharset(0, Ge), this._charsetService.setgCharset(1, Ge), this._charsetService.setgCharset(2, Ge), this._charsetService.setgCharset(3, Ge);
        break;
      case 3:
  ...
  requestMode(e, t) {
    let i;
    ((g) => (g[g.NOT_RECOGNIZED = 0] = "NOT_RECOGNIZED", g[g.SET = 1] = "SET", g[g.RESET = 2] = "RESET", g[g.PERMANENTLY_SET = 3] = "PERMANENTLY_SET", g[g.PERMANENTLY_RESET = 4] = "PERMANENTLY_RESET"))(i || (i = {}));
    let s = this._coreService.decPrivateModes, { activeProtocol: r, activeEncoding: n } = this._coreMouseService, o = this._coreService, { buffers: h, cols: l } = this._bufferService, { active: a, alt: d } = h, c = this._optionsService.rawOptions, _ = (g, k) => (o.triggerDataEvent(`${p.ESC}[${t ? "" : "?"}${g};${k}$y`), !0), f = (g) => g ? 1 : 2, u = e.params[0];
    return t ? u === 2 ? _(u, 4) : u === 4 ? _(u, f(o.modes.insertMode)) : u === 12 ? _(u, 3) : u === 20 ? _(u, f(c.convertEol)) : _(u, 0) : u === 1 ? _(u, f(s.applicationCursorKeys)) : u === 3 ? _(u, c.windowOptions.setWinLines ? l === 80 ? 2 : l === 132 ? 1 : 0 : 0) : u === 6 ? _(u, f(s.origin)) : u === 7 ? _(u, f(s.wraparound)) : u === 8 ? _(u, 3) : u === 9 ? _(u, f(r === "X10")) : u === 12 ? _(u, f(c.cursorBlink)) : u === 25 ? _(u, f(!o.isCursorHidden)) : u === 45 ? _(u, f(s.reverseWraparound)) : u === 66 ? _(u, f(s.applicationKeypad)) : u === 67 ? _(u, 4) : u === 1e3 ? _(u, f(r === "VT200")) : u === 1002 ? _(u, f(r === "DRAG")) : u === 1003 ? _(u, f(r === "ANY")) : u === 1004 ? _(u, f(s.sendFocus)) : u === 1005 ? _(u, 4) : u === 1006 ? _(u, f(n === "SGR")) : u === 1015 ? _(u, 4) : u === 1016 ? _(u, f(n === "SGR_PIXELS")) : u === 1048 ? _(u, 1) : u === 47 || u === 1047 || u === 1049 ? _(u, f(a === d)) : u === 2004 ? _(u, f(s.bracketedPasteMode)) : u === 2026 ? _(u, f(s.synchronizedOutput)) : _(u, 0);
  }
  _updateAttrColor(e, t, i, s, r) {
    return t === 2 ? (e |= 50331648, e &= -16777216, e |= Rt.fromColorRGB([
      i,
      s,
      r
    ])) : t === 5 && (e &= -50331904, e |= 33554432 | i & 255), e;
  }
  _extractColor(e, t, i) {
    let s = [
      0,
    ...
    do {
      if (s[n + r] = e.params[t + n], e.hasSubParams(t + n)) {
        let o = e.getSubParams(t + n), h = 0;
        do
          s[1] === 5 && (r = 1), s[n + h + 1 + r] = o[h];
        while (++h < o.length && h + n + 1 + r < s.length);
        break;
      }
  ...
  _processSGR0(e) {
    e.fg = j.fg, e.bg = j.bg, e.extended = e.extended.clone(), e.extended.underlineStyle = 0, e.extended.underlineColor &= -67108864, e.updateExtended();
  }
  charAttributes(e) {
    if (e.length === 1 && e.params[0] === 0) return this._processSGR0(this._curAttrData), !0;
    let t = e.length, i, s = this._curAttrData;
    for (let r = 0; r < t; r++) i = e.params[r], i >= 30 && i <= 37 ? (s.fg &= -50331904, s.fg |= 16777216 | i - 30) : i >= 40 && i <= 47 ? (s.bg &= -50331904, s.bg |= 16777216 | i - 40) : i >= 90 && i <= 97 ? (s.fg &= -50331904, s.fg |= i - 90 | 16777224) : i >= 100 && i <= 107 ? (s.bg &= -50331904, s.bg |= i - 100 | 16777224) : i === 0 ? this._processSGR0(s) : i === 1 ? s.fg |= 134217728 : i === 3 ? s.bg |= 67108864 : i === 4 ? (s.fg |= 268435456, this._processUnderline(e.hasSubParams(r) ? e.getSubParams(r)[0] : 1, s)) : i === 5 ? s.fg |= 536870912 : i === 7 ? s.fg |= 67108864 : i === 8 ? s.fg |= 1073741824 : i === 9 ? s.fg |= 2147483648 : i === 2 ? s.bg |= 134217728 : i === 21 ? this._processUnderline(2, s) : i === 22 ? (s.fg &= -134217729, s.bg &= -134217729) : i === 23 ? s.bg &= -67108865 : i === 24 ? (s.fg &= -268435457, this._processUnderline(0, s)) : i === 25 ? s.fg &= -536870913 : i === 27 ? s.fg &= -67108865 : i === 28 ? s.fg &= -1073741825 : i === 29 ? s.fg &= 2147483647 : i === 39 ? (s.fg &= -67108864, s.fg |= j.fg & 16777215) : i === 49 ? (s.bg &= -67108864, s.bg |= j.bg & 16777215) : i === 38 || i === 48 || i === 58 ? r += this._extractColor(e, r, s) : i === 53 ? s.bg |= 1073741824 : i === 55 ? s.bg &= -1073741825 : i === 59 ? (s.extended = s.extended.clone(), s.extended.underlineColor = -1, s.updateExtended()) : i === 100 ? (s.fg &= -67108864, s.fg |= j.fg & 16777215, s.bg &= -67108864, s.bg |= j.bg & 16777215) : this._logService.debug("Unknown SGR attribute: %d.", i);
    return !0;
  }
  deviceStatus(e) {
    switch (e.params[0]) {
      ...
      case 6:
        ...
        this._coreService.triggerDataEvent(`${p.ESC}[${t};${i}R`);
    }
    return !0;
  }
  ...
  windowOptions(e) {
    if (!pr(e.params[0], this._optionsService.rawOptions.windowOptions)) return !0;
    ...
    switch (e.params[0]) {
      ...
      case 18:
        ...
        break;
      case 22:
        (t === 0 || t === 2) && (this._windowTitleStack.push(this._windowTitle), this._windowTitleStack.length > fr && this._windowTitleStack.shift()), (t === 0 || t === 1) && (this._iconNameStack.push(this._iconName), this._iconNameStack.length > fr && this._iconNameStack.shift());
        break;
      case 23:
  ...
  _createHyperlink(e, t) {
    ...
    return r !== -1 && (s = i[r].slice(3) || void 0), this._curAttrData.extended = this._curAttrData.extended.clone(), this._curAttrData.extended.urlId = this._oscLinkService.registerLink({
      id: s,
      uri: t
  ...
  _setOrReportSpecialColor(e, t) {
    let i = e.split(";");
    for (let s = 0; s < i.length && !(t >= this._specialColors.length); ++s, ++t) if (i[s] === "?") this._onColor.fire([{
      type: 0,
  ...
  selectCharset(e) {
    return e.length !== 2 ? (this.selectDefaultCharset(), !0) : (e[0] === "/" || this._charsetService.setgCharset(Bh[e[0]], J[e[1]] || Ge), !0);
  }
  index() {
  ...
  reset() {
    this._curAttrData = j.clone(), this._eraseAttrDataInternal = j.clone();
  }
  _eraseAttrData() {
  ...
  requestStatusString(e, t) {
    let i = (n) => (this._coreService.triggerDataEvent(`${p.ESC}${n}${p.ESC}\\`), !0), s = this._bufferService.buffer, r = this._optionsService.rawOptions;
    return i(e === '"q' ? `P1$r${this._curAttrData.isProtected() ? 1 : 0}"q` : e === '"p' ? 'P1$r61;1"p' : e === "r" ? `P1$r${s.scrollTop + 1};${s.scrollBottom + 1}r` : e === "m" ? "P1$r0m" : e === " q" ? `P1$r${{
      block: 2,
      underline: 4,
      bar: 6
  ...
  markRangeDirty(e, t) {
    e > t && (vr = e, e = t, t = vr), e < this.start && (this.start = e), t > this.end && (this.end = t);
  }
  markAllDirty() {
...
var Mh = 5e7, Sr = 12, Lh = 50, Ph = class extends R {
  constructor(e) {
  ...
  write(e, t) {
    if (this._pendingData > Mh) throw new Error("write data discarded, use flow control to avoid losing data");
  ...
  _innerWrite(e = 0, t = !0) {
    ...
    for (; this._writeBuffer.length > this._bufferOffset; ) {
      ...
      if (r) {
        let o = (h) => performance.now() - i >= Sr ? setTimeout(() => this._innerWrite(0, h)) : this._innerWrite(i, h);
        r.catch((h) => (queueMicrotask(() => {
          throw h;
        }), Promise.resolve(!1))).then(o);
        return;
      }
      let n = this._callbacks[this._bufferOffset];
      if (n && n(), this._bufferOffset++, this._pendingData -= s.length, performance.now() - i >= Sr) break;
    }
    this._writeBuffer.length > this._bufferOffset ? (this._bufferOffset > Lh && (this._writeBuffer = this._writeBuffer.slice(this._bufferOffset), this._callbacks = this._callbacks.slice(this._bufferOffset), this._bufferOffset = 0), setTimeout(() => this._innerWrite())) : (this._writeBuffer.length = 0, this._callbacks.length = 0, this._pendingData = 0, this._bufferOffset = 0), this._onWriteParsed.fire();
  }
}, cs = class {
  constructor(e) {
  ...
  registerLink(e) {
    ...
    if (e.id === void 0) {
      let h = t.addMarker(t.ybase + t.y), l = {
        data: e,
        id: this._nextId++,
        lines: [h]
      };
    ...
    let n = t.addMarker(t.ybase + t.y), o = {
      id: this._nextId++,
...
cs = q([y(0, ce)], cs);
var br = !1, Th = class extends R {
  constructor(e) {
    super(), this._windowsWrappingHeuristics = this._register(new rt()), this._onBinary = this._register(new v()), this.onBinary = this._onBinary.event, this._onData = this._register(new v()), this.onData = this._onData.event, this._onLineFeed = this._register(new v()), this.onLineFeed = this._onLineFeed.event, this._onResize = this._register(new v()), this.onResize = this._onResize.event, this._onWriteParsed = this._register(new v()), this.onWriteParsed = this._onWriteParsed.event, this._onScroll = this._register(new v()), this._instantiationService = new ih(), this.optionsService = this._register(new _h(e)), this._instantiationService.setService(de, this.optionsService), this._bufferService = this._register(this._instantiationService.createInstance(ns)), this._instantiationService.setService(ce, this._bufferService), this._logService = this._register(this._instantiationService.createInstance(rs)), this._instantiationService.setService(Tr, this._logService), this.coreService = this._register(this._instantiationService.createInstance(os)), this._instantiationService.setService(tt, this.coreService), this.coreMouseService = this._register(this._instantiationService.createInstance(as)), this._instantiationService.setService(Pr, this.coreMouseService), this.unicodeService = this._register(this._instantiationService.createInstance(Je)), this._instantiationService.setService(On, this.unicodeService), this._charsetService = this._instantiationService.createInstance(mh), this._instantiationService.setService(An, this._charsetService), this._oscLinkService = this._instantiationService.createInstance(cs), this._instantiationService.setService(Ar, this._oscLinkService), this._inputHandler = this._register(new Rh(this._bufferService, this._charsetService, this.coreService, this._logService, this.optionsService, this._oscLinkService, this.coreMouseService, this.unicodeService)), this._register(se.forward(this._inputHandler.onLineFeed, this._onLineFeed)), this._register(this._inputHandler), this._register(se.forward(this._bufferService.onResize, this._onResize)), this._register(se.forward(this.coreService.onData, this._onData)), this._register(se.forward(this.coreService.onBinary, this._onBinary)), this._register(this.coreService.onRequestScrollToBottom(() => this.scrollToBottom(!0))), this._register(this.coreService.onUserInput(() => this._writeBuffer.handleUserInput())), this._register(this.optionsService.onMultipleOptionChange(["windowsMode", "windowsPty"], () => this._handleWindowsPtyOptionChange())), this._register(this._bufferService.onScroll(() => {
    ...
    })), this._writeBuffer = this._register(new Ph((t, i) => this._inputHandler.parse(t, i))), this._register(se.forward(this._writeBuffer.onWriteParsed, this._onWriteParsed));
  }
  get onScroll() {
  ...
  writeSync(e, t) {
    this._logService.logLevel <= 3 && !br && (this._logService.warn("writeSync is unreliable and will be removed soon."), br = !0), this._writeBuffer.writeSync(e, t);
  }
  input(e, t = !0) {
    this.coreService.triggerDataEvent(e, t);
  }
  resize(e, t) {
    isNaN(e) || isNaN(t) || (e = Math.max(e, vn), t = Math.max(t, mn), this._bufferService.resize(e, t));
  }
  scroll(e, t = !1) {
  ...
  _enableWindowsWrappingHeuristics() {
    if (!this._windowsWrappingHeuristics.value) {
      let e = [];
      e.push(this.onLineFeed(dr.bind(null, this._bufferService))), e.push(this.registerCsiHandler({ final: "H" }, () => (dr(this._bufferService), !1))), this._windowsWrappingHeuristics.value = z(() => {
...
function Oh(e, t, i, s) {
  let r = {
    ...
    cancel: !1,
    key: void 0
  }, n = (e.shiftKey ? 1 : 0) | (e.altKey ? 2 : 0) | (e.ctrlKey ? 4 : 0) | (e.metaKey ? 8 : 0);
  switch (e.keyCode) {
    case 0:
      e.key === "UIKeyInputUpArrow" ? t ? r.key = p.ESC + "OA" : r.key = p.ESC + "[A" : e.key === "UIKeyInputLeftArrow" ? t ? r.key = p.ESC + "OD" : r.key = p.ESC + "[D" : e.key === "UIKeyInputRightArrow" ? t ? r.key = p.ESC + "OC" : r.key = p.ESC + "[C" : e.key === "UIKeyInputDownArrow" && (t ? r.key = p.ESC + "OB" : r.key = p.ESC + "[B");
      break;
    case 8:
      r.key = e.ctrlKey ? "\b" : p.DEL, e.altKey && (r.key = p.ESC + r.key);
      break;
    case 9:
      if (e.shiftKey) {
        r.key = p.ESC + "[Z";
      ...
      r.key = p.HT, r.cancel = !0;
      break;
    case 13:
      r.key = e.altKey ? p.ESC + p.CR : p.CR, r.cancel = !0;
      break;
    case 27:
      r.key = p.ESC, e.altKey && (r.key = p.ESC + p.ESC), r.cancel = !0;
      break;
    case 37:
      if (e.metaKey) break;
      n ? r.key = p.ESC + "[1;" + (n + 1) + "D" : t ? r.key = p.ESC + "OD" : r.key = p.ESC + "[D";
      break;
    case 39:
      if (e.metaKey) break;
      n ? r.key = p.ESC + "[1;" + (n + 1) + "C" : t ? r.key = p.ESC + "OC" : r.key = p.ESC + "[C";
      break;
    case 38:
      if (e.metaKey) break;
      n ? r.key = p.ESC + "[1;" + (n + 1) + "A" : t ? r.key = p.ESC + "OA" : r.key = p.ESC + "[A";
      break;
    case 40:
      if (e.metaKey) break;
      n ? r.key = p.ESC + "[1;" + (n + 1) + "B" : t ? r.key = p.ESC + "OB" : r.key = p.ESC + "[B";
      break;
    case 45:
      !e.shiftKey && !e.ctrlKey && (r.key = p.ESC + "[2~");
      break;
    case 46:
      n ? r.key = p.ESC + "[3;" + (n + 1) + "~" : r.key = p.ESC + "[3~";
      break;
    case 36:
      n ? r.key = p.ESC + "[1;" + (n + 1) + "H" : t ? r.key = p.ESC + "OH" : r.key = p.ESC + "[H";
      break;
    case 35:
      n ? r.key = p.ESC + "[1;" + (n + 1) + "F" : t ? r.key = p.ESC + "OF" : r.key = p.ESC + "[F";
      break;
    case 33:
      e.shiftKey ? r.type = 2 : e.ctrlKey ? r.key = p.ESC + "[5;" + (n + 1) + "~" : r.key = p.ESC + "[5~";
      break;
    case 34:
      e.shiftKey ? r.type = 3 : e.ctrlKey ? r.key = p.ESC + "[6;" + (n + 1) + "~" : r.key = p.ESC + "[6~";
      break;
    case 112:
      n ? r.key = p.ESC + "[1;" + (n + 1) + "P" : r.key = p.ESC + "OP";
      break;
    case 113:
      n ? r.key = p.ESC + "[1;" + (n + 1) + "Q" : r.key = p.ESC + "OQ";
      break;
    case 114:
      n ? r.key = p.ESC + "[1;" + (n + 1) + "R" : r.key = p.ESC + "OR";
      break;
    case 115:
      n ? r.key = p.ESC + "[1;" + (n + 1) + "S" : r.key = p.ESC + "OS";
      break;
    case 116:
      n ? r.key = p.ESC + "[15;" + (n + 1) + "~" : r.key = p.ESC + "[15~";
      break;
    case 117:
      n ? r.key = p.ESC + "[17;" + (n + 1) + "~" : r.key = p.ESC + "[17~";
      break;
    case 118:
      n ? r.key = p.ESC + "[18;" + (n + 1) + "~" : r.key = p.ESC + "[18~";
      break;
    case 119:
      n ? r.key = p.ESC + "[19;" + (n + 1) + "~" : r.key = p.ESC + "[19~";
      break;
    case 120:
      n ? r.key = p.ESC + "[20;" + (n + 1) + "~" : r.key = p.ESC + "[20~";
      break;
    case 121:
      n ? r.key = p.ESC + "[21;" + (n + 1) + "~" : r.key = p.ESC + "[21~";
      break;
    case 122:
      n ? r.key = p.ESC + "[23;" + (n + 1) + "~" : r.key = p.ESC + "[23~";
      break;
    case 123:
      n ? r.key = p.ESC + "[24;" + (n + 1) + "~" : r.key = p.ESC + "[24~";
      break;
    default:
      if (e.ctrlKey && !e.shiftKey && !e.altKey && !e.metaKey) e.keyCode >= 65 && e.keyCode <= 90 ? r.key = String.fromCharCode(e.keyCode - 64) : e.keyCode === 32 ? r.key = p.NUL : e.keyCode >= 51 && e.keyCode <= 55 ? r.key = String.fromCharCode(e.keyCode - 51 + 27) : e.keyCode === 56 ? r.key = p.DEL : e.keyCode === 219 ? r.key = p.ESC : e.keyCode === 220 ? r.key = p.FS : e.keyCode === 221 && (r.key = p.GS);
      else if ((!i || s) && e.altKey && !e.metaKey) {
        let o = Ah[e.keyCode]?.[e.shiftKey ? 1 : 0];
        if (o) r.key = p.ESC + o;
        else if (e.keyCode >= 65 && e.keyCode <= 90) {
          let h = e.ctrlKey ? e.keyCode - 64 : e.keyCode + 32, l = String.fromCharCode(h);
          e.shiftKey && (l = l.toUpperCase()), r.key = p.ESC + l;
        } else if (e.keyCode === 32) r.key = p.ESC + (e.ctrlKey ? p.NUL : " ");
        else if (e.key === "Dead" && e.code.startsWith("Key")) {
          let h = e.code.slice(3, 4);
          e.shiftKey || (h = h.toLowerCase()), r.key = p.ESC + h, r.cancel = !0;
        }
      } else i && !e.altKey && !e.ctrlKey && !e.shiftKey && e.metaKey ? e.keyCode === 65 && (r.type = 1) : e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.keyCode >= 48 && e.key.length === 1 ? r.key = e.key : e.key && e.ctrlKey && (e.key === "_" && (r.key = p.US), e.key === "@" && (r.key = p.NUL));
  }
  return r;
}
var V = 0, Ih = class {
  constructor(e) {
    this._getKey = e, this._array = [], this._insertedValues = [], this._flushInsertedTask = new Qt(), this._isFlushingInserted = !1, this._deletedIndices = [], this._flushDeletedTask = new Qt(), this._isFlushingDeleted = !1;
  }
  clear() {
  ...
  delete(e) {
    ...
    if (t === void 0 || (V = this._search(t), V === -1) || this._getKey(this._array[V]) !== t) return !1;
    do
      if (this._array[V] === e) return this._deletedIndices.length === 0 && this._flushDeletedTask.enqueue(() => this._flushDeleted()), this._deletedIndices.push(V), !0;
    while (++V < this._array.length && this._getKey(this._array[V]) === t);
    return !1;
  }
  _flushDeleted() {
  ...
  *getKeyIterator(e) {
    if (this._flushCleanupInserted(), this._flushCleanupDeleted(), this._array.length !== 0 && (V = this._search(e), !(V < 0 || V >= this._array.length) && this._getKey(this._array[V]) === e)) do
      yield this._array[V];
    while (++V < this._array.length && this._getKey(this._array[V]) === e);
  }
  forEachByKey(e, t) {
    if (this._flushCleanupInserted(), this._flushCleanupDeleted(), this._array.length !== 0 && (V = this._search(e), !(V < 0 || V >= this._array.length) && this._getKey(this._array[V]) === e)) do
      t(this._array[V]);
...
}, yi = 0, wr = 0, Nh = class extends R {
  constructor() {
    super(), this._decorations = new Ih((e) => e?.marker.line), this._onDecorationRegistered = this._register(new v()), this.onDecorationRegistered = this._onDecorationRegistered.event, this._onDecorationRemoved = this._register(new v()), this.onDecorationRemoved = this._onDecorationRemoved.event, this._register(z(() => this.reset()));
  }
  get decorations() {
  ...
  *getDecorationsAtCell(e, t, i) {
  ...
  forEachDecorationAtCell(e, t, i, s) {
    this._decorations.forEachByKey(t, (r) => {
      yi = r.options.x ?? 0, wr = yi + (r.options.width ?? 1), e >= yi && e < wr && (!i || (r.options.layer ?? "bottom") === i) && s(r);
    });
  }
}, Hh = class extends Ve {
  constructor(e) {
  ...
  get backgroundColorRGB() {
    return this._cachedBg === null && (this.options.backgroundColor ? this._cachedBg = W.toColor(this.options.backgroundColor) : this._cachedBg = void 0), this._cachedBg;
  }
  get foregroundColorRGB() {
    return this._cachedFg === null && (this.options.foregroundColor ? this._cachedFg = W.toColor(this.options.foregroundColor) : this._cachedFg = void 0), this._cachedFg;
  }
  dispose() {
...
`))), this._register(this._terminal.onA11yTab((n) => this._handleTab(n))), this._register(this._terminal.onKey((n) => this._handleKey(n.key))), this._register(this._terminal.onBlur(() => this._clearLiveRegion())), this._register(this._renderService.onDimensionsChange(() => this._refreshRowsDimensions())), this._register(B(r, "selectionchange", () => this._handleSelectionChange())), this._register(this._coreBrowserService.onDprChange(() => this._refreshRowsDimensions())), this._refreshRowsDimensions(), this._refreshRows(), this._register(z(() => {
  ...
  _handleChar(e) {
    this._liveRegionLineCount < yr + 1 && (this._charsToConsume.length > 0 ? this._charsToConsume.shift() !== e && (this._charsToAnnounce += e) : this._charsToAnnounce += e, e === `
` && (this._liveRegionLineCount++, this._liveRegionLineCount === yr + 1 && (this._liveRegion.textContent += ki.get())));
  }
  _clearLiveRegion() {
  ...
  _renderRows(e, t) {
    ...
    for (let r = e; r <= t; r++) {
      let n = i.lines.get(i.ydisp + r), o = [], h = n?.translateToString(!0, void 0, void 0, o) || "", l = (i.ydisp + r + 1).toString(), a = this._rowElements[r];
      a && (h.length === 0 ? (a.textContent = " ", this._rowColumns.set(a, [0, 1])) : (a.textContent = h, this._rowColumns.set(a, o)), a.setAttribute("aria-posinset", l), a.setAttribute("aria-setsize", s), this._alignRowWidth(a));
    }
  ...
  _handleBoundaryFocus(e, t) {
    let i = e.target, s = this._rowElements[t === 0 ? 1 : this._rowElements.length - 2];
    if (i.getAttribute("aria-posinset") === (t === 0 ? "1" : `${this._terminal.buffer.lines.length}`) || e.relatedTarget !== s) return;
    let r, n;
    if (t === 0 ? (r = i, n = this._rowElements.pop(), this._rowContainer.removeChild(n)) : (r = this._rowElements.shift(), n = i, this._rowContainer.removeChild(r)), r.removeEventListener("focus", this._topBoundaryFocusListener), n.removeEventListener("focus", this._bottomBoundaryFocusListener), t === 0) {
      let o = this._createAccessibilityTreeNode();
  ...
  _handleSelectionChange() {
    ...
    let r = ({ node: h, offset: l }) => {
      ...
      return _ >= this._terminal.cols && (++d, _ = 0), {
        row: d,
        column: _
      };
    }, n = r(t), o = r(i);
...
var ds = class extends R {
  constructor(e, t, i, s, r) {
    ...
    })), this._register(B(this._element, "mouseleave", () => {
      this._isMouseOut = !0, this._clearCurrentLink();
    })), this._register(B(this._element, "mousemove", this._handleMouseMove.bind(this))), this._register(B(this._element, "mousedown", this._handleMouseDown.bind(this))), this._register(B(this._element, "mouseup", this._handleMouseUp.bind(this)));
  }
  get currentLink() {
  ...
  _removeIntersectingLinks(e, t) {
    ...
    for (let s = 0; s < t.size; s++) {
      ...
      if (r) for (let n = 0; n < r.length; n++) {
        let o = r[n], h = o.link.range.start.y < e ? 0 : o.link.range.start.x, l = o.link.range.end.y > e ? this._bufferService.cols : o.link.range.end.x;
        for (let a = h; a <= l; a++) {
          if (i.has(a)) {
            r.splice(n--, 1);
            break;
  ...
  _checkLinkProviderResult(e, t, i) {
    ...
    if (this._activeProviderReplies.size === this._linkProviderService.linkProviders.length && !i) for (let n = 0; n < this._activeProviderReplies.size; n++) {
      let o = this._activeProviderReplies.get(n)?.find((h) => this._linkAtPosition(h.link, t));
      if (o) {
  ...
  _handleMouseUp(e) {
    ...
    let t = this._positionFromMouseEvent(e, this._element, this._mouseService);
    t && this._mouseDownLink && Fh(this._mouseDownLink.link, this._currentLink.link) && this._linkAtPosition(this._currentLink.link, t) && this._currentLink.link.activate(e, this._currentLink.link.text);
  }
...
var $h = class extends Th {
  ...
  _handleColorEvent(e) {
    if (this._themeService) for (let t of e) {
      ...
      switch (t.type) {
        case 0:
          let r = H.toColorRGB(i === "ansi" ? this._themeService.colors.ansi[t.index] : this._themeService.colors[i]);
          this.coreService.triggerDataEvent(`${p.ESC}]${s};${Dh(r)}${Xi.ST}`);
          break;
        case 1:
  ...
  _handleScreenReaderModeOptionChange(e) {
    e ? !this._accessibilityManager.value && this._renderService && (this._accessibilityManager.value = this._instantiationService.createInstance(ei, this)) : this._accessibilityManager.clear();
  }
  _handleTextAreaFocus(e) {
    this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(p.ESC + "[I"), this.element.classList.add("focus"), this._showCursor(), this._onFocus.fire();
  }
  blur() {
    return this.textarea?.blur();
  }
  _handleTextAreaBlur() {
    this.textarea.value = "", this.refresh(this.buffer.y, this.buffer.y), this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(p.ESC + "[O"), this.element.classList.remove("focus"), this._onBlur.fire();
  }
  _syncTextArea() {
    if (!this.textarea || !this.buffer.isCursorInViewport || this._compositionHelper.isComposing || !this._renderService) return;
    let e = this.buffer.ybase + this.buffer.y, t = this.buffer.lines.get(e);
    if (!t) return;
    let i = Math.min(this.buffer.x, this.cols - 1), s = this._renderService.dimensions.css.cell.height, r = t.getWidth(i), n = this._renderService.dimensions.css.cell.width * r, o = this.buffer.y * this._renderService.dimensions.css.cell.height, h = i * this._renderService.dimensions.css.cell.width;
  ...
  _initGlobal() {
    this._bindKeys(), this._register(B(this.element, "copy", (t) => {
      this.hasSelection() && Bn(t, this._selectionService);
    }));
    let e = (t) => Rn(t, this.textarea, this.coreService, this.optionsService);
    this._register(B(this.textarea, "paste", e)), this._register(B(this.element, "paste", e)), an ? this._register(B(this.element, "mousedown", (t) => {
      t.button === 2 && xs(t, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
    })) : this._register(B(this.element, "contextmenu", (t) => {
      xs(t, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
    })), ys && this._register(B(this.element, "auxclick", (t) => {
      t.button === 1 && Dr(t, this.textarea, this.screenElement);
    }));
  }
  _bindKeys() {
  ...
  open(e) {
    ...
    this._renderService.hasRenderer() || this._renderService.setRenderer(this._createRenderer()), this._register(this.onCursorMove(() => {
    ...
    })), this._selectionService = this._register(this._instantiationService.createInstance(is, this.element, this.screenElement, s)), this._instantiationService.setService(Nn, this._selectionService), this._register(this._selectionService.onRequestScrollLines((r) => this.scrollLines(r.amount, r.suppressScrollEvent))), this._register(this._selectionService.onSelectionChange(() => this._onSelectionChange.fire())), this._register(this._selectionService.onRequestRedraw((r) => this._renderService.handleSelectionChanged(r.start, r.end, r.columnSelectMode))), this._register(this._selectionService.onLinuxMouseSelection((r) => {
      this.textarea.value = r, this.textarea.focus(), this.textarea.select();
    })), this._register(se.any(this._onScroll.event, this._inputHandler.onScroll)(() => {
      ...
      !this._overviewRulerRenderer && r && this._viewportElement && this.screenElement && (this._overviewRulerRenderer = this._register(this._instantiationService.createInstance(Gt, this._viewportElement, this.screenElement)));
    }), this._charSizeService.measure(), this.refresh(0, this.rows - 1), this._initGlobal(), this.bindMouse();
  }
  _createRenderer() {
    return this._instantiationService.createInstance(Zi, this, this._document, this.element, this.screenElement, this._viewportElement, this._helperContainer, this.linkifier);
  }
  bindMouse() {
    ...
    function i(n) {
      ...
      switch (n.overrideType || n.type) {
        case "mousemove":
          l = 32, n.buttons === void 0 ? (h = 3, n.button !== void 0 && (h = n.button < 3 ? n.button : 3)) : h = n.buttons & 1 ? 0 : n.buttons & 4 ? 1 : n.buttons & 2 ? 2 : 3;
          break;
        case "mouseup":
          l = 0, h = n.button < 3 ? n.button : 3;
          break;
        case "mousedown":
          l = 1, h = n.button < 3 ? n.button : 3;
          break;
        case "wheel":
          if (e._customWheelEventHandler && e._customWheelEventHandler(n) === !1) return !1;
          let a = n.deltaY;
          if (a === 0 || e.coreMouseService.consumeWheelEvent(n, e._renderService?.dimensions?.device?.cell?.height, e._coreBrowserService?.dpr) === 0) return !1;
          l = a < 0 ? 0 : 1, h = 4;
          break;
        default:
          return !1;
      }
      return l === void 0 || h === void 0 || h > 4 ? !1 : e.coreMouseService.triggerMouseEvent({
        col: o.col,
        row: o.row,
        x: o.x,
        y: o.y,
    ...
    let s = {
      ...
      mouseup: (n) => (i(n), n.buttons || (this._document.removeEventListener("mouseup", s.mouseup), s.mousedrag && this._document.removeEventListener("mousemove", s.mousedrag)), this.cancel(n)),
      wheel: (n) => (i(n), this.cancel(n, !0)),
      mousedrag: (n) => {
        n.buttons && i(n);
      },
      mousemove: (n) => {
    ...
    this._register(this.coreMouseService.onProtocolChange((n) => {
    ...
    })), this.coreMouseService.activeProtocol = this.coreMouseService.activeProtocol, this._register(B(t, "mousedown", (n) => {
      ...
      if (!s.wheel) {
        ...
        if (!this.buffer.hasScrollback) {
          ...
          let o = p.ESC + (this.coreService.decPrivateModes.applicationCursorKeys ? "O" : "[") + (n.deltaY < 0 ? "A" : "B");
  ...
  paste(e) {
    Er(e, this.textarea, this.coreService, this.optionsService);
  }
  ...
  _keyDown(e) {
    ...
    let i = Oh(e, this.coreService.decPrivateModes.applicationCursorKeys, this.browser.isMac, this.options.macOptionIsMeta);
    ...
    if ((i.key === p.ETX || i.key === p.CR) && (this.textarea.value = ""), this._onKey.fire({
      key: i.key,
      domEvent: e
    }), this._showCursor(), this.coreService.triggerDataEvent(i.key, !0), !this.optionsService.rawOptions.screenReaderMode || e.altKey || e.ctrlKey) return this.cancel(e, !0);
  ...
  _keyUp(e) {
    this._keyDownSeen = !1, !(this._customKeyEventHandler && this._customKeyEventHandler(e) === !1) && (Kh(e) || this.focus(), this.updateCursorStyle(e), this._keyPressHandled = !1);
  }
  _keyPress(e) {
    let t;
  ...
  clear() {
    if (!(this.buffer.ybase === 0 && this.buffer.y === 0)) {
      ...
      for (let e = 1; e < this.rows; e++) this.buffer.lines.push(this.buffer.getBlankLine(j));
  ...
  _reportFocus() {
    this.element?.classList.contains("focus") ? this.coreService.triggerDataEvent(p.ESC + "[I") : this.coreService.triggerDataEvent(p.ESC + "[O");
  }
...
var Uh = class {
  ...
  getCell(e, t) {
    if (!(e < 0 || e >= this._line.length)) return t ? (this._line.loadCell(e, t), t) : this._line.loadCell(e, new be());
  }
  ...
  constructor(e) {
    super(), this._core = e, this._onBufferChange = this._register(new v()), this.onBufferChange = this._onBufferChange.event, this._normal = new kr(this._core.buffers.normal, "normal"), this._alternate = new kr(this._core.buffers.alt, "alternate"), this._core.buffers.onBufferActivate(() => this._onBufferChange.fire(this.active));
  }
  get active() {
...
}, Xh = ["cols", "rows"], De = 0, Gh = class extends R {
  constructor(e) {
    super(), this._core = this._register(new $h(e)), this._addonManager = this._register(new Uh()), this._publicOptions = { ...this._core.options };
  ...
  _checkReadonlyOptions(e) {
    if (Xh.includes(e)) throw new Error(`Option "${e}" can only be set in the constructor`);
  }
  _checkProposedApi() {
  ...
  get parser() {
    return this._parser || (this._parser = new Yh(this._core)), this._parser;
  }
  get unicode() {
    return this._checkProposedApi(), new jh(this._core);
  }
  get textarea() {
  ...
  get buffer() {
    return this._buffer || (this._buffer = this._register(new Vh(this._core))), this._buffer;
  }
  get markers() {
...
`, t);
  ...
  constructor(e) {
    ...
    }), this.fitAddon = new Cn(), this.terminal.loadAddon(this.fitAddon), this.terminal.open(e.container), this.fitAddon.fit(), this.terminal.focus(), this.bindTerminal(), this.observeResize(e.container), e.autoConnect !== !1 && this.connect();
  }
  connect() {
    if (this.socket && (this.socket.readyState === WebSocket.OPEN || this.socket.readyState === WebSocket.CONNECTING)) return;
    this.manualClose = !1, this.setStatus("connecting");
    const e = sl(this.options.debugPath, this.options.kind), t = new WebSocket(e);
    this.socket = t, t.onopen = () => {
      this.socket === t && (this.scheduleReconnectBudgetReset(t), this.resetOnOpen && (this.resetOnOpen = !1, this.resetTerminal()), this.setStatus("connected"), this.awaitingPrompt = !0, this.options.kind === "console" && this.writePrompt(), this.sendResize());
    }, t.onmessage = (i) => {
      this.socket === t && (!i || typeof i.data != "string" || this.handleMessage(i.data));
    }, t.onclose = () => {
      if (this.socket === t) {
      ...
      this.socket === t && this.setStatus("error");
    };
  }
  reconnect() {
  ...
  paste(e) {
    e && (this.handlePaste(e), this.terminal.focus());
  }
  bindTerminal() {
    if (this.terminal.attachCustomKeyEventHandler((e) => this.handleKeyEvent(e)), this.options.kind === "shell") {
    ...
    this.terminal.onData((e) => this.handleConsoleInput(e));
  }
  handleKeyEvent(e) {
    if (!e) return !0;
    const t = e.metaKey || e.ctrlKey;
    if (t && e.shiftKey && e.code === "KeyC") {
      const i = this.terminal.getSelection();
      return i ? (navigator.clipboard?.writeText(i).catch(() => null), !1) : !0;
    }
    return t && e.shiftKey && e.code === "KeyV" ? (navigator.clipboard?.readText().then((i) => {
...
`), this.lineBuffer = "", this.writePrompt(!0);
      ...
      this.lineBuffer += i, this.terminal.write(i);
    }
  }
  submitLine() {
    const e = this.lineBuffer.trim();
...
`), this.writePrompt(!0);
  ...
  handleMessage(e) {
    ...
    !t || !t.type || (this.options.kind === "shell" ? this.handleShellEvent(t) : this.handleConsoleEvent(t));
  }
  handleShellEvent(e) {
    if (e.type === "output" && typeof e.data == "string") {
      this.terminal.write(e.data);
      return;
    }
    if (e.type === "exit") {
      const t = Number(e.code ?? 0);
...
`);
  ...
  handleConsoleEvent(e) {
    if (e.type === "result") {
      const t = typeof e.output == "string" ? e.output : String(e.output ?? "");
      t && this.writeLine(t), this.writePrompt();
      return;
    }
    if (e.type === "error") {
      const t = typeof e.output == "string" ? e.output : String(e.output ?? "");
      t && this.terminal.write(`\x1B[31m${t}\x1B[0m\r
`), this.writePrompt();
    }
  }
  writeLine(e) {
    const t = e.replace(/\r?\n/g, `\r
`);
    this.terminal.write(`${t}\r
`);
  }
  writePrompt(e = !1) {
    this.options.kind === "console" && (!e && !this.awaitingPrompt || (this.awaitingPrompt = !1, this.terminal.write(this.prompt)));
  }
  sendResize() {
  ...
  sendCommand(e) {
    !e || !e.type || !this.socket || this.socket.readyState !== WebSocket.OPEN || this.socket.send(JSON.stringify(e));
  }
  setStatus(e) {
  ...
  scheduleReconnect() {
    ...
    if (this.reconnectAttempts >= el) {
      this.setStatus("disconnected");
      return;
    }
    const e = this.reconnectAttempts, t = Math.min(Zh * Math.pow(2, e), Qh), i = t * (0.2 + Math.random() * 0.3);
  ...
  scheduleReconnectBudgetReset(e) {
    ...
    const t = Math.max(this.options.reconnectStabilityMs ?? tl, 0);
    this.reconnectStabilityTimer = window.setTimeout(() => {
      this.reconnectStabilityTimer = null, this.socket === e && e.readyState === WebSocket.OPEN && (this.reconnectAttempts = 0);
    }, t);
  }
  resetTerminal() {
  ...
  observeResize(e) {
    !e || typeof ResizeObserver > "u" || (this.resizeObserver = new ResizeObserver(() => {
      this.fitAddon.fit(), this.sendResize();
...
}), cl = '<span class="debug-repl__overlay-text">Session not connected. Click the button below to start a terminal session.</span>', dl = `<button class="debug-repl__overlay-btn" data-overlay-connect>${st("connect", { size: "14px" })} Connect</button>`, xl = class {
  constructor(e) {
    this.commandsEl = null, this.connectButton = null, this.options = e, this.commands = Array.isArray(e.commands) ? e.commands : [], this.root = document.createElement("section"), this.root.className = "debug-repl", this.root.dataset.replKind = e.kind;
    const t = e.kind === "console" ? this.renderCommands() : "";
    this.root.innerHTML = `
      <div class="debug-repl__header">
        <div class="debug-repl__title">
          <span class="debug-repl__label">${ol[e.kind]}</span>
        ...
        <div class="debug-repl__actions">
          <button class="debug-btn" data-repl-action="reconnect">${st("refresh", { size: "14px" })} Reconnect</button>
          <button class="debug-btn" data-repl-action="clear">${st("clear", { size: "14px" })} Clear</button>
          <button class="debug-btn debug-btn--danger" data-repl-action="kill">${st("delete", { size: "14px" })} Kill</button>
        </div>
      </div>
  ...
  bindCommandActions() {
    !this.commandsEl || this.options.kind !== "console" || this.commandsEl.addEventListener("click", (e) => {
      const t = e.target;
      if (!t) return;
      const i = t.closest("[data-repl-command]");
      if (!i) return;
      const s = i.dataset.replCommand || "";
      s && (this.terminal.paste(`${s} `), this.terminal.focus());
    });
  }
  bindOverlayConnect() {
    const e = this.overlayEl.querySelector("[data-overlay-connect]");
  ...
  updateStatus(e) {
    const t = hl[e] || e;
    this.statusEl.dataset.replStatus = e, this.statusTextEl.textContent = t;
    const i = e === "disconnected" || e === "error";
    if (this.overlayEl.hidden = !i, this.terminalEl.dataset.terminalDisconnected = i ? "true" : "false", this.connectButton) {
      const s = i ? "Connect" : "Reconnect", r = i ? "connect" : "refresh";
      this.connectButton.innerHTML = `${st(r, { size: "14px" })} ${s}`;
    }
  }
  renderCommands() {
    if (this.options.kind !== "console") return "";
    const e = this.commands, t = e.length, i = e.map((s) => {
      const r = li(s.command), n = s.description ? `<div class="debug-repl__command-desc">${li(s.description)}</div>` : "", o = Array.isArray(s.tags) && s.tags.length > 0 ? `<div class="debug-repl__command-tags">${s.tags.map((h) => `<span class="debug-repl__command-tag">${li(h)}</span>`).join("")}</div>` : "";
      return `
          <button class="debug-repl__command" type="button" data-repl-command="${r}">
            <div class="debug-repl__command-title">
              <span class="debug-repl__command-name">${r}</span>
              <span class="debug-repl__command-badge ${s.mutates ? "debug-repl__command-badge--exec" : ""}">${s.mutates ? "exec" : "read-only"}</span>
            </div>
            ${n}
            ${o}
          </button>
    ...
    return `
      <aside class="debug-repl__commands" data-repl-commands>
        <div class="debug-repl__commands-header">
          <span>Commands</span>
          <span class="debug-repl__commands-count">${t}</span>
        </div>
        <div class="debug-repl__commands-list">
          ${t > 0 ? i : '<div class="debug-repl__commands-empty">No exposed commands.</div>'}
        </div>
      </aside>
    `;
  }
  requireElement(e, t) {
    ...
    if (!i) throw new Error(`Missing debug repl element: ${e}`);
    return i;
  }
};
export {
...
//# sourceMappingURL=repl-panel-Ce3vonoJ.js.map