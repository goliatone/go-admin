...
function u(e) {
  const n = e.page ?? 1, t = e.page_size ?? 20, s = e.total_count ?? 0, i = t > 0 ? Math.ceil(s / t) : 0, r = (n - 1) * t + 1, y = Math.min(n * t, s);
  return {
    mode: e.mode ?? "page",
    currentPage: n,
    pageSize: t,
...
function b(e) {
  ...
  return {
    ...
    confidenceLabel: v(e.lineage_confidence),
    providerKind: t.kind,
...
function k(e) {
  ...
  return {
    ...
    fingerprintProcessingLabel: T(i.state),
...
function C(e) {
  ...
  return {
    ...
    relationshipTypeLabel: P(e.relationship_type),
    status: e.status ?? "unknown",
...
function G(e, n, t) {
  return e ? a({ loadingMessage: "Loading sources..." }) : n !== null ? n.message.includes("403") || n.message.includes("Forbidden") ? p() : l(n) : t === null ? a() : t.empty_state.kind !== "none" ? o(t.empty_state, {
    suggestedActions: [{
      label: "Clear Filters",
...
function Y(e, n, t) {
  ...
  }] }) : l(n) : t === null ? a() : t.empty_state.kind !== "none" ? o(t.empty_state) : x(t);
}
function Q(e, n, t) {
  return e ? a({ loadingMessage: "Loading revisions..." }) : n !== null ? n.message.includes("403") || n.message.includes("Forbidden") ? p() : l(n) : t === null ? a() : t.empty_state.kind !== "none" ? o(t.empty_state) : M(t);
}
function H(e) {
  return {
...
function B(e) {
  return {
    ...
    matchedFieldLabels: O(e.matched_fields ?? []),
    summary: e.summary ?? "",
...
function J(e, n, t) {
  return e ? a({ loadingMessage: "Searching sources..." }) : n !== null ? n.message.includes("403") || n.message.includes("Forbidden") ? p() : l(n) : t === null ? a() : t.empty_state.kind !== "none" ? o(t.empty_state, {
    suggestedActions: [{
      label: "Clear Search",
      actionType: "filter_reset",
...
function W(e, n, t) {
  if (e) return a({ loadingMessage: "Loading comments..." });
  if (n !== null)
  ...
  return s === "failed" ? _(f(t), t.sync?.error_message ?? "Comment synchronization failed", "critical", {
    stale: !1,
    suggestedActions: [{
      label: "Retry Sync",
      actionType: "retry",
  ...
  }) : s === "stale" ? _(f(t), "Comment data may be outdated", "warning", {
    stale: !0,
...
//# sourceMappingURL=source-management-rendering-states-BtlxXRKI.js.map