...
export type { Widget, WidgetArea, WidgetLayoutRow, WidgetSlot, LayoutPreferences, WidgetGridConfig, WidgetGridSelectors, WidgetGridBehaviors, DragDropBehavior, ResizeBehavior, VisibilityBehavior, PersistenceBehavior, } from './types.js';
