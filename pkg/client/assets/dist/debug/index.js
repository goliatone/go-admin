...
import { _ as J, a as H, b as F, c as Q, d as Fe, f as Ne, g as X, h as z, i as je, l as x, m as Y, n as G, o as V, p as Me, r as W, s as Z, t as ee, u as Be, x as Ue, y as Ke } from "../chunks/builtin-panels-BKjPg2R2.js";
import { t as te } from "../chunks/repl-panel-7Cc12h6s.js";
...
f.prototype._trace = function(t, e, s, r, i, n, o, h) {
  ...
  if ((typeof c != "string" || h) && e && Object.hasOwn(e, c)) y(this._trace(d, e[c], C(s, c), e, c, n, o));
...
var U = (t) => {
  ...
  subscribeToEvents() {
    ...
    for (const e of this.panels) for (const s of ce(e)) t.add(s);
  ...
  updateFiltersFromInputs() {
    const t = this.activePanel, e = this.filtersEl.querySelectorAll("[data-filter]"), s = v.get(t);
    if (s?.renderFilters) {
  ...
  handleCustomEvent(t) {
    if (t) {
      if (typeof t == "object" && "key" in t && "value" in t) {
        _e(this.state.custom.data, String(t.key), t.value);
        return;
      }
