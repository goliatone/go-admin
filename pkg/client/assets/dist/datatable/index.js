...
import { createStructuredActionError as K, executeActionRequest as pe, executeStructuredRequest as Oe, extractErrorMessage as Lt, extractExchangeError as Yi, extractTranslationBlocker as _t, formatStructuredErrorForDisplay as I, generateExchangeReport as Wi, getStructuredActionError as M, groupRowResultsByStatus as Xi, isExchangeError as Zi, isHandledActionError as _, isTranslationBlocker as Rt, parseImportResult as ea } from "../toast/error-helpers.js";
import { n as Dt, t as J } from "../chunks/badge-DT04uHwZ.js";
import { t as Q } from "../chunks/date-utils-Xhx5dXNC.js";
import { $ as sa, A as ia, B as je, C as aa, D as oa, E as Pt, F as la, G as ca, H as da, I as ze, J as ua, K as ha, L as pa, M as fa, N as ma, O as ga, P as ba, Q as ya, R as va, S as Tt, T as wa, U as xa, V as Ne, W as Sa, X as Mt, Y as F, Z as Ca, _ as Ge, a as It, at as Ue, b as Bt, c as Ft, d as qt, et as $a, f as Ot, g as fe, h as jt, i as ka, it as zt, j as Ea, k as Aa, l as Nt, m as Gt, n as Ut, nt as He, o as La, ot as Ht, p as _a, q as Vt, r as Ra, rt as Ve, s as Kt, st as Ke, t as Da, tt as Pa, u as me, v as Ta, w as Ma, x as Ia, y as Ba, z as Fa } from "../chunks/grouped-mode-D5oZzoVA.js";
...
import { initActionMenus as Yt } from "../shared/action-menu.js";
import { normalizeAPIBasePath as Wt, normalizeBasePath as Xt } from "../shared/path-normalization.js";
import { r as Zt, t as er } from "../chunks/translation-contracts-Ct_EG7JJ.js";
...
var Qe = { async prompt(e) {
  ...
  buildDropdownItems(e, t) {
    return t.map((r, n) => {
      const s = r.variant === "danger", i = r.disabled === !0, a = this.getActionKey(r), o = r.icon ? this.renderIcon(r.icon) : "", l = this.shouldShowDivider(r, n, t), c = i ? (r.disabledReason || "Action unavailable").trim() : "", u = c ? `${a}-disabled-reason` : "", h = l ? '<div class="action-divider border-t border-gray-200 my-1"></div>' : "", p = i ? "action-item text-gray-400 cursor-not-allowed" : s ? "action-item text-red-600 hover:bg-red-50" : "action-item text-gray-700 hover:bg-gray-50", f = i ? 'aria-disabled="true"' : "", y = u ? `aria-describedby="${u}"` : "", g = c ? `${r.label} unavailable: ${c}` : r.label, m = r.disabledReason ? `title="${d(r.disabledReason)}"` : "", w = c ? `<span id="${u}" class="action-item-reason text-xs leading-5 text-gray-500">${d(c)}</span>` : "";
      return `
        ${h}
        <button type="button"
    ...
    if (r !== null)
      try {
        ...
        if (!n.success) {
          ...
          throw e.onError || this.notifier.error(a), i ? K(i, `Bulk action '${e.id}' failed`, !0) : K({
            textCode: null,
            message: a,
            metadata: null,
            fields: null,
...
function L(e) {
  ...
  return !e || typeof e != "object" || (t.requestedLocale = P(e, ["requested_locale"]), t.resolvedLocale = P(e, ["resolved_locale", "locale"]), t.availableLocales = cr(e, ["available_locales"]), t.missingRequestedLocale = Ee(e, ["missing_requested_locale"]), t.fallbackUsed = Ee(e, ["fallback_used"]), t.familyId = P(e, ["family_id"]), t.status = P(e, ["status"]), t.entityType = P(e, [
    "entity_type",
    "type",
    "_type"
...
function Ja(e, t = {}) {
  ...
  if (!r) return '<span class="text-gray-400">-</span>';
  const n = T(r, ["status"]), s = T(r, ["label"]), i = T(r, ["assignee_id"]), a = T(r, ["priority"]), o = oe(r, ["active_count", "open_count"]), l = [];
  return n ? l.push(F(n, {
    domain: "queue",
    size: "sm",
    showIcon: !1
  })) : s && l.push(A(s, t, "info")), o !== null && o >= 0 && l.push(A(`${o} active`, t, "neutral")), i && l.push(A(`@${i}`, t, "neutral")), a && l.push(A(a, t, a === "urgent" || a === "high" ? "warning" : "neutral")), l.length === 0 ? '<span class="text-gray-400">-</span>' : `<div class="inline-flex items-center gap-1.5 flex-wrap">${l.join("")}</div>`;
}
function Qa(e, t = {}) {
  const r = Ye(e, "translation_exchange_summary");
  if (!r) return '<span class="text-gray-400">-</span>';
  const n = T(r, ["status", "last_job_status"]), s = T(r, ["label", "last_job_label"]), i = oe(r, ["pending_count"]), a = oe(r, ["error_count"]), o = [];
  return n ? o.push(F(n, {
    domain: "exchange",
    size: "sm",
    showIcon: !1
...
function C(e) {
  ...
  if (r && typeof r == "object") {
    ...
    typeof s == "string" && rr(s) && (t.readinessState = s);
...
function Za(e, t = {}) {
  ...
  const { size: n = "default", showDetailedTooltip: s = !0, extraClass: i = "" } = t, a = `inline-flex items-center gap-1 rounded font-medium ${n === "sm" ? "text-xs px-1.5 py-0.5" : "text-xs px-2 py-1"}`, o = r.readinessState || "ready", { icon: l, label: c, bgClass: u, textClass: h, tooltip: p } = ir(o, r, s);
...
function ro(e, t = {}) {
  ...
  return o && l ? (c = "bg-red-100", u = "text-red-800", h = `${a} missing`, p = `Missing translations: ${r.missingRequiredLocales.join(", ")}. Also has incomplete fields.`) : o ? (c = "bg-amber-100", u = "text-amber-800", h = `${a} missing`, p = `Missing translations: ${r.missingRequiredLocales.join(", ")}`) : l && (c = "bg-yellow-100", u = "text-yellow-800", h = "Incomplete", p = `Incomplete fields in: ${Object.keys(r.missingRequiredFieldsByLocale).join(", ")}`), h ? `<span class="inline-flex items-center gap-1.5 rounded-full font-medium ${i} ${c} ${u} ${s}"
                title="${p}"
                aria-label="${p}"
...
function ir(e, t, r) {
  const n = Ne(e, "core"), s = n ? Mt(n, "sm") : "", i = n?.bgClass || "bg-gray-100", a = n?.textClass || "text-gray-600", o = n?.label || "Unknown", l = n?.description || "Unknown readiness state";
  switch (e) {
    case "ready":
      return {
        icon: s,
...
var E = '<span class="text-gray-400">-</span>', dr = [
  "name",
  "label",
  "title",
  "slug",
...
function le(e, t) {
  ...
  const r = [...hr(t), ...dr], n = /* @__PURE__ */ new Set();
  for (const s of r) {
    if (n.has(s)) continue;
    n.add(s);
    const i = fr(pr(e, s));
...
var wr = class {
  ...
  registerDefaultRenderers() {
    this.renderers.set("_badge", (e) => {
      ...
      if (!Array.isArray(e) || e.length === 0) return E;
      const s = n?.options || {}, i = mr(s, "max_visible", "maxVisible", 3), a = gr(s, "show_count", "showCount", !0), o = br(s, "chip_variant", "chipVariant", "default"), l = s.block_icons_map || s.blockIconsMap || {}, c = [], u = e.slice(0, i);
      for (const f of u) {
        const y = yr(f);
        if (!y) continue;
...
}, xr = "datagrid.state.", te = "datagrid.share.", Ze = "datagrid.share.index", Sr = 20, Cr = 1500;
function $r(e) {
...
var et = class {
  constructor(e) {
    const t = $r(e.key);
    this.key = t, this.persistedStorageKey = `${xr}${t}`, this.maxShareEntries = Math.max(1, e.maxShareEntries || Sr);
  }
  loadPersistedState() {
    try {
  ...
  createShareState(e) {
    ...
    try {
      ...
      const s = Lr(this.maxShareEntries).filter((i) => i.token !== r);
      for (s.unshift({
        token: r,
        updatedAt: t.updatedAt
      }); s.length > this.maxShareEntries; ) {
        const i = s.pop();
        i && localStorage.removeItem(`${te}${i.token}`);
      }
      return _r(s), r;
    } catch {
      return null;
  ...
  constructor(e) {
    super(e), this.syncTimeout = null, this.preferencesEndpoint = kr(e.preferencesEndpoint), this.resource = Er(e.resource) || this.key, this.syncDebounceMs = Math.max(100, e.syncDebounceMs || 1e3), this.hydrateTimeoutMs = Math.max(100, e.hydrateTimeoutMs || Cr);
  }
  get serverStateKey() {
  ...
  async hydrate() {
    ...
    try {
      ...
      if (!i) return;
      const a = this.extractMap(i.effective), o = this.extractMap(i.raw), l = j(a[this.serverStateKey] ?? o[this.serverStateKey]);
...
function Dr(e) {
  return (e.mode || "local") === "preferences" ? new Rr(e) : new et(e);
}
...
function Nr(e, t = {}) {
  ...
  let i = $e(window.location.pathname, n);
  ...
  if (r.enableStateToken && (s || a)) {
    ...
    o && n.set(Y, o), i = $e(window.location.pathname, n);
  }
...
function en(e, t, r, n) {
  ...
  const o = It(t);
  o.size > 0 && (a = Gt(a, o)), e.state.groupedData = a;
...
async function tt(e) {
  ...
  const r = String(e.fallbackMessage || "Delete failed").trim() || "Delete failed", n = t.error || gn(r), s = {
    ...n,
    message: I(n, r)
  };
...
function Cn(e, t) {
  ...
  if (a.className = "px-6 py-4 whitespace-nowrap text-end text-sm font-medium", a.dataset.role = "actions", a.dataset.fixed = "right", e.config.rowActions) {
    ...
    a.innerHTML = e.actionRenderer.renderRowActions(t, o), o.forEach((l) => {
      const c = e.sanitizeActionId(l.label), u = a.querySelector(`[data-action-id="${c}"]`);
...
function nt(e) {
  const t = On(document.getElementById("bulk-actions-overlay"));
  if (t) {
    if (!e.length) {
...
function Vn(e) {
  ...
  document.querySelectorAll("[data-bulk-action]").forEach((n) => {
    n.addEventListener("click", async () => {
      ...
      if (t) {
        const o = `${t}/${i}`, l = s.dataset.bulkConfirm, c = e.parseDatasetStringArray(s.dataset.bulkPayloadRequired), u = e.parseDatasetObject(s.dataset.bulkPayloadSchema), h = {
          id: i,
...
function Xn(e) {
  ...
  _n(document, "click", "[data-dropdown-toggle]", (n, s) => {
    n.stopPropagation();
...
var S, it = class {
  constructor(e) {
    ...
    this.stateStore = this.config.stateStore || Dr({
      key: t,
    ...
    }, this.actionRenderer = new tr({
      mode: this.config.actionRenderMode || "dropdown",
      actionBasePath: this.config.actionBasePath || this.config.apiEndpoint,
      notifier: this.notifier
    }), this.cellRendererRegistry = new wr(), this.config.cellRenderers && Object.entries(this.config.cellRenderers).forEach(([v, q]) => {
  ...
  async drainRefreshQueue() {
    for (; this.refreshQueued; ) {
      ...
      this.activeRefreshSeq = e, this.refreshInFlight = Gr(this, e), await this.refreshInFlight, this.refreshInFlight = null;
    }
  }
  buildApiUrl() {
    return Ur(this);
...
S.DEFAULT_MAX_URL_LENGTH = Pr;
S.DEFAULT_MAX_FILTERS_LENGTH = 600;
typeof window < "u" && (window.DataGrid = it);
var Le = {
  text: [
    {
      label: "contains",
  ...
  bindGroupEvents(e, t) {
    ...
    n && n.addEventListener("click", () => this.addCondition(t)), e.querySelectorAll("[data-cond]").forEach((s) => {
      const i = s, [a, o, l] = i.dataset.cond.split("-"), c = parseInt(a, 10), u = parseInt(o, 10);
      i.addEventListener("change", () => {
        l === "field" ? (this.structure.groups[c].conditions[u].field = i.value, this.render()) : l === "operator" ? (this.structure.groups[c].conditions[u].operator = i.value, this.updatePreview()) : l === "value" && (this.structure.groups[c].conditions[u].value = i.value, this.updatePreview());
      });
  ...
  async export(e, t) {
    ...
    const r = ds(t, this.config, e);
    r.delivery = us(this.config, e);
    let n;
    try {
    ...
    if (n.status === 202) {
      ...
      if (i) {
        ...
        try {
          await ms(i, {
            intervalMs: hs(this.config),
            timeoutMs: ps(this.config)
          });
          const o = await x(a, {
            method: "GET",
...
function ds(e, t, r) {
  const n = Cs(r), s = bs(e, t), i = ys(e, t), a = {
    format: n,
    query: ws(vs(e)),
    selection: s,
    columns: i,
...
async function ms(e, t) {
  ...
  for (; ; ) {
    ...
    const i = await at(s), a = String(i?.state || "").toLowerCase();
...
async function De(e, t, r) {
  const n = await e.blob(), s = $s(e, t, r), i = URL.createObjectURL(n), a = document.createElement("a");
...
var As = class {
  ...
  constructor(e, t) {
    ...
    const n = Xt(t.basePath), s = Wt(t.apiBasePath);
    t.preferencesEndpoint ? this.preferencesEndpoint = t.preferencesEndpoint : s ? this.preferencesEndpoint = `${s}/panels/preferences` : n ? this.preferencesEndpoint = `${n}/api/panels/preferences` : this.preferencesEndpoint = "/api/panels/preferences", this.syncDebounce = t.syncDebounce ?? 1e3, this.loadTimeoutMs = Math.max(100, t.loadTimeoutMs || Es);
  }
  get serverPrefsKey() {
  ...
  async loadFromServer() {
    ...
    try {
      ...
      return ot(i) ? (this.serverPrefs = i, this.savePrefs(i), console.log("[ServerColumnVisibility] Loaded prefs from server:", i), i) : (console.warn("[ServerColumnVisibility] Server prefs not in V2 format:", i), null);
    } catch (r) {
...
function D(e, t, r = "", n = "") {
  const { path: s, query: i } = Ls(e), a = s.replace(/\/+$/, ""), o = r.replace(/^\/+/, "");
...
var Pe = {
  ...
  resolveActionOrder(e, t) {
    ...
    return this.config.actionOrderOverride?.[r] !== void 0 ? this.config.actionOrderOverride[r] : Pe[r] !== void 0 ? Pe[r] : _s;
  }
...
function Is(e) {
  ...
  const { primary: t, rest: r } = Ms(e);
  let n = "";
  if (t) {
    const i = t.disabled === !0, a = ue(t, 0), o = Te(t), l = i ? (t.disabledReason || "Action unavailable").trim() : "", c = l ? `detail-action-reason-${a}` : "", u = c ? `aria-describedby="${c}"` : "", h = l ? `${t.label} unavailable: ${l}` : t.label, p = i && t.remediation?.href && t.remediation?.label ? `
          <a
  ...
  return r.length > 0 && (s = `
      <div class="relative" data-detail-actions-dropdown>
        ...
        >
          ${r.map((i, a) => {
    const o = i.disabled === !0, l = ue(i, t ? a + 1 : a), c = Te(i), u = o ? (i.disabledReason || "Action unavailable").trim() : "", h = u ? `detail-action-reason-${l}` : "", p = h ? `aria-describedby="${h}"` : "", f = u ? `${i.label} unavailable: ${u}` : i.label, y = i.variant === "danger" && a > 0 ? '<div class="my-1 border-t border-gray-100"></div>' : "", g = u ? `title="${d(u)}"` : "", m = o && i.remediation?.href && i.remediation?.label ? `
            <a
...
var Bs = class {
  constructor(e) {
    this.actions = [], this.record = null, this.documentClickHandler = null, this.documentKeydownHandler = null, this.mount = e.mount, this.notifier = e.notifier || Rs(), this.fetchImpl = e.fetchImpl || fetch.bind(globalThis);
  }
  async init() {
  ...
  async refresh() {
    ...
    const n = this.panelName(), s = this.recordID(), i = this.panelBasePath(), a = `${this.apiBasePath()}/panels/${encodeURIComponent(n)}`, o = new URLSearchParams(window.location.search), l = new lt({
      apiEndpoint: a,
      actionBasePath: i,
      panelName: n,
    ...
    this.record = t, this.actions = l.buildRowActions(t, r), this.mount.innerHTML = Is(this.actions), this.mount.setAttribute("aria-busy", "false"), this.attachListeners(s), this.attachDropdownListeners();
  }
      ...
      s && s.addEventListener("click", async (i) => {
        if (i.preventDefault(), !(s.getAttribute("aria-disabled") === "true" || s.dataset.disabled === "true"))
          try {
            ...
            if (!_(a)) {
              const o = M(a), l = o ? I(o, `${t.label} failed`) : a instanceof Error ? a.message : `${t.label} failed`;
  ...
  async handleCreateTranslation(t) {
    ...
    if (!(!r || r.loading || r.created)) {
      ...
      try {
        ...
        const i = await pe(`${this.config.apiEndpoint}/actions/create_translation`, n);
        if (i.success) {
...
function $o(e) {
  ...
  return t.forEach((n) => {
    ...
    const s = zs(n, (i) => e(i, n), { size: n.dataset.size || "default" });
    n.setAttribute("data-quick-filters-init", "true"), r.push(s);
  }), r;
}
function ko(e = {}) {
  const { filters: t = ut, activeKey: r = null, capabilities: n = [], size: s = "default", containerClass: i = "" } = e, a = s === "sm" ? "text-xs" : "text-sm", o = s === "sm" ? "px-2 py-1" : "px-3 py-1.5", l = /* @__PURE__ */ new Map();
  for (const c of n) l.set(c.key, c);
  return `<div class="quick-filters inline-flex items-center gap-1 flex-wrap ${i}">${t.map((c) => {
    const u = l.get(c.key), h = u?.supported !== !1, p = r === c.key, f = u?.disabledReason || "Filter not available", y = `inline-flex items-center gap-1 ${o} ${a} rounded-full font-medium`;
    let g;
...
var ne = "go-admin:translation-panel-expanded", Ns = class {
  constructor(e) {
...
async function Gs(e, t, r = {}) {
  ...
  try {
    ...
    const l = Us(await o.json(), i);
    return Hs(l, s), e.onSuccess && e.onSuccess(l), l;
  } catch (o) {
...
function k(e) {
  return Vs[e.toLowerCase()] || e.toUpperCase();
}
var X = class {
  constructor(e) {
...
function Do(e, t) {
  ...
  return e.querySelectorAll("[data-locale-action]").forEach((n) => {
    ...
    if (!s) return;
    const i = n.getAttribute("data-locale-exists") === "true", a = new X({
      ...t,
      locale: s,
      localeExists: i
    }), o = n.parentElement;
...
function ft(e) {
  const t = e.modifiers.map(Ws), r = Xs(e.key);
...
var mt = class {
  ...
  matchesEvent(e, t) {
    ...
    const s = Z(), i = new Set(e.modifiers), a = i.has("ctrl"), o = i.has("meta"), l = i.has("alt"), c = i.has("shift");
      ...
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            ...
            to view all shortcuts, or use <kbd class="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded text-xs font-mono">${Ys()}+S</kbd> to save.
          </p>
...
function ii(e, t) {
  ...
  return si(n, r), n.bind(), n;
}
function Ho(e, t) {
  const r = ii(e, t);
  return t.hintContainer && ni({
...
var ai = 1500, oi = 2e3, xe = "autosave", O = {
  idle: "",
  saving: "Saving...",
  saved: "Saved",
  error: "Save failed",
  ...
  constructor(e = {}) {
    this.state = "idle", this.conflictInfo = null, this.pendingData = null, this.lastError = null, this.debounceTimer = null, this.savedTimer = null, this.listeners = [], this.isDirty = !1, this.config = {
      ...
      onSave: e.onSave,
      debounceMs: e.debounceMs ?? ai,
      savedDurationMs: e.savedDurationMs ?? oi,
      notifier: e.notifier,
...
var vt = "char-counter", ci = "interpolation-preview", wt = "dir-toggle", xt = [
  {
    pattern: /\{\{(\w+(?:\.\w+)*)\}\}/g,
    name: "Mustache",
    example: "{{name}}"
...
function gi(e) {
  return !e || typeof e != "object" ? null : Zt(e);
}
var St = class {
  constructor(e) {
    this.capabilities = e;
...
var wi = {
  ...
  async loadData() {
    ...
    try {
      ...
      this.data = await vi(n), this.state = this.data.assignments.length === 0 ? "empty" : "loaded", this.error = null;
    } catch (e) {
  ...
  renderDisabled() {
    const e = this.gateResult?.reason || "Access to this feature is not available.", t = this.gateResult ? bi(this.gateResult) : "";
    return `
  ...
  renderAssignmentRow(e) {
    this.config.labels;
    const t = Ci(e.due_state), r = $i(e.priority), n = F(e.queue_state, {
      domain: "queue",
      size: "sm"
    }), s = e.due_date ? Ei(new Date(e.due_date)) : "-";
    return `
      <tr class="assignment-row" data-assignment-id="${b(e.id)}">
        ...
        <td class="priority-cell">
          <span class="priority-indicator ${r}">${d(ki(e.priority))}</span>
        </td>
  ...
  renderPreviewRow(e) {
    ...
    return `
      <tr class="preview-row ${t} ${e.isSelected ? "selected" : ""}" data-index="${e.index}">
        ...
        <td class="status-cell">
          ${n}
          ${e.error ? `<span class="error-message" title="${b(e.error)}">${d(Ti(e.error, 30))}</span>` : ""}
        </td>
...
function ul(e) {
  ...
  return !t || !r ? (console.warn("ExchangeImport: Missing required data attributes"), null) : Mi(e, {
    validateEndpoint: t,
    applyEndpoint: r
  });
}
var Ii = {
  ...
  elapsed: "Elapsed",
  conflicts: "Conflicts"
}, Bi = 2e3, Fi = 300, qi = "async_job_", Ct = class {
  constructor(e = {}) {
    ...
    this.config = {
      storageKeyPrefix: e.storageKeyPrefix || qi,
      pollInterval: e.pollInterval || Bi,
...
export {
  ...
  Os as createStatusLegend,
  Vo as createTranslationAutosave,
  io as createTranslationMatrixRenderer,
  Eo as createTranslationPanel,
  ...
  Ra as encodeExpandedGroupsToken,
  Gs as executeBulkCreateMissing,
  ka as expandAllGroups,
  ...
  pa as getAllReasonCodes,
  hl as getAsyncProgressStyles,
  Jo as getAutosaveIndicatorStyles,
  al as getCapabilityGateStyles,
  ml as getChangedFields,
  tl as getCharCountSeverity,
  Uo as getDefaultShortcutRegistry,
  va as getDisabledReasonDisplay,
  dl as getExchangeImportStyles,
  La as getExpandedGroupIds,
  Zo as getFieldHelperStyles,
  To as getFormLockReason,
  k as getLocaleLabel,
  so as getMissingTranslationsCount,
  Ws as getModifierSymbol,
  Ft as getPersistedExpandState,
  Nt as getPersistedViewMode,
  Ys as getPrimaryModifierLabel,
  Fa as getSeverityCssClass,
  bl as getSideBySideEditorStyles,
  je as getStatusCssClass,
  Ne as getStatusDisplay,
  da as getStatusVocabularyStyles,
  xa as getStatusesForDomain,
  ...
  zi as hasFieldDrift,
  no as hasMissingTranslations,
  Ha as hasTranslationContext,
  Ya as hasTranslationReadiness,
  pl as initAsyncProgress,
  ol as initCapabilityGating,
  ul as initExchangeImport,
  Bo as initFallbackBanner,
  Yo as initFieldHelpers,
  Qo as initFormAutosave,
  Fo as initFormLock,
  Oo as initInlineLocaleChips,
  ii as initKeyboardShortcuts,
  Ho as initKeyboardShortcutsWithDiscovery,
  Do as initLocaleActionChips,
  wo as initPanelDetailActions,
  $o as initQuickFilters,
  gl as initSideBySideEditorFromRecord,
  So as initStatusLegends,
  cl as initTranslatorDashboard,
  Li as initTranslatorDashboardWithOptions,
  Sa as initializeVocabularyFromPayload,
  nl as isCoreEnabled,
  fi as isExchangeEnabled,
  Zi as isExchangeError,
  Po as isFormLocked,
  Ua as isInFallbackMode,
  Z as isMacPlatform,
  _a as isNarrowViewport,
  mi as isQueueEnabled,
  Wa as isReadyForTransition,
  ti as isShortcutHintDismissed,
  ca as isValidReasonCode,
  ha as isValidStatus,
  ei as loadShortcutSettings,
  Gt as mergeBackendSummaries,
  Ca as normalizeActionBlockCode,
  ya as normalizeActionState,
  sa as normalizeActionStateMap,
  $a as normalizeActionStateMeta,
  Pa as normalizeActionStateRecord,
  ...
  ea as parseImportResult,
  Ge as parseViewMode,
  Ta as persistExpandState,
  Ba as persistViewMode,
  Js as removeFormLock,
  Ko as renderAutosaveIndicator,
  nr as renderAvailableLocalesIndicator,
  Lo as renderBulkResultInline,
  Ao as renderBulkResultSummary,
  Wo as renderCharacterCounter,
  Is as renderDetailActions,
  Xo as renderDirectionToggle,
  bi as renderDisabledReasonBadge,
  ni as renderDiscoveryHint,
  Mo as renderFallbackBannerFromRecord,
  ...
  aa as renderGroupedErrorState,
  Ma as renderGroupedLoadingState,
  Qs as renderInlineLocaleChips,
  ht as renderLocaleActionChip,
  Ro as renderLocaleActionList,
  Xe as renderLocaleBadge,
  to as renderLocaleCompleteness,
  ro as renderMissingTranslationsBadge,
  eo as renderPublishReadinessBadge,
  ko as renderQuickFiltersHTML,
  Za as renderReadinessIndicator,
  Vt as renderReasonCodeBadge,
  ua as renderReasonCodeIndicator,
  Go as renderShortcutSettingsUI,
  zo as renderShortcutsHelpContent,
  Xa as renderStatusBadge,
  Co as renderStatusLegendHTML,
  Ja as renderTranslationAssignmentSummary,
  Qa as renderTranslationExchangeSummary,
  Va as renderTranslationFamilyLink,
  Ka as renderTranslationFamilyMemberCount,
  ar as renderTranslationMatrixCell,
  sr as renderTranslationStatusCell,
  F as renderVocabularyStatusBadge,
  Mt as renderVocabularyStatusIcon,
  Ke as resolveActionState,
  No as saveShortcutSettings,
  Io as shouldShowFallbackBanner,
  qo as shouldShowInlineLocaleChips,
  xo as showTranslationBlocker,
  wa as toggleGroupExpand,
