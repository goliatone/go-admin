  ...
  build: {
    ...
    lib: {
      ...
      entry: {
        ...
        'debug/jsonpath-search': resolve(import.meta.dirname, 'src/debug/shared/jsonpath-search.ts'),
        'debug/syntax-highlight': resolve(import.meta.dirname, 'src/debug/syntax-highlight.ts'),
        'debug/toolbar': resolve(import.meta.dirname, 'src/debug/toolbar/index.ts'),
        'debug/toolbar-bootstrap': resolve(import.meta.dirname, 'src/debug/toolbar-bootstrap.ts'),
        'content-type-builder/index': resolve(import.meta.dirname, 'src/content-type-builder/index.ts'),
        'content-type-builder/bootstrap': resolve(import.meta.dirname, 'src/content-type-builder/bootstrap.ts'),
        'content-type-builder/content-editor-runtime': resolve(import.meta.dirname, 'src/content-type-builder/content-editor-runtime.ts'),
        'content-type-builder/block-library-runtime': resolve(import.meta.dirname, 'src/content-type-builder/block-library-runtime.ts'),
