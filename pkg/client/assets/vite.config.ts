  ...
  build: {
    ...
    lib: {
      ...
      entry: {
        ...
        'debug/shared/path-helpers': resolve(__dirname, 'src/debug/shared/path-helpers.ts'),
        ...
        'entry-navigation/index': resolve(__dirname, 'src/entry-navigation/index.ts'),
        ...
        'shared/path-normalization': resolve(__dirname, 'src/shared/path-normalization.ts'),
