...
const EXPECTED_ENTRY_POINTS = [
  ...
  'content-type-builder/index.js',
  'content-type-builder/bootstrap.js',
  'content-type-builder/content-editor-runtime.js',
  'content-type-builder/block-library-runtime.js',
  'dashboard/index.js',
