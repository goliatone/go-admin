...
test('translation-family phase 3: normalizes list payloads and filter query state', () => {
...
test('translation-family phase 3: normalizes detail payloads and renders readiness chips', () => {
  const detail = normalizeFamilyDetail({
    ...
    active_assignments: [
      { id: 'asg-1', family_id: 'tg-page-1', source_locale: 'en', target_locale: 'es', status: 'in_progress' },
    ],
    publish_gate: {
      allowed: false,
...
test('translation-family phase 3: client builds canonical endpoints for list and detail', async () => {
  const requests = [];
