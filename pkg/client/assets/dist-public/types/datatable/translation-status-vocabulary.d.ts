...
import { type ActionBlockCodeInput } from './action-contracts.js';
 ...
 */
export declare function getActionBlockDisplay(input: ActionBlockCodeInput): DisabledReasonDisplayConfig | null;
/**
