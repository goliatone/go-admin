export declare function adoptSemanticPresentation(grid: any): void;
...
export declare function setBulkActionState(grid: any, state: Record<string, any> | null | undefined, config: Record<string, any> | null | undefined): void;
export declare function applyBulkActionState(grid: any, state: Record<string, any> | null | undefined): void;
export declare function syncBulkActionState(grid: any): void;
/**
