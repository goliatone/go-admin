...
export declare function renderTranslationFamilyLink(record: Record<string, unknown>, options?: TranslationSummaryOptions): string;
export declare function renderTranslationFamilyMemberCount(record: Record<string, unknown>, options?: TranslationSummaryOptions): string;
export declare function renderTranslationAssignmentSummary(value: unknown, options?: TranslationSummaryOptions): string;
export declare function renderTranslationExchangeSummary(value: unknown, options?: TranslationSummaryOptions): string;
/**
