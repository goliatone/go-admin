 ...
 */
export declare function buildSearchParams<F extends Record<string, string>>(state: QueryState<F> | Record<string, string | number | null | undefined>, options?: {
    includePage?: boolean;
 ...
 */
export declare function parseSearchParams<F extends Record<string, string>>(params: URLSearchParams, filterFields: (keyof F)[], defaults?: Partial<QueryState<F>>): QueryState<F> | (Record<string, string> & {
    page?: string;
    per_page?: string;
    q?: string;
    search?: string;
