 ...
 */
export declare function createPermissionGuard(permission: PermissionInput, manager?: ServicesPermissionManager): PermissionGuard;
/**
 ...
 */
export declare function combineGuards(...guards: Array<PermissionGuard | PermissionGuard[]>): PermissionGuard;
/**
 * Guard: Can view services (providers, connections, etc.)
 */
export declare function canViewServices(manager?: ServicesPermissionManager): () => boolean;
/**
 * Guard: Can connect new services
 */
export declare function canConnect(manager?: ServicesPermissionManager): () => boolean;
/**
 * Guard: Can edit services (refresh, sync, etc.)
 */
export declare function canEdit(manager?: ServicesPermissionManager): () => boolean;
/**
 * Guard: Can revoke connections
 */
export declare function canRevoke(manager?: ServicesPermissionManager): () => boolean;
/**
 * Guard: Can re-consent connections
 */
export declare function canReconsent(manager?: ServicesPermissionManager): () => boolean;
/**
 * Guard: Can view activity
 */
export declare function canViewActivity(manager?: ServicesPermissionManager): () => boolean;
/**
