...
export declare function renderPanelLoadingState(config?: PanelLoadingStateConfig): string;
export declare function renderPanelState(config?: PanelStateConfig): string;
/**
