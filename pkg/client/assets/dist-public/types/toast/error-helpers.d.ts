...
export declare function executeStructuredRequest(endpoint: string, options: RequestInit, parseSuccess?: (response: Response) => Promise<{
    success: boolean;
    data?: Record<string, unknown>;
    error?: StructuredError;
}>): Promise<StructuredRequestResult>;
export declare function createStructuredActionError(error: StructuredError, fallbackMessage?: string, handled?: boolean): StructuredActionError;
export declare function getStructuredActionError(error: unknown): StructuredError | null;
export declare function isHandledActionError(error: unknown): boolean;
/**
