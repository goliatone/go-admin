...
import { t as A } from "./toast-manager-dTUZQSLs.js";
var w = Object.defineProperty, P = (e, t) => {
  let i = {};
  for (var s in e)
    w(i, s, {
      get: e[s],
  ...
  return t || w(i, Symbol.toStringTag, { value: "Module" }), i;
}, q = /* @__PURE__ */ P({ FilterBuilder: () => R }), C = F("DataGrid"), S = {
...
var R = class {
  constructor(e) {
    ...
    this.config = e, this.mode = e.mode ?? "overlay", this.messages = {
      ...S,
      ...e.messages
    }, this.limits = this.resolveLimits(e.limits), this.chrome = this.resolveChrome(e.chrome), this.actions = this.resolveActions(e.actions), this.instanceID = `filter-builder-${++E}`, this.notifier = e.notifier || new A(), this.structure = e.initialStructure ? this.normalizeStructure(e.initialStructure) : this.createDefaultStructure(), this.init();
  }
  resolveChrome(e) {
  ...
  init() {
    if (this.previewElement = f(this.config.previewElement), this.mode === "compact") {
      ...
      if (this.panel = f(this.config.host) || document.getElementById("filter-panel"), !this.panel) {
        C.error("[FilterBuilder] Panel element not found");
        return;
      }
  ...
  restoreFromURL() {
    ...
    if (e)
      try {
        ...
        C.warn("[FilterBuilder] Failed to parse filters from URL:", t);
      }
  }
...
//# sourceMappingURL=filter-builder-CCvhDgs0.js.map