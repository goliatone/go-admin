...
import { executeActionRequest as L } from "../toast/error-helpers.js";
import { r as $ } from "./modal-B1Um4QMU.js";
var C = m("DataGrid"), S = class y extends $ {
  constructor(e) {
    super({
      size: "lg",
  ...
  async handleCreateTranslation(e) {
    ...
    if (!(!i || i.loading || i.created)) {
      ...
      try {
        ...
        const r = `${this.config.apiEndpoint}/actions/create_translation`, n = await L(r, s);
        if (n.success) {
...
//# sourceMappingURL=translation-panel-2jrAPSuu.js.map