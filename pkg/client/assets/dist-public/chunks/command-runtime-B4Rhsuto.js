...
import { httpRequestWith as g, readHTTPJSONValue as k } from "../shared/transport/http-client.js";
import { extractStructuredError as A, formatStructuredErrorForDisplay as T, parseActionResponse as B } from "../toast/error-helpers.js";
import { t as x } from "./toast-manager-dTUZQSLs.js";
var l = "true", p = /* @__PURE__ */ new WeakMap();
function L(t) {
...
function M(t, e = {}) {
  ...
  t.setAttribute("aria-busy", l), t.dataset.busy = l, (e.compatibilitySubmitLoading || t.hasAttribute("data-submit-loading-form")) && (t.dataset.loading = l, t.dataset.submitLoadingActive = l), b(t) && J(t, P(e.submitter), a);
  const i = V(t, e);
  for (const r of i)
    q(r, a), $(r, e, a);
...
function R(t) {
  ...
  e.overrides && b(t) && z(t, e.overrides), p.delete(t);
}
function E(t) {
  return {
    root: t.root,
...
function V(t, e) {
  ...
  if (h(e.submitter) && !n.includes(e.submitter) && n.push(e.submitter), h(t) && !n.includes(t) && n.push(t), e.includeDescendantControls !== !1) {
    ...
    t.querySelectorAll(a).forEach((i) => {
      (b(t) ? _(i) : h(i)) && !n.includes(i) && n.push(i);
    });
  }
  return n;
}
...
function y(t, e, n, a, i = null) {
  ...
  return r.type = "hidden", r.name = n, r.value = a, r.dataset.busyGenerated = l, r.dataset.submitLoadingGenerated = l, i && i.parentNode === e ? i.after(r) : e.appendChild(r), t.generatedInputs.push(r), r;
}
function J(t, e, n) {
  if (!e || !j(e) || e.disabled) return;
  const a = {
...
var K = F("CommandRuntime");
function Q() {
  const t = globalThis.window;
  return t?.toastManager ? t.toastManager : new x();
}
function d(t) {
...
function v(t) {
  ...
  const n = d(t.dataset.commandBusyClosest);
...
function rt(t) {
  ...
  return t.querySelectorAll(".collapsible-trigger[aria-controls]").forEach((n) => {
    const a = d(n.getAttribute("aria-controls") || void 0);
...
var ut = class {
  constructor(t) {
    this.submitHandler = null, this.clickHandler = null, this.feedbackUnsubscribe = null, this.pendingFeedback = /* @__PURE__ */ new Map(), this.inlineStatus = /* @__PURE__ */ new Map(), this.inlineStatusListeners = /* @__PURE__ */ new Set(), this.mount = t.mount, this.apiBasePath = String(t.apiBasePath || "").trim().replace(/\/$/, ""), this.panelName = String(t.panelName || "").trim(), this.recordId = String(t.recordId || "").trim(), this.rpcEndpoint = String(t.rpcEndpoint || "").trim() || `${this.apiBasePath}/rpc`, this.tenantId = String(t.tenantId || "").trim(), this.orgId = String(t.orgId || "").trim(), this.notifier = t.notifier || Q(), this.fetchImpl = t.fetchImpl || fetch.bind(globalThis), this.defaultRefreshSelectors = Array.isArray(t.defaultRefreshSelectors) ? t.defaultRefreshSelectors.filter(Boolean) : [], this.feedback = t.feedback, this.onBeforeDispatch = t.onBeforeDispatch, this.onAfterDispatch = t.onAfterDispatch, this.onAfterRefresh = t.onAfterRefresh;
  }
  init() {
  ...
  emitInlineStatusChange(t) {
    this.inlineStatusListeners.forEach((e) => {
      try {
        ...
        K.warn("Inline status listener error:", n);
      }
    });
  }
  ...
  buildSpec(t, e, n) {
    const a = d(t.dataset.commandName || e?.dataset.commandName), i = d(t.dataset.commandTransport || e?.dataset.commandTransport) || "action", r = d(t.dataset.commandDispatch || e?.dataset.commandDispatch) || a, u = nt(e), s = N(t), o = e ? N(e) : {}, c = {
      ...this.scopePayload(),
      ...u,
      ...o,
      ...s
    }, D = C(t.dataset.commandRefresh || e?.dataset.commandRefresh || "").length > 0 ? C(t.dataset.commandRefresh || e?.dataset.commandRefresh || "") : this.defaultRefreshSelectors;
    return {
      trigger: t,
      form: e,
      commandName: a,
      ...
      transport: i,
      payload: c,
      successMessage: d(t.dataset.commandSuccess || e?.dataset.commandSuccess) || `${a} completed successfully`,
      fallbackMessage: d(t.dataset.commandFailure || e?.dataset.commandFailure) || `${a} failed`,
      refreshSelectors: D,
...
Enter a reason:`, o = globalThis.window?.prompt(s, "") ?? null;
    ...
    const n = tt(t.payload), a = this.resolveSection(t.trigger), i = this.resolveParticipantId(t.trigger, t.payload), r = {
      trigger: t.trigger,
      form: t.form,
      commandName: t.commandName,
      transport: t.transport,
  ...
  replaceFragment(t, e) {
    ...
    if (!n || !a) return;
    const i = rt(n), r = document.importNode(a, !0);
    n.replaceWith(r), r instanceof Element && st(r, i);
  }
};
function ft(t) {
...
//# sourceMappingURL=command-runtime-B4Rhsuto.js.map