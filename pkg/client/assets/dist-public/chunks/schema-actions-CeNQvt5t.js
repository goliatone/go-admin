...
import { createStructuredActionError as x, executeActionRequest as v, extractTranslationBlocker as _, formatStructuredErrorForDisplay as S, isTranslationBlocker as C } from "../toast/error-helpers.js";
import { t as D } from "./modal-nXs4C8ko.js";
import { I as L, R as O, d as P, t as R } from "./action-execution-DXtVRyWi.js";
var y = A("DataGrid");
function $(e) {
...
var b = {
  ...
  buildNavigationAction(e, t, n, i, o, r) {
    ...
    } else t.name === "edit" ? c = g(a, s, "edit", r) : c = g(a, s, "", r);
    return {
      id: t.name,
      label: n,
  ...
  buildPostAction(e, t, n, i, o) {
    ...
    return {
      ...
      variant: i,
      action: async () => {
        if (t.confirm && !await D.confirm(t.confirm, {
          title: `Confirm ${n}`,
          confirmText: n,
  ...
  async executePostAction(e) {
    const t = await v(e.endpoint, e.payload);
    if (t.success)
  ...
  handleActionRedirectSuccess(e) {
    ...
    if (!n) return !1;
    const i = e.redirect_to_edit === !0 || e.mode === "redirect", o = this.buildQueryContext(), r = g(this.config.actionBasePath, n, i ? "edit" : "", o);
  ...
  async handleStructuredActionFailure(e, t, n) {
    ...
    throw o.textCode && this.config.reconcileOnDomainFailure && await this.config.reconcileOnDomainFailure(e, o), this.config.onActionError?.(e, o), x(o, n, !!this.config.onActionError);
  }
  ...
  deriveCreateTranslationLocaleOptions(e, t, n, i, o) {
    ...
    const l = this.extractStringField(s, "recommended_locale") || this.extractStringField(n, "recommended_locale") || this.extractStringField(r || {}, "recommended_locale"), u = this.asStringArray(s.required_for_publish ?? n.required_for_publish ?? r?.required_for_publish ?? r?.required_locales), d = this.asStringArray(s.existing_locales ?? n.existing_locales ?? r?.available_locales), h = this.createTranslationLocaleLabelMap(i), m = this.buildCreateTranslationLocaleOptions(a, l, u, d, h);
    return m.sort((f, p) => f.recommended && !p.recommended ? -1 : !f.recommended && p.recommended ? 1 : f.value.localeCompare(p.value)), m.length > 0 ? m : void 0;
  }
  ...
  buildCreateTranslationLocaleOptions(e, t, n, i, o) {
    ...
    for (const a of e) {
      ...
      const h = d.length > 0 ? d.join(" • ") : void 0, m = o[c] || this.localeLabel(c);
      let f = `${c.toUpperCase()} - ${m}`;
    ...
    const i = String(t.id || ""), o = this.config.actionBasePath, r = [
      ...
      },
      {
        ...
        button: {
          ...
          variant: "primary",
          action: () => {
            window.location.href = g(o, i, "edit", n);
          }
        }
      },
      {
    ...
    const o = String(t.id || ""), r = this.config.actionBasePath, s = [
      ...
      },
      {
        ...
        button: {
          ...
          variant: "primary",
          action: () => {
            window.location.href = g(r, o, "edit", n);
          }
        }
      },
      {
...
//# sourceMappingURL=schema-actions-CeNQvt5t.js.map