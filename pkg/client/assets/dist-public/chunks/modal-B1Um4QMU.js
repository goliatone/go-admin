...
function u(e) {
  return !(!e.isConnected || x(e) || e.matches(":disabled"));
}
function m(e) {
  return Array.from(e.querySelectorAll(y)).filter((t) => t.tabIndex >= 0 && u(t));
}
function v(e, t) {
  if (!t) return null;
...
var C = class {
  ...
  register(e) {
    const t = e.zIndexTarget ?? e.container, i = {
      ...
      zIndex: _ + ++this.nextLayerIndex * k,
      closing: !1,
      released: !1,
  ...
  async show() {
    ...
    try {
      ...
      this.container = n, n.className = [
        ...
        o,
        c
      ].filter(Boolean).join(" "), n.setAttribute("data-go-admin-modal", "true"), n.setAttribute("data-size", r), n.setAttribute("role", "dialog"), n.setAttribute("aria-modal", "true"), this._layer = w({
        container: n,
        zIndexTarget: i,
  ...
  _applyAccessibleName() {
    if (this.container) {
      if (this.container.removeAttribute("aria-label"), this.container.removeAttribute("aria-labelledby"), this.container.removeAttribute("aria-describedby"), this._options.labelledBy) this.container.setAttribute("aria-labelledby", this._options.labelledBy);
        ...
        e ? (e.id || (e.id = `go-admin-modal-title-${++A}`), this.container.setAttribute("aria-labelledby", e.id)) : (this.container.setAttribute("aria-label", "Dialog"), L.warn("Modal opened without labelledBy, ariaLabel, or heading; using fallback accessible name."));
      }
...
}, T = "w-full border rounded-lg bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:border-gray-600 dark:bg-slate-800 dark:text-white dark:placeholder-gray-500 px-3 py-2 text-sm border-gray-300", E = 0, B = class extends p {
  constructor(e) {
    super({
      size: "sm",
...
//# sourceMappingURL=modal-B1Um4QMU.js.map