...
var h = {
  ...
  async show() {
    ...
    const e = h[this._options.size] ?? h.lg, s = this._options.flexColumn ? "flex flex-col" : "", a = this._options.containerClass;
...
}, x = "w-full border rounded-lg bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:border-gray-600 dark:bg-slate-800 dark:text-white dark:placeholder-gray-500 px-3 py-2 text-sm border-gray-300", k = class extends u {
  constructor(t) {
    super({
      size: "sm",
  ...
  renderContent() {
    const t = this.config.inputClass ?? x;
    return `
      <div class="p-5">
  ...
  bindContentEvents() {
    const t = this.container?.querySelector("[data-prompt-input]"), e = this.container?.querySelector("[data-prompt-error]"), s = this.container?.querySelector("[data-prompt-confirm]"), a = this.container?.querySelector("[data-prompt-cancel]"), c = (r) => {
      ...
      const n = await this.config.onConfirm(r), d = n === !1 ? "Value is invalid." : typeof n == "string" ? n : n && typeof n == "object" && typeof n.error == "string" ? n.error : "";
      if (d) {
        c(d), t?.focus();
        return;
      }
...
//# sourceMappingURL=toast-manager-CZnLPlYg.js.map