...
import { t as D } from "./toast-manager-dTUZQSLs.js";
import { P as k } from "./action-execution-Bn3QEHJ3.js";
import { t as H } from "./schema-actions-B4T0mJiP.js";
function S() {
      ...
      l && l.addEventListener("click", async (a) => {
        if (a.preventDefault(), !(l.getAttribute("aria-disabled") === "true" || l.dataset.disabled === "true"))
          try {
            ...
            if (!L(o)) {
              const c = A(o), s = c ? y(c, `${t.label} failed`) : o instanceof Error ? o.message : `${t.label} failed`;
...
//# sourceMappingURL=detail-actions-TJCOZYoE.js.map