// @ts-ignore The upstream sibling package ships JS that Vite can bundle, but TypeScript
// declaration emit does not resolve its ambient types outside this source root.
import upstreamCreateSSEClient from '../../../../../../go-router/sseclient/dist/client.mjs';
...
export interface ClientOptions {
  ...
  onHeartbeat?: (event: { timestamp: string; scope_key?: string }) => void;
...
const createSSEClient = upstreamCreateSSEClient as (options: ClientOptions) => SSEClient;
