...
type TranslationExchangeUIConfig = admin.TranslationExchangeUIConfig

// TranslationExchangeLocaleOption describes a selectable locale.
type TranslationExchangeLocaleOption = admin.TranslationExchangeLocaleOption

// TranslationExchangeResourceOption describes a selectable exchange resource.
type TranslationExchangeResourceOption = admin.TranslationExchangeResourceOption

// TranslationExchangeTemplateOption configures the template download affordance.
type TranslationExchangeTemplateOption = admin.TranslationExchangeTemplateOption

// TranslationExchangeApplyDefaults configures import/apply wizard option defaults.
type TranslationExchangeApplyDefaults = admin.TranslationExchangeApplyDefaults
