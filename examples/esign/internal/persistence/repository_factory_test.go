...
func TestNewRepositoryFactoryFromDBInitializesAggregateRepositories(t *testing.T) {
	...
	repositories := map[string]any{
		...
		"draft_audit_events":          factory.DraftAuditEvents(),
		...
		"agreement_reminder_states":   factory.AgreementReminderStates(),
	...
	tableAssertions := []struct {
		...
		{name: "draft_audit_events", table: "draft_audit_events", provider: factory.DraftAuditEvents()},
		...
		{name: "agreement_reminder_states", table: "agreement_reminder_states", provider: factory.AgreementReminderStates()},
