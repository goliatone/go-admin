...
func (*ReviewSessionTokenRecord) TableName() string {
	return "review_session_tokens"
}

func (*PublicSignerSessionTokenRecord) TableName() string {
	return "public_signer_session_tokens"
}
