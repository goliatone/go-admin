ALTER TABLE agreement_review_participants ADD COLUMN participant_type TEXT NOT NULL DEFAULT 'recipient';
ALTER TABLE agreement_review_participants ADD COLUMN email TEXT NOT NULL DEFAULT '';
ALTER TABLE agreement_review_participants ADD COLUMN display_name TEXT NOT NULL DEFAULT '';
...
CREATE TABLE review_session_tokens (
    id TEXT PRIMARY KEY,
...
CREATE INDEX idx_review_session_tokens_scope_participant
