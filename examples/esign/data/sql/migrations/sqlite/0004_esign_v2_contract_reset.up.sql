CREATE TABLE participants (
    ...
    CONSTRAINT uq_participants_scope_id UNIQUE (tenant_id, org_id, id),
...
CREATE TABLE field_definitions (
    ...
    created_at TIMESTAMP NOT NULL,
    updated_at TIMESTAMP NOT NULL,
    CONSTRAINT uq_field_definitions_scope_id UNIQUE (tenant_id, org_id, id),
...
CREATE TABLE field_instances (
    ...
    created_at TIMESTAMP NOT NULL,
    updated_at TIMESTAMP NOT NULL,
    CONSTRAINT uq_field_instances_scope_id UNIQUE (tenant_id, org_id, id),
...
SELECT
    ...
    f.field_type,
    CASE
        WHEN COALESCE(f.required, 0) <> 0 THEN TRUE
        ELSE FALSE
    END,
    '',
    f.created_at,
