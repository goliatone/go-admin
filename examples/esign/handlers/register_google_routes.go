...
func registerGoogleOAuthRoutes(adminRoutes routeRegistrar, routes RouteSet, cfg registerConfig) {
	registerGoogleOAuthMutationRoutes(adminRoutes, routes, cfg)
	registerGoogleOAuthReadRoutes(adminRoutes, routes, cfg)
}

func registerGoogleOAuthMutationRoutes(adminRoutes routeRegistrar, routes RouteSet, cfg registerConfig) {
...
func registerGoogleOAuthReadRoutes(adminRoutes routeRegistrar, routes RouteSet, cfg registerConfig) {
...
func registerGoogleImportRoutes(adminRoutes routeRegistrar, routes RouteSet, cfg registerConfig) {
	registerGoogleImportMutationRoutes(adminRoutes, routes, cfg)
	registerGoogleImportReadRoutes(adminRoutes, routes, cfg)
}

func registerGoogleImportMutationRoutes(adminRoutes routeRegistrar, routes RouteSet, cfg registerConfig) {
	registerGoogleDriveImportsCreateRoute(adminRoutes, routes, cfg)
	registerGoogleDriveImportLegacyRoute(adminRoutes, routes, cfg)
}

func registerGoogleDriveImportsCreateRoute(adminRoutes routeRegistrar, routes RouteSet, cfg registerConfig) {
...
func registerGoogleDriveImportLegacyRoute(adminRoutes routeRegistrar, routes RouteSet, cfg registerConfig) {
	adminRoutes.Post(routes.AdminGoogleDriveImport, func(c router.Context) error {
		...
		respErr := c.JSON(http.StatusOK, googleImportLegacyResponse(imported))
...
func googleImportLegacyResponse(imported services.GoogleImportResult) map[string]any {
	return map[string]any{
		"status":               "imported",
		"document":             googleImportLegacyDocumentPayload(imported),
		"agreement":            googleImportLegacyAgreementPayload(imported),
...
func googleImportLegacyDocumentPayload(imported services.GoogleImportResult) map[string]any {
	return map[string]any{
...
func googleImportLegacyAgreementPayload(imported services.GoogleImportResult) map[string]any {
	return map[string]any{
...
func registerGoogleImportReadRoutes(adminRoutes routeRegistrar, routes RouteSet, cfg registerConfig) {
	registerGoogleDriveImportRunRoute(adminRoutes, routes, cfg)
	registerGoogleDriveImportsListRoute(adminRoutes, routes, cfg)
}

func registerGoogleDriveImportRunRoute(adminRoutes routeRegistrar, routes RouteSet, cfg registerConfig) {
...
func registerGoogleDriveImportsListRoute(adminRoutes routeRegistrar, routes RouteSet, cfg registerConfig) {
