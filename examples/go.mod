...
require (
	...
	github.com/goliatone/go-admin v0.125.0
	github.com/goliatone/go-admin/quickstart v0.125.0
...
// Examples are a repository-local development module, not a published module.
