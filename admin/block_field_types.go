...
func defaultFieldTypeDefinitions() []FieldTypeDefinition {
	return []FieldTypeDefinition{
		...
		{Type: "media-picker", Label: "Media", Description: "Single media asset picker", Category: "media", Icon: "media-picker", Defaults: map[string]any{"config": map[string]any{"valueMode": "url"}}, Order: 10},
		{Type: "media-gallery", Label: "Media Gallery", Description: "Multiple media assets", Category: "media", Icon: "media-gallery", Defaults: map[string]any{"config": map[string]any{"multiple": true, "valueMode": "url"}}, Order: 20},
		{Type: "file-upload", Label: "File Upload", Description: "Direct file upload field", Category: "media", Icon: "file-upload", Order: 30},
