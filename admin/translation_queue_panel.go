...
func translationAssignmentFromMap(record map[string]any) TranslationAssignment {
	...
	return TranslationAssignment{
		...
		TenantID:            strings.TrimSpace(toString(record[ScopeTenantIDKey])),
		OrgID:               strings.TrimSpace(toString(record[ScopeOrgIDKey])),
		...
		WorkScope:           strings.TrimSpace(toString(record["work_scope"])),
		...
		ReviewerID:          strings.TrimSpace(toString(record["reviewer_id"])),
