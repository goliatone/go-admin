...
func debugPermissionSnapshot(cfg Config) map[string]any {
	...
	debugSetPermission(out, "notifications_inspect", cfg.NotificationsInspectPermission)
	debugSetPermission(out, "notifications_receipts", cfg.NotificationsReceiptPermission)
	debugSetPermission(out, "notifications_retention_purge", cfg.NotificationsRetentionPurgePermission)
