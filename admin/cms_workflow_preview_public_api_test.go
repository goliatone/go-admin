...
func TestCMSWorkflowPreviewAndPublicAPIIntegration(t *testing.T) {
	...
	createReq := httptest.NewRequestWithContext(context.Background(), http.MethodPost, createPath, strings.NewReader(pageBody))
	...
	updateReq := httptest.NewRequestWithContext(context.Background(), http.MethodPut, updatePath, strings.NewReader(updateBody))
	...
	publicReq := httptest.NewRequestWithContext(context.Background(), http.MethodGet, publicPath, nil)
	...
	previewReq := httptest.NewRequestWithContext(context.Background(), http.MethodGet, previewPath, nil)
	...
	adminPreviewReq := httptest.NewRequestWithContext(context.Background(), http.MethodGet, adminPreviewPath, nil)
	...
	publicPreviewReq := httptest.NewRequestWithContext(context.Background(), http.MethodGet, publicPreviewPath, nil)
	...
	workflowReq := httptest.NewRequestWithContext(context.Background(), http.MethodPost, workflowPath, strings.NewReader(`{"id":"`+pageID+`"}`))
	...
	publishReq := httptest.NewRequestWithContext(context.Background(), http.MethodPost, publishPath, strings.NewReader(`{"id":"`+pageID+`"}`))
...
func fetchContentStatus(t *testing.T, server router.Server[*httprouter.Router], urls urlkit.Resolver, adminAPIGroup, panel, id string) string {
	...
	getReq := httptest.NewRequestWithContext(context.Background(), http.MethodGet, getPath, nil)
