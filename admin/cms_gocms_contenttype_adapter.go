...
func (a *GoCMSContentTypeAdapter) ContentTypes(ctx context.Context) ([]CMSContentType, error) {
	...
	for _, item := range items {
		...
		cmsadapter.SetContentTypeChannel(&converted, cmsadapter.ResolveContentTypeChannel(converted, channel))
...
func (a *GoCMSContentTypeAdapter) ContentType(ctx context.Context, id string) (*CMSContentType, error) {
	...
	cmsadapter.SetContentTypeChannel(&converted, cmsadapter.ResolveContentTypeChannel(converted, cmsContentChannelFromContext(ctx, "")))
...
func (a *GoCMSContentTypeAdapter) contentTypeByPanelSlug(ctx context.Context, slug string) (*CMSContentType, error) {
	...
	for _, ct := range types {
		panelSlug := capabilityString(ct.Capabilities, ContentTypeCapabilityKeyPanelSlug)
