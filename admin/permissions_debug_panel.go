...
func (p *PermissionsDebugPanel) collectRequiredPermissions() map[string]string {
	...
	configPerms := []struct {
		...
		{cfg.NotificationsInspectPermission, "notifications"},
		{cfg.NotificationsReceiptPermission, "notifications"},
		{cfg.NotificationsRetentionPurgePermission, "notifications"},
