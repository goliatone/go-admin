...
func TranslationDashboardQueryModels() map[string]any {
	return map[string]any{
		translationDashboardTableTopOverdueAssignments: map[string]any{
			...
			"supported_filters": []string{ScopeTenantIDKey, ScopeOrgIDKey, "status", "overdue", "assignee_id", "reviewer_id", "family_id"},
		...
		translationDashboardTableBlockedFamilies: map[string]any{
			...
			"drilldown_route":   "translations.families",
			...
			"resolver_keys":     []string{"admin.translations.families", "admin.translations.families.id", "admin.api.translations.families"},
			"supported_filters": []string{ScopeTenantIDKey, ScopeOrgIDKey, "family_id", "readiness_state", "blocker_code", "missing_locale"},
...
func translationDashboardRunbookCatalog() []map[string]any {
	return []map[string]any{
		...
		},
		{
			...
			"group":        "admin",
			"route":        "translations.families",
			"resolver_key": "admin.translations.families",
			"query": map[string]any{
