...
func dashboardDiagnosticsPayload(report DashboardDiagnosticsReport) map[string]any {
	payload := map[string]any{
		...
		"providers":          report.Catalog.Providers,
		"definitions":        report.Catalog.Definitions,
		"provider_count":     report.Providers,
		"definition_count":   report.Definitions,
		"instance_count":     report.Instances,
