...
- Routing ownership is now clean-break and explicit:
  - Mounted modules must implement `admin.RouteContractProvider`; inferred module routing is no longer supported.
  - Startup routing validation is strict fail-fast in every environment.
  - Module public API exposure is opt-in through `routing.ModuleContract.PublicAPIRoutes`; modules do not receive a public surface by default.
...
- Published the canonical routing contract in `GUIDE_ROUTING.md`, including external-module rules, release-policy decisions, and manifest-diff review guidance.
- Updated routing operator docs to point to `admin/routing`, `RoutingReport()`, and routing manifests as the canonical diagnostics surfaces.
...
- Merge panel action context ([1c4ed86](https://github.com/goliatone/go-admin/commit/1c4ed8650d06506c881758bc00d5e9b2097e4480))  - (goliatone)
- Env management in cms blocks ([05b35d5](https://github.com/goliatone/go-admin/commit/05b35d5c06ba1e86ce0cf6f51b7cdea8f5c2af05))  - (goliatone)
- Compact perms in session ([9f9c311](https://github.com/goliatone/go-admin/commit/9f9c31156a414899889a0dbe72ab3663854c4428))  - (goliatone)
- Render routes using serializer ([7c9f83c](https://github.com/goliatone/go-admin/commit/7c9f83c4313d715209e6e4ecd3ae1b65cacbbe41))  - (goliatone)
- Render debug module using template view ([a9bdda4](https://github.com/goliatone/go-admin/commit/a9bdda4d7ceb134e372ede469e9df54677fd1ce1))  - (goliatone)
- Perms cache to prevent query amplification ([ee3131b](https://github.com/goliatone/go-admin/commit/ee3131b22fc1ad61696be9a394339a998c8b1886))  - (goliatone)
- Error messages ([f224673](https://github.com/goliatone/go-admin/commit/f22467329872d9d13c3d0c86f4506af68b876edc))  - (goliatone)
- Auth session setup to preven max length header error ([56fe93a](https://github.com/goliatone/go-admin/commit/56fe93a903401f47c8acb0aa4cf3cd20d48e21bc))  - (goliatone)
- Update how we loop and find block items ([c288e53](https://github.com/goliatone/go-admin/commit/c288e53ea80456522a617c918817e3901f0731bb))  - (goliatone)
- Explicit error ahndler and rendering ([7638a89](https://github.com/goliatone/go-admin/commit/7638a89dee01b7adf9ed9b6619272776c976483e))  - (goliatone)
- Environment handling in selector ([a4b2127](https://github.com/goliatone/go-admin/commit/a4b212791c1e4f364565e2005e1daa088fd69117))  - (goliatone)
- Settings menu item registration ([be700d7](https://github.com/goliatone/go-admin/commit/be700d73b1e49dbc22cb0dd6ae72a71e11e7f06e))  - (goliatone)
- Translation readiness ([bf320a0](https://github.com/goliatone/go-admin/commit/bf320a0b5c485fd6591764326d0e812d6af298ad))  - (goliatone)
- Translation wiring ([3324067](https://github.com/goliatone/go-admin/commit/33240673bbcf05fafe2fa5e51a16652c14676c12))  - (goliatone)
- Gate errors ([a441197](https://github.com/goliatone/go-admin/commit/a441197d7d9adee52768c0d7786afbe850a547b4))  - (goliatone)
- Sync translation queue for panel ([add1247](https://github.com/goliatone/go-admin/commit/add124700e9313cd29709339b5a2a048bfe81f4d))  - (goliatone)
- Aling UI routes with capabilities and falgs ([b2cf83c](https://github.com/goliatone/go-admin/commit/b2cf83c9fd667d75075eeb10e46648528ba20313))  - (goliatone)
- Boot bindings for translations ([f733da9](https://github.com/goliatone/go-admin/commit/f733da9b00d936e0a7a084bd4b00ddda3914a7d4))  - (goliatone)
- Translation UI wiring ([a564d04](https://github.com/goliatone/go-admin/commit/a564d046b1b5d1968c62318450b647304fa2416d))  - (goliatone)
- Include req context in ui feature context ([a1ba45d](https://github.com/goliatone/go-admin/commit/a1ba45d4c371a2abc9e3692dfb77b5bd859d2dc9))  - (goliatone)
- Translation capabilities wiring ([a40595a](https://github.com/goliatone/go-admin/commit/a40595a589cf54d63868ca9992bccc7d0e3c1b72))  - (goliatone)
- Translation ui ([b1dd81c](https://github.com/goliatone/go-admin/commit/b1dd81c7a29bad3926cbbf0bcd93c27c43e729b4))  - (goliatone)
- Datatable translation integration ([653b2d9](https://github.com/goliatone/go-admin/commit/653b2d99fc90b2329f5625c845cf1bfa0b0a0b1b))  - (goliatone)
- Disable tpl debug by default ([dc3f615](https://github.com/goliatone/go-admin/commit/dc3f6156d2a84c8c8a83372abb5e18d26f9caa72))  - (goliatone)
- Coordinate system for preview ([27bed72](https://github.com/goliatone/go-admin/commit/27bed72654462bdb2d869b693808754a613e0e79))  - (goliatone)
- Parsing for content ([706462f](https://github.com/goliatone/go-admin/commit/706462f17e63c2013d4020e28b922b910a5af977))  - (goliatone)
- Menu item prevent double parent ([62fb750](https://github.com/goliatone/go-admin/commit/62fb75003b1fddd3234c77835d565004e48e1541))  - (goliatone)
- Update cms adapter ([f48ff2f](https://github.com/goliatone/go-admin/commit/f48ff2f2b23269a7f6a5b3caf5d5269870d992a1))  - (goliatone)
- Persistence CMS error ([f739e44](https://github.com/goliatone/go-admin/commit/f739e4441b1d834a56f52a4eb25383e9e452ad9f))  - (goliatone)
- Add default content parent perms ([a5c760f](https://github.com/goliatone/go-admin/commit/a5c760f33c6f33aabf5fab22cab490896afa74a3))  - (goliatone)
- Include ui feature context ([d693eef](https://github.com/goliatone/go-admin/commit/d693eef3882db12a2727a4748abb64483ea6db79))  - (goliatone)
- Check for bulk user import before binding ([cf2bce6](https://github.com/goliatone/go-admin/commit/cf2bce6e3f8c43f632b28f115492fefa08d6e238))  - (goliatone)
- Content type builder include env in routes ([4291a71](https://github.com/goliatone/go-admin/commit/4291a714db4549c08b5f16f1a43558b49097130b))  - (goliatone)
- Agreemtn ([666a996](https://github.com/goliatone/go-admin/commit/666a996930b58fdd3c5a310741200ed7e3bb59ff))  - (goliatone)
- Content type routes ([b062227](https://github.com/goliatone/go-admin/commit/b0622270715f68f11a797746430b60ebaae8849a))  - (goliatone)
- Biuld seed menu ([a202d30](https://github.com/goliatone/go-admin/commit/a202d30105e7480dc95867d314e6d5ab93ed7480))  - (goliatone)
- Include asset_base_path to view context ([bc97c4e](https://github.com/goliatone/go-admin/commit/bc97c4e291600d1a449b78fa1181766ab6d1f545))  - (goliatone)
- Check for command bus enabled ([73bef44](https://github.com/goliatone/go-admin/commit/73bef44cd1abb45ebebad7607c9d65dd209b478c))  - (goliatone)
- Implement route shadowing guard for dev ([e97105b](https://github.com/goliatone/go-admin/commit/e97105b3f854a09f6e6695b9b540e01620c55198))  - (goliatone)
- Quickstart error fiber handler ([4886c3e](https://github.com/goliatone/go-admin/commit/4886c3e3f46d3e9795c278f54cd251e56a893e55))  - (goliatone)
- Remove unused code ([e80e1cb](https://github.com/goliatone/go-admin/commit/e80e1cbab2ee506af92e13a1028c28bba921464b))  - (goliatone)
- Use asset base path ([15449ce](https://github.com/goliatone/go-admin/commit/15449cea8508c3938bc8245de2adf8320363db04))  - (goliatone)
- Include and wire activity and preview features ([23f65db](https://github.com/goliatone/go-admin/commit/23f65db420b4360216b018e1afa86a8e3cb86a48))  - (goliatone)
- Better error codes ([e27a49a](https://github.com/goliatone/go-admin/commit/e27a49a415f210adb26f092a04edfa1216ae0085))  - (goliatone)
- Prevent empty session info by adding fallback handler ([a1c6a0a](https://github.com/goliatone/go-admin/commit/a1c6a0abd0f1ad49b76cd40d1525783d8c1d3ac5))  - (goliatone)
- Support canonical top fields ([69cd0ad](https://github.com/goliatone/go-admin/commit/69cd0ad3fdf30f4a2fa1cab7dbfbfc94f521454c))  - (goliatone)
- Content route check for templates before click ([9773a88](https://github.com/goliatone/go-admin/commit/9773a88d6d56ee8383820be5b025f891cefdcf86))  - (goliatone)
- Remove merge fields from repo ([0f27944](https://github.com/goliatone/go-admin/commit/0f2794415952b59ad903f1672ce22accc7bd542c))  - (goliatone)
- Handle fiber error and provide proper error code ([c1a7446](https://github.com/goliatone/go-admin/commit/c1a7446ce61436ed0093517b4cac650c2a212adb))  - (goliatone)
- Boot transition workflow handler ([3888a75](https://github.com/goliatone/go-admin/commit/3888a757cececa7833e79fe68f0365df5037e57f))  - (goliatone)
- Clean up ([ba79953](https://github.com/goliatone/go-admin/commit/ba799531bb44c0e34c8a1015f62d41f5387b3d89))  - (goliatone)
- Content filtering wiring ([5e6277a](https://github.com/goliatone/go-admin/commit/5e6277a7ad7307d8a98a2dd9fbdab988d56a4ad0))  - (goliatone)
- Get user id from actor in preferences ([1c794bf](https://github.com/goliatone/go-admin/commit/1c794bfef6712793d90c897a30b117cb094eb147))  - (goliatone)
- Role handling in user record ([a684d3d](https://github.com/goliatone/go-admin/commit/a684d3da1962fdb1e1015265afd04464b34cc362))  - (goliatone)
- Include payload, errors and other meta in bulk action ([9b805ad](https://github.com/goliatone/go-admin/commit/9b805ad09809e5902d3e401b78d166e7d2cea7cc))  - (goliatone)

## <!-- 13 -->📦 Bumps

- Bump version: v0.25.0 ([72a45e3](https://github.com/goliatone/go-admin/commit/72a45e311ff2e0b7410610536eef69f686d9c60b))  - (goliatone)

## <!-- 16 -->➕ Add

- Content list include translation setup ([71eeea1](https://github.com/goliatone/go-admin/commit/71eeea1daf6f959fa0d6106c111bbe25108b7d03))  - (goliatone)
- User roles ([ffb92ef](https://github.com/goliatone/go-admin/commit/ffb92ef027ae336537f2eee01c9279c58cd62d1b))  - (goliatone)
- Payload for matrix setup ([8946963](https://github.com/goliatone/go-admin/commit/8946963b46a862b74e4a6dbed387aa5bb0902737))  - (goliatone)
- Udpated routes ([eb0249a](https://github.com/goliatone/go-admin/commit/eb0249ac052c80667be59d5083530aab39e68404))  - (goliatone)
- Permission matrix form gen component ([b185707](https://github.com/goliatone/go-admin/commit/b185707f2733928c9685de35974cde45f7e50207))  - (goliatone)
- Translation binding queue ([830e164](https://github.com/goliatone/go-admin/commit/830e1649004d74accff86a3286b148e49d30464c))  - (goliatone)
- Translation queue updates ([62b093d](https://github.com/goliatone/go-admin/commit/62b093d55cf3fa421fd66453e28e25bfdc9691cc))  - (goliatone)
- Formgen updates for translation and content ([81e92e2](https://github.com/goliatone/go-admin/commit/81e92e2874d340570817a05060fb6789e2767c9a))  - (goliatone)
- Internal widget codes ([b41d603](https://github.com/goliatone/go-admin/commit/b41d60398171aaa7c9815f0b5c7f1dd8b5452dec))  - (goliatone)
- Widget codes ([a88a757](https://github.com/goliatone/go-admin/commit/a88a7576ce9d483e8076bc46a37d307c8df0d580))  - (goliatone)
- Template view helper ([452f906](https://github.com/goliatone/go-admin/commit/452f906a3f81a75d5d99517c89c53f0726793981))  - (goliatone)
- Content type diagnostic for Doctor ([5682545](https://github.com/goliatone/go-admin/commit/56825450d1807f31f5be3a8c6210daad4739f517))  - (goliatone)
- Update facade to expose tpyes ([7ca7575](https://github.com/goliatone/go-admin/commit/7ca75757ff0b9b9110b41054f915469567291747))  - (goliatone)
- Template render helper ([1b3b3ca](https://github.com/goliatone/go-admin/commit/1b3b3ca6f63b0378c7a634a8c6c63fb5a972f9fd))  - (goliatone)
- Service api workflow ([c147c3a](https://github.com/goliatone/go-admin/commit/c147c3aeecc98968677668b410ca1629a191bbba))  - (goliatone)
- Update templates to use SSR and hydration flow ([39d6418](https://github.com/goliatone/go-admin/commit/39d6418e6120dc212c5a55c140e3998a6739be5c))  - (goliatone)
- Doctor panel and doctor helper ([92bd131](https://github.com/goliatone/go-admin/commit/92bd1318f361a780df24d7f2af4073583833e177))  - (goliatone)
- Content type builder ([2383d1b](https://github.com/goliatone/go-admin/commit/2383d1b23c5218f7d556b082c7800e64190024a9))  - (goliatone)
- Doctor panel ([17e868f](https://github.com/goliatone/go-admin/commit/17e868f44f22b68c84388edf2f7a80886f8660d6))  - (goliatone)
- Cms env repository handle cases ([967e32f](https://github.com/goliatone/go-admin/commit/967e32fb98a02ef138814ee530b0f1b838028cc0))  - (goliatone)
- Generate facade vs manual update ([80ce32e](https://github.com/goliatone/go-admin/commit/80ce32e3f8aae6426c2a6e6526c90ec511ddf3df))  - (goliatone)
- Internal primite helpers ([766d11b](https://github.com/goliatone/go-admin/commit/766d11b4c8caecad0e7138c5904e38edde2eef87))  - (goliatone)
- Make menu collapsible ([be7384e](https://github.com/goliatone/go-admin/commit/be7384e88fbcffb3d0bbc37d515a1dd5544fbb22))  - (goliatone)
- Resolve admin preference api ([3c8beb8](https://github.com/goliatone/go-admin/commit/3c8beb88a2bc63f31ffad852fb04148c249c294c))  - (goliatone)
- State management for datable ([e6d4feb](https://github.com/goliatone/go-admin/commit/e6d4febc803d1f4967950de0755b43e75276bdf9))  - (goliatone)
- State management store ([bd73110](https://github.com/goliatone/go-admin/commit/bd73110932136014f2338605e0a02ff8ce1809bd))  - (goliatone)
- Translation readiness wiring ([538f72f](https://github.com/goliatone/go-admin/commit/538f72f7eb8a56b47a06dd21b30afd663c8f9ec7))  - (goliatone)
- Tools module ([4eb8fe8](https://github.com/goliatone/go-admin/commit/4eb8fe834d97afbc890f457817e7e19bbd904c5d))  - (goliatone)
- Maange translations in cms repo ([c32e986](https://github.com/goliatone/go-admin/commit/c32e9860ecec85b8ee0539b9b8646e993588c69e))  - (goliatone)
- Updated client code ([a63ba90](https://github.com/goliatone/go-admin/commit/a63ba90b66d19fd9870ea24edb937c98caa43d35))  - (goliatone)
- Module registration for translation ([0f74c62](https://github.com/goliatone/go-admin/commit/0f74c62ebfe15ca5c3328016b279149e186a1a97))  - (goliatone)
- Canonical policy for translation ([ca69e3b](https://github.com/goliatone/go-admin/commit/ca69e3b13595466a1632f36a68d6060a953dfc93))  - (goliatone)
- Validation run of translation setup ([5a89932](https://github.com/goliatone/go-admin/commit/5a899323f10a91c7167b8596e6bd722973fa3e99))  - (goliatone)
- Translation capabilities handling ([c397d20](https://github.com/goliatone/go-admin/commit/c397d20a2c202bcc70d5ee05f0d28cd22b75dd87))  - (goliatone)
- Mangae disable nav items ([937661d](https://github.com/goliatone/go-admin/commit/937661df723227f6f8595744ddd185155d2addb3))  - (goliatone)
- Api URL helpers ([90525b4](https://github.com/goliatone/go-admin/commit/90525b4b576d4f7f876d7d37103825f4ce1ba4f4))  - (goliatone)
- Translation wiring setup ([55c5564](https://github.com/goliatone/go-admin/commit/55c556402bb0a94470ffcf1b9a38961896ee70be))  - (goliatone)
- Translation module exposure ([1862fb6](https://github.com/goliatone/go-admin/commit/1862fb6de996c192f39581ab88d8b45297219a4b))  - (goliatone)
- Updated datatable features ([5d92ab9](https://github.com/goliatone/go-admin/commit/5d92ab98f33f72deb8813e3fbcbb019f17e2a5e4))  - (goliatone)
- Update client setup ([d96a47d](https://github.com/goliatone/go-admin/commit/d96a47d22c9303da5478705432c7445324f3285c))  - (goliatone)
- Translation UI ([10b9496](https://github.com/goliatone/go-admin/commit/10b949629d6f50bf877d3249af7fb4f1ecc57569))  - (goliatone)
- Wire translation UI ([a2943e1](https://github.com/goliatone/go-admin/commit/a2943e125eddaaee1ede108c2c22a122ec7c696e))  - (goliatone)
- Content translation UX routes ([5fc81f0](https://github.com/goliatone/go-admin/commit/5fc81f0aefa34dc635c0ab425a90296325105c1f))  - (goliatone)
- Register translation dashboard ([1e2bae9](https://github.com/goliatone/go-admin/commit/1e2bae97879acda14d27890a861b8e796a629cce))  - (goliatone)
- View capabilities ([14afb7f](https://github.com/goliatone/go-admin/commit/14afb7f69a19bf5ab1d5dda6128cad28cedec31c))  - (goliatone)
- Register translation UI routes ([2393fcf](https://github.com/goliatone/go-admin/commit/2393fcf646554dbe8ad34fb0bdd022461493fd20))  - (goliatone)
- Missing translation dashboard ([0b6eb4b](https://github.com/goliatone/go-admin/commit/0b6eb4b7a71b4a5dea3a9028839a7f6234f04c32))  - (goliatone)
- Translation bindings ([00dd095](https://github.com/goliatone/go-admin/commit/00dd095987afe1b79e20a90a2aa81e5e537fcd94))  - (goliatone)
- Client translation code ([d4881de](https://github.com/goliatone/go-admin/commit/d4881ded62c2a196d0dc6a3f981dfc6be7a1f729))  - (goliatone)
- Translation urls ([a640946](https://github.com/goliatone/go-admin/commit/a6409462237a45598f585028e2f84070daaf4cf2))  - (goliatone)
- Translation capabilites in context ([fe1065f](https://github.com/goliatone/go-admin/commit/fe1065fb65e2b42692a395c25ffed04bd1a9636d))  - (goliatone)
- Update boot sequence ([7a675c6](https://github.com/goliatone/go-admin/commit/7a675c696178e71bef8dd9c3eac003860399b7a3))  - (goliatone)
- Translation exchange support new flow ([2e6cffd](https://github.com/goliatone/go-admin/commit/2e6cffd7ffa84c1d3ba5c2ca008f03778d56ed1c))  - (goliatone)
- Transition error mapping ([13143cc](https://github.com/goliatone/go-admin/commit/13143cc5bee75232b3f9e81d242b5f8d0db6be75))  - (goliatone)
- Auto save conflict error ([38149d2](https://github.com/goliatone/go-admin/commit/38149d2f2c165064f2d50cf686a42f6352c482a0))  - (goliatone)
- Add action boot setup ([1e4d435](https://github.com/goliatone/go-admin/commit/1e4d4353cdda562d56dbb45e48365354f043166c))  - (goliatone)
- Boot translation queue ([ede3f80](https://github.com/goliatone/go-admin/commit/ede3f80aeef1f4814500a80ffe1e27ddd31bdb02))  - (goliatone)
- Action disable reason code feature disabled ([069dfc7](https://github.com/goliatone/go-admin/commit/069dfc7994c67f666ae48dabe13b4220482c4c27))  - (goliatone)
- Datatable translation featues ([dd8fec6](https://github.com/goliatone/go-admin/commit/dd8fec645d4110e55eb9e756c3fb18f7877520c2))  - (goliatone)
- Admin boot translation queue step ([be2bcb6](https://github.com/goliatone/go-admin/commit/be2bcb6db7664b678f101ea1a25dc62abcf59765))  - (goliatone)
- Admin autosave conflict ([7945421](https://github.com/goliatone/go-admin/commit/7945421c354a2ced241ccb77acd23119e17c23cf))  - (goliatone)
- UI for translation ([5dbc988](https://github.com/goliatone/go-admin/commit/5dbc988454c80900d5a859002e28a4ae0e311578))  - (goliatone)
- Module startup policy ([77aca6a](https://github.com/goliatone/go-admin/commit/77aca6ad2113908e552cb45a18197fc212aa16ee))  - (goliatone)
- Action state reason codes ([119dd21](https://github.com/goliatone/go-admin/commit/119dd216153c3c781848aaa091bba4c8eae88515))  - (goliatone)
- Oauth needs re-auth ([c3e25a3](https://github.com/goliatone/go-admin/commit/c3e25a311aeed5c41d423be17224dedc519adb7e))  - (goliatone)
- Update templates ([c4c2a12](https://github.com/goliatone/go-admin/commit/c4c2a1275a28d35ef53b75ed210f0e53663ae096))  - (goliatone)
- Oauth token policy ([61ac95b](https://github.com/goliatone/go-admin/commit/61ac95bce70fd7cc4f45b169c7c6a4c8afa0db08))  - (goliatone)
- Templates for resources ([ac0ddf4](https://github.com/goliatone/go-admin/commit/ac0ddf4307e03f333ae80b29b128955b1a79b2e8))  - (goliatone)
- Module service callback url ([b66193d](https://github.com/goliatone/go-admin/commit/b66193dec0e3ad4aeff516104534bb43e350d121))  - (goliatone)
- Transaction outbox ([e15267a](https://github.com/goliatone/go-admin/commit/e15267a4d7cbed54b8bf127e3a299a5ab415193f))  - (goliatone)
- Services assets ([98bf348](https://github.com/goliatone/go-admin/commit/98bf348d86f104e48bee296c057b14aa3b4dd5fd))  - (goliatone)
- Services module ([273a534](https://github.com/goliatone/go-admin/commit/273a534ff3d79799ee1703a25cb56bd4d77983bc))  - (goliatone)
- Flag to check persistence cms ([acd4ce7](https://github.com/goliatone/go-admin/commit/acd4ce7a28169efae5e4fa80dd84b32c2a960415))  - (goliatone)
- Services UI ([1ab607a](https://github.com/goliatone/go-admin/commit/1ab607a950a84d48efa2f6aecd5107c99ee644ff))  - (goliatone)
- Public and protected router ([9c924ec](https://github.com/goliatone/go-admin/commit/9c924ec91cac730ab6c148a5dab82943f4cdb02a))  - (goliatone)
- Ensure menu integrity ([82e4878](https://github.com/goliatone/go-admin/commit/82e48786c64b47e45b4e58b0d1cdfe06222a015b))  - (goliatone)
- Protected and public routes ([51baede](https://github.com/goliatone/go-admin/commit/51baede6809699a88b79dadea0e31ae5896029d6))  - (goliatone)
- Expose protected router ([7b126fa](https://github.com/goliatone/go-admin/commit/7b126fab66aac7d54f91c9dec6cd5cb0db3fc22a))  - (goliatone)
- Datatable column menu use filters and visual cues ([2213273](https://github.com/goliatone/go-admin/commit/22132735d3e78296db4bdd84b9597f13614dfe6d))  - (goliatone)
- Protected routes ([42df90e](https://github.com/goliatone/go-admin/commit/42df90e31ef39e9fc5b1dc9bf859a3c9042df3aa))  - (goliatone)
- Menu integrity handler ([c01bbf3](https://github.com/goliatone/go-admin/commit/c01bbf34203b47e4aa0c720e12f26ed22610489c))  - (goliatone)
- Workflow engine setup ([3e00d06](https://github.com/goliatone/go-admin/commit/3e00d0660f50b32b5753c2b413fe88ef2b3b96b4))  - (goliatone)
- Panel entry mode ([a61afc7](https://github.com/goliatone/go-admin/commit/a61afc764f97a760947894379664b69c285c1911))  - (goliatone)
- Update entry model for profile for current user ([d487017](https://github.com/goliatone/go-admin/commit/d4870173282aab1bce3dbd3d96c1158aadc70115))  - (goliatone)
- Cms page record search matcher ([cc2c6ad](https://github.com/goliatone/go-admin/commit/cc2c6ade4548b8cc04e06dc958e2ff78120cd79a))  - (goliatone)
- Settings bun repository defaults ([deff219](https://github.com/goliatone/go-admin/commit/deff21948f6439b1451a390b9d5d15f103fe3b68))  - (goliatone)
- Panel tab scopes ([44f9ec9](https://github.com/goliatone/go-admin/commit/44f9ec96a905a04c01473c7ef974135c2f7c01f6))  - (goliatone)
- Debug panel for permissions ([3ccbb68](https://github.com/goliatone/go-admin/commit/3ccbb682d9a1e517bb731e90a03a73c80974d91c))  - (goliatone)
- New workflow setup ([8f79ed7](https://github.com/goliatone/go-admin/commit/8f79ed7a2d358c347defe638b948bd312afa5570))  - (goliatone)
- Workflow migraitons ([fba9ba1](https://github.com/goliatone/go-admin/commit/fba9ba1ec07fa20d62cac717f49355673185e49c))  - (goliatone)
- Translation and permision handling work ([e18749a](https://github.com/goliatone/go-admin/commit/e18749af824eeb426e43278454cd33adb8bc17a6))  - (goliatone)
- With UI route mode to prefs module ([bac458a](https://github.com/goliatone/go-admin/commit/bac458a0160cff915d51b1a440ce50ac3fe6c5ff))  - (goliatone)
- Form fields to translation panel ([6fb75cd](https://github.com/goliatone/go-admin/commit/6fb75cd0772061aae1b24da4e1c8170306382a6e))  - (goliatone)
- Expose user panel configurator ([3936811](https://github.com/goliatone/go-admin/commit/3936811cf11cb41ad10a09f4275a5780a3d6a2e3))  - (goliatone)
- Module register for translation capabilities ([ca3f96f](https://github.com/goliatone/go-admin/commit/ca3f96f6bacc7a19eab0f9680339f33b4a6b4296))  - (goliatone)
- User import available/enabled to context ([383ae91](https://github.com/goliatone/go-admin/commit/383ae91d1b173f9c3e4ed51638dff42844e73df4))  - (goliatone)
- Url helpers to resolve admin panel URL ([2c5aa8b](https://github.com/goliatone/go-admin/commit/2c5aa8bbb3dd59970e9561958a7db03a6c1aa2d4))  - (goliatone)
- Bulk user import ([cdc7e72](https://github.com/goliatone/go-admin/commit/cdc7e72fd2bf7fcfa0f3895bf7e70a42004d687c))  - (goliatone)
- Admin translation capabilities ([f27096c](https://github.com/goliatone/go-admin/commit/f27096cf96fecb2c068a5d27502f699d47ef37a5))  - (goliatone)
- Quickstart admin list contract ([4baf20b](https://github.com/goliatone/go-admin/commit/4baf20be0025390eb7648209f80c8b9c9628f9a7))  - (goliatone)
- Quickstart view capabilities ([6093ae0](https://github.com/goliatone/go-admin/commit/6093ae0b860bb35142562862f0edb99d71575777))  - (goliatone)
- Permissions debug panel ([2729eef](https://github.com/goliatone/go-admin/commit/2729eef89778e67d04058329b397c31803daa8bf))  - (goliatone)
- Filters and translations ([25a44cc](https://github.com/goliatone/go-admin/commit/25a44ccfaf4b570c55199287ff8c0e19ac20537a))  - (goliatone)
- Frontend tests ([e58e88c](https://github.com/goliatone/go-admin/commit/e58e88ccc38d55d9168a754ba0b4146854faa6d0))  - (goliatone)
- Cms container include translations ([da1fe56](https://github.com/goliatone/go-admin/commit/da1fe5667d9a7b4c91b130815609f95e96ee13eb))  - (goliatone)
- Updated command messages ([6cd0750](https://github.com/goliatone/go-admin/commit/6cd07500d16571361821254e4f38fe8975c3dcb1))  - (goliatone)
- New translation errors ([c57cb45](https://github.com/goliatone/go-admin/commit/c57cb45d7b0a3c4f54dddbe0667e5c88458b4620))  - (goliatone)
- CreateTranslation to admin cms ([c505155](https://github.com/goliatone/go-admin/commit/c5051557e1eb580fe247e1b6d4ad76430a90431c))  - (goliatone)
- Bulk action for user module ([a38b06c](https://github.com/goliatone/go-admin/commit/a38b06c3023f7c06a21dd57287e75f030ba22dfa))  - (goliatone)
- Facade expose translation service ([315392b](https://github.com/goliatone/go-admin/commit/315392b3f49306931c24bfde4f4980ce8bab97a4))  - (goliatone)
- Updae vite build ([e9ab585](https://github.com/goliatone/go-admin/commit/e9ab58509f257a6731eb4c74d29d96ba4b0446fc))  - (goliatone)
- Content entry routes ([d1be4f0](https://github.com/goliatone/go-admin/commit/d1be4f01051c4dd8aaab0384e20776ef3c598d4d))  - (goliatone)
- Admin boot handle label normalizaiton ([526ee20](https://github.com/goliatone/go-admin/commit/526ee20632b8950dd5640e6f91b3127c0d7f3717))  - (goliatone)
- Route conflict support ([fa51e7f](https://github.com/goliatone/go-admin/commit/fa51e7fb4d1b020b3449458653e622fbef6c8fa5))  - (goliatone)
- Panel subresource ([82fef77](https://github.com/goliatone/go-admin/commit/82fef77a79eba4a4b8ccf138053c41a3ab7fd9e1))  - (goliatone)
- Default template functions for panel URL ([b353bc6](https://github.com/goliatone/go-admin/commit/b353bc6819063f2c668093903755f7b078830e4b))  - (goliatone)
- Resolve URL ([49e2244](https://github.com/goliatone/go-admin/commit/49e22441c299f5211afc51e00d3461c53475b0f7))  - (goliatone)
- Translation to panel ([2b07c3d](https://github.com/goliatone/go-admin/commit/2b07c3dac11dc420d6edc91c99c2b3597ae6518f))  - (goliatone)
- Check validation error for id, action, query, value ([1fb47f3](https://github.com/goliatone/go-admin/commit/1fb47f3876d4b343017862d30ca17434d1406859))  - (goliatone)
- Subresources for panel ([2d1259c](https://github.com/goliatone/go-admin/commit/2d1259c34bcc1cf06b4ef0dba19b6bf3fe8fa458))  - (goliatone)
- Normalize create locale ([24cbd13](https://github.com/goliatone/go-admin/commit/24cbd132cce07828f0119c623bf81813050a6351))  - (goliatone)
- Create translation capability ([f2fe87e](https://github.com/goliatone/go-admin/commit/f2fe87e7ed7f00dd882896b5eb9199d642d1bd8f))  - (goliatone)
- Implement translation queue ([74d85ce](https://github.com/goliatone/go-admin/commit/74d85ce5c38526fa8e3787ba6aee097d3cea356a))  - (goliatone)
- Register template filter aliases ([905846c](https://github.com/goliatone/go-admin/commit/905846cb921eb2cb888161c531a602ab83df504d))  - (goliatone)
- Translation auto create ([1a0541a](https://github.com/goliatone/go-admin/commit/1a0541ad94076bb880c9ea16781bcb68c84b6997))  - (goliatone)
- Tenant asset ([7a0339e](https://github.com/goliatone/go-admin/commit/7a0339edd679086932346b0923ec90ca656b2d86))  - (goliatone)
- Object response ([d535395](https://github.com/goliatone/go-admin/commit/d5353950f9fff6b679e43ea3409782264dbcfb95))  - (goliatone)
- Template aliases ([6077ac2](https://github.com/goliatone/go-admin/commit/6077ac251d72d0d6210185c907b7abbdc5d15278))  - (goliatone)
- With path view context ([42d8df4](https://github.com/goliatone/go-admin/commit/42d8df42dddf88c5b295fd561aa2f2888416e6fd))  - (goliatone)
- Translation detail ([5f6d6b3](https://github.com/goliatone/go-admin/commit/5f6d6b3531a3c46a1c62698781a452bf33760551))  - (goliatone)
- Admin layout view context api ([1b9089a](https://github.com/goliatone/go-admin/commit/1b9089a520772a1ec19af5b3f8f163ef1b834e7f))  - (goliatone)
- Helper method to commands ([5c4659d](https://github.com/goliatone/go-admin/commit/5c4659d608021da2d017fd4ea0ddca89c2c6b17f))  - (goliatone)
- Ensure cms field projection ([98bdfb9](https://github.com/goliatone/go-admin/commit/98bdfb9e357d9f0700b8d8711066762dadd16bf9))  - (goliatone)
- Validate panel activity wiring ([aaa8bfc](https://github.com/goliatone/go-admin/commit/aaa8bfc650765daabe5272644699e472a200bd08))  - (goliatone)
- View context paths ([e67a76d](https://github.com/goliatone/go-admin/commit/e67a76d8d2b119e7f9cfe5aee3f715435b5b678a))  - (goliatone)
- Icon service ([2a7ffd6](https://github.com/goliatone/go-admin/commit/2a7ffd6f2beefdf245d87477fbec552c5c520b3d))  - (goliatone)
- Translation helpers ([e99a75e](https://github.com/goliatone/go-admin/commit/e99a75ebdfac1ee9bbd514023f7c854a715f7017))  - (goliatone)
- Cms content list ootpions using projected fields ([c091d07](https://github.com/goliatone/go-admin/commit/c091d077b1db9463787c9875fac55419f7db88f5))  - (goliatone)
- Better error handling for translations ([f7981d7](https://github.com/goliatone/go-admin/commit/f7981d7b66311c92c6ae1a384d98d3ad0d3ae56a))  - (goliatone)
- Translation templates and better layout handling ([34422e5](https://github.com/goliatone/go-admin/commit/34422e5e46668bae6c9ea9a260a56f1aab005464))  - (goliatone)
- Panel add action scope, icons ([a02cb85](https://github.com/goliatone/go-admin/commit/a02cb85c9f54e4640efd87428857642f77c1fb49))  - (goliatone)
- Build admin layout view with context ([04fdc93](https://github.com/goliatone/go-admin/commit/04fdc93dfa739d381bbb30e9618d359859a1bdd6))  - (goliatone)
- Activity reload enabled ([c0724cd](https://github.com/goliatone/go-admin/commit/c0724cd260c72c9edc0a1ca5f3370717241d0138))  - (goliatone)
- Logger provider to boot ([d835bc0](https://github.com/goliatone/go-admin/commit/d835bc0b1f70dc60bd1e6f204374914d64259461))  - (goliatone)
- Build debug session snapshot ([36ca587](https://github.com/goliatone/go-admin/commit/36ca587b5450694c5c1e7e510aa7858c648174c5))  - (goliatone)
- Build admin layout view context ([7f938cb](https://github.com/goliatone/go-admin/commit/7f938cb3bde2965136741a0f33f37cac3dd4f3b1))  - (goliatone)
- Icon management in admin ([9d79437](https://github.com/goliatone/go-admin/commit/9d79437e8d6992b0a236c2140a26cc529700432b))  - (goliatone)
- Support translation boot ([7e5ddac](https://github.com/goliatone/go-admin/commit/7e5ddac12f31e448eedb4f1de0b3608ec600881f))  - (goliatone)
- Export async use new logger API ([9f2d251](https://github.com/goliatone/go-admin/commit/9f2d25121d1de994dbed8ad45cddb0a89cc67240))  - (goliatone)
- Support for random icons ([031a8ea](https://github.com/goliatone/go-admin/commit/031a8ea4a5454c51cde6656bc0ce99ae7dafd321))  - (goliatone)
- Render menu icon using helper ([823dd6d](https://github.com/goliatone/go-admin/commit/823dd6d50699f3c6d5773babc67c92b7f1f62ef9))  - (goliatone)
- Include context in UI routes ([ef40f17](https://github.com/goliatone/go-admin/commit/ef40f17a43923fef7c962a285680bf614b20eb6c))  - (goliatone)
- Translation readiness ([1092b96](https://github.com/goliatone/go-admin/commit/1092b96abb481a49fc68a06caec8f834585c35d9))  - (goliatone)
- Admin panel action wiring ([dca8a0c](https://github.com/goliatone/go-admin/commit/dca8a0c1c9eb0d7958f866c59e32af89190632e7))  - (goliatone)
- Layout view context ([d389eb9](https://github.com/goliatone/go-admin/commit/d389eb94eb3dee0b5a94146972f02e4fac2f7371))  - (goliatone)
- Quickstart UI feature context ([4d9619b](https://github.com/goliatone/go-admin/commit/4d9619b40cc3c23e133a4f3c5befd8905aad9887))  - (goliatone)
- Quickstart translation feature ([c80571c](https://github.com/goliatone/go-admin/commit/c80571ceabe11205ebd2b9465aa90c99a2588e6c))  - (goliatone)
- Upload handler ([fa7fcb6](https://github.com/goliatone/go-admin/commit/fa7fcb6d6ac3cafe8c929ecc4a73f8482194ad92))  - (goliatone)
- Update action logic in menus ([2c34d3f](https://github.com/goliatone/go-admin/commit/2c34d3f9a5d1ac90877cbea2cdd0183fa7555ead))  - (goliatone)
- Scoped logging ([1ec9689](https://github.com/goliatone/go-admin/commit/1ec9689bb4153d90c0d3dd09b533c28115161ba3))  - (goliatone)
- Debug view update filters ([11bd46b](https://github.com/goliatone/go-admin/commit/11bd46bbc6f56105c9b89cdc41dd086b34c6d64e))  - (goliatone)
- Admin scoped logger ([f7f37d9](https://github.com/goliatone/go-admin/commit/f7f37d97da45666d9429d18c39a13e61e9020240))  - (goliatone)
- Logger admin setup ([e3e4ce4](https://github.com/goliatone/go-admin/commit/e3e4ce40310fa16bc1287df586c949caf1a7a10c))  - (goliatone)
- Logger to placeholders ([132d342](https://github.com/goliatone/go-admin/commit/132d342433da0a5dec01d1f96a3f59e683d3f562))  - (goliatone)
- Logger to regsitry ([7897796](https://github.com/goliatone/go-admin/commit/78977967aa3575dbe0f3f437f87bccbabba08b58))  - (goliatone)
- Cms list option derived fields ([3c3e9a4](https://github.com/goliatone/go-admin/commit/3c3e9a4ea45c3d3bcfbb9c1cfd8d78e31fc518ba))  - (goliatone)
- Integrate logger in bootstrap ([cabd44a](https://github.com/goliatone/go-admin/commit/cabd44ac57fd4fda54be6c658d25adcfd7a722fb))  - (goliatone)
- Better error handling in auth UI ([72349bc](https://github.com/goliatone/go-admin/commit/72349bc7202c2d1de2b3e50f66d25ca5d11fa2f3))  - (goliatone)
- Content type route builder ([1dbf156](https://github.com/goliatone/go-admin/commit/1dbf156affaccc72dff15968033c316746c6c34f))  - (goliatone)
- Quickstart loggin setup ([e7f9a49](https://github.com/goliatone/go-admin/commit/e7f9a49f4828ac76b3c2d66529481a30b9e540be))  - (goliatone)
- Attach debug log bridge ([08a50c5](https://github.com/goliatone/go-admin/commit/08a50c5d064ed266de9d6e11890882892a6be5cc))  - (goliatone)
- Support for content fields ([ba4f203](https://github.com/goliatone/go-admin/commit/ba4f203336ef73e3bcbeead00c15a9d9daa5e068))  - (goliatone)
- Support for centralized logging ([b925333](https://github.com/goliatone/go-admin/commit/b9253339d031ab150b16459cd97864ce25e0e20d))  - (goliatone)
- Feature unavailable handler ([6169628](https://github.com/goliatone/go-admin/commit/6169628a6fcbaaeb94c9da11d3c87441da914780))  - (goliatone)
- Provider commands to dashboard ([fb3bbda](https://github.com/goliatone/go-admin/commit/fb3bbda2903c57388bfaf753d45a39a7e3682bca))  - (goliatone)
- Refactoring logging to integrate all packages ([995d948](https://github.com/goliatone/go-admin/commit/995d948290e55a555b26f584651262414cbc6c17))  - (goliatone)
- Content field sortable ([25adb05](https://github.com/goliatone/go-admin/commit/25adb05e5dbaa6858aece94e6ce8c609744a9f2c))  - (goliatone)
- Logger wiring for fiber server ([2c6e6d5](https://github.com/goliatone/go-admin/commit/2c6e6d5b2388a42e9d530448837051d1578b304c))  - (goliatone)
- List records to handle datagrid ([41ad4de](https://github.com/goliatone/go-admin/commit/41ad4de29c9547a51394a541504f58cc25785eea))  - (goliatone)
- Translation exchange ([28343e4](https://github.com/goliatone/go-admin/commit/28343e47b2ddd4667e13d57a036ad1ae737c659d))  - (goliatone)
- Data migration ([b37be31](https://github.com/goliatone/go-admin/commit/b37be31d5b220b09aa8a1f01b5403839a815e53a))  - (goliatone)
- Translation routes for ui ([e446367](https://github.com/goliatone/go-admin/commit/e446367ce4d377344b391ac5ed8433d4bfb28208))  - (goliatone)
- Transltaion queue ([07a8df0](https://github.com/goliatone/go-admin/commit/07a8df0152794681b1c71d5cd938fd1edbe07abe))  - (goliatone)
- Translation bootstrap config ([b97269a](https://github.com/goliatone/go-admin/commit/b97269a2b962387f875f9b5ac45902b09f9146fc))  - (goliatone)
- Translation queue tabs ([007dc03](https://github.com/goliatone/go-admin/commit/007dc0348a0d14857854dd964fdd3c1da12822c3))  - (goliatone)
- Translation exchange ui ([9c76113](https://github.com/goliatone/go-admin/commit/9c76113e490fc914cd0ef75eea46983ea1acaf94))  - (goliatone)
- Translation queue ([ff40532](https://github.com/goliatone/go-admin/commit/ff405326f84b80f578b1b6c1d4e16d612a203f51))  - (goliatone)
- Feature gates for translation exchange ([9a742c9](https://github.com/goliatone/go-admin/commit/9a742c9e6ebf39942b86bf49c351f2d08687f3f7))  - (goliatone)
- Translation workflow ([c8c9f7d](https://github.com/goliatone/go-admin/commit/c8c9f7db1c4bf7f0d8bd22d17fb1a330d0f3556c))  - (goliatone)
- Transltaion workflow ([1271792](https://github.com/goliatone/go-admin/commit/12717929eaf23ae331a9e6b19d959efb28f754ff))  - (goliatone)
- Register translation widget ([99eb6b1](https://github.com/goliatone/go-admin/commit/99eb6b1f2a2adeb9b5779933e6895d3e300c54e2))  - (goliatone)
- Feature check for translation exchagne ([10cb406](https://github.com/goliatone/go-admin/commit/10cb406f7a2902579413d9675576816ac33e4faf))  - (goliatone)
- Udpate error codes ([a8fad79](https://github.com/goliatone/go-admin/commit/a8fad7913c7d8b2cb167fcc4e41c15a94d2c9c92))  - (goliatone)
- Translation preferences ([66876dd](https://github.com/goliatone/go-admin/commit/66876dd3284d9f5a229627bf7803573c8759f146))  - (goliatone)
- Feature setup ([0b74272](https://github.com/goliatone/go-admin/commit/0b74272a0f69e89918a2c2618109bc3d6e7987fe))  - (goliatone)
- Translation workflow setup ([228f4f8](https://github.com/goliatone/go-admin/commit/228f4f88a36b611ee9147bb84dd7baf3c294de3e))  - (goliatone)
- Translation queue dashboard ([3ac3aea](https://github.com/goliatone/go-admin/commit/3ac3aeaf69254c0137479b1c4bf345f89bc0a8bf))  - (goliatone)
- Permission matrix setup ([c0f12a6](https://github.com/goliatone/go-admin/commit/c0f12a67f20d7a8eb4a4095a2dc4dbd881c0fd79))  - (goliatone)
- Translation queue, exchange, and assignment ([fabe645](https://github.com/goliatone/go-admin/commit/fabe64531dd033f8c5d45947270a01a080fcdfff))  - (goliatone)
- Support for bulk update users ([61d5367](https://github.com/goliatone/go-admin/commit/61d5367fb0d5118ea8eb4113805dab0648fba219))  - (goliatone)
- Translation exchnge workflow ([a798861](https://github.com/goliatone/go-admin/commit/a798861978c62b3f9eacfa5a1c34cedf2b9ab4ae))  - (goliatone)
- Translation policy ([d775b71](https://github.com/goliatone/go-admin/commit/d775b71aa761ec0cd5c4d421e2a8d43c67a5622c))  - (goliatone)
- Udpated error codes for translation workflow ([1dd874f](https://github.com/goliatone/go-admin/commit/1dd874f3fc392475d8929043ac29e95e0ffd299d))  - (goliatone)
- Dashboard router register ([75d147e](https://github.com/goliatone/go-admin/commit/75d147e6ee94be4c0d0ed61f78995f3ae094b65f))  - (goliatone)
- Bulk actions in panel definition ([b78e44f](https://github.com/goliatone/go-admin/commit/b78e44ff0182a4bbce26fc59a4d6b1fb81a0a4d8))  - (goliatone)
- Implement actions in panels ([91fb859](https://github.com/goliatone/go-admin/commit/91fb859edddad0f0b59258cc9f6ba7a727a675d2))  - (goliatone)
- Action payload validation ([44164ef](https://github.com/goliatone/go-admin/commit/44164ef98a14f0569c3580753c65adbc862d48d6))  - (goliatone)

## <!-- 2 -->🚜 Refactor

- Use widget name const ([06a2687](https://github.com/goliatone/go-admin/commit/06a26870be563234277ff2ae563e5f34df4c5847))  - (goliatone)
- Dashboard use structs for widgets ([9659bd8](https://github.com/goliatone/go-admin/commit/9659bd815d1c385e15659a1ea9fbbc8f0fe1a5fd))  - (goliatone)
- Dashboard rendering mode, SSR default ([c767d8f](https://github.com/goliatone/go-admin/commit/c767d8f6dbcdd509a073d576a50022274d2f33fe))  - (goliatone)
- Clean up code ([e564bc7](https://github.com/goliatone/go-admin/commit/e564bc72341a553fb2b033e8e0a1a7091a407e03))  - (goliatone)
- Make code more compact ([5275654](https://github.com/goliatone/go-admin/commit/52756545410597469f6dbd39a2431a1d0bd30934))  - (goliatone)
- Use tree vs concrete content types ([6d3d7f9](https://github.com/goliatone/go-admin/commit/6d3d7f9b2825eaae79cf1ae1a2e20b7cea31748a))  - (goliatone)
- Navigation setup ([8f70632](https://github.com/goliatone/go-admin/commit/8f70632a18a2c0c3b6bb5b08b83175e2d7c9c637))  - (goliatone)
- State management for datagrid ([1314651](https://github.com/goliatone/go-admin/commit/13146517fcf453a625da230d58ed15edf0979305))  - (goliatone)
- Js out of templates ([60c5adf](https://github.com/goliatone/go-admin/commit/60c5adfb5849a37404fb35a6b26332c1077f8b7f))  - (goliatone)
- Use url manager ([6a91412](https://github.com/goliatone/go-admin/commit/6a91412310421abe51d672a2cf434d131cb3a964))  - (goliatone)
- Inject paths to view context ([8e68002](https://github.com/goliatone/go-admin/commit/8e6800216ab02a7fa3d978d12f66b6679353b1e6))  - (goliatone)
- Translation capabilities model ([fbcf326](https://github.com/goliatone/go-admin/commit/fbcf326d49db5439caa5885f5716536349f1f844))  - (goliatone)
- Router definition ([f2613cf](https://github.com/goliatone/go-admin/commit/f2613cf4f088268ae50730014084212de95513d6))  - (goliatone)
- Resource views to incorporate latest features ([f642a0c](https://github.com/goliatone/go-admin/commit/f642a0cbae086369f679aef591fb116c0fad7403))  - (goliatone)

## <!-- 3 -->📚 Documentation

- Update changelog for v0.24.0 ([9fd3db3](https://github.com/goliatone/go-admin/commit/9fd3db32d3a810e3a9c42b6ff167d394de984d05))  - (goliatone)

## <!-- 7 -->⚙️ Miscellaneous Tasks

- Udpate tests ([052e4db](https://github.com/goliatone/go-admin/commit/052e4db7591bb77a1c56dc66dc2a15adabcd18b8))  - (goliatone)
- Update gitignore ([5890ebb](https://github.com/goliatone/go-admin/commit/5890ebb1947ae94a7fc579dfa2f02e352b95a9df))  - (goliatone)
- Update guides ([5fc714f](https://github.com/goliatone/go-admin/commit/5fc714faf0d25d72b7db1eba514e71bafe4a56d5))  - (goliatone)
- Update readme ([150b5a4](https://github.com/goliatone/go-admin/commit/150b5a4477281e48f5c8a7ab9ec73c82ba6bdce5))  - (goliatone)
- Update examples ([98a81ef](https://github.com/goliatone/go-admin/commit/98a81efd44c4716ef5b21d6cb4c2b1ee270e5958))  - (goliatone)
- Update test ([962e44b](https://github.com/goliatone/go-admin/commit/962e44bb2a9972dee4a9bb2ff207afcf09df2d47))  - (goliatone)
- Update tasks ([fc8400c](https://github.com/goliatone/go-admin/commit/fc8400c0c696ec09808f8029e756d4d77645e172))  - (goliatone)
- Clean code ([a2770d6](https://github.com/goliatone/go-admin/commit/a2770d6b38d24b027c9b0b795fa7a5b40c8723c4))  - (goliatone)
- Update deps ([cf9177b](https://github.com/goliatone/go-admin/commit/cf9177b2538106e4185b853245499c9eeb41bfb5))  - (goliatone)
- Update docs ([e73ec42](https://github.com/goliatone/go-admin/commit/e73ec42b7c131ea7f74a2d337aca1555a2f8e969))  - (goliatone)
- Update task to check service contracts ([e9fec91](https://github.com/goliatone/go-admin/commit/e9fec918322476000cc9ca392f3cec33acd79935))  - (goliatone)
- Udpate docs ([6374330](https://github.com/goliatone/go-admin/commit/63743304e695b43f5c69420c6330664b9c404a4d))  - (goliatone)
- Update example ([00ee52c](https://github.com/goliatone/go-admin/commit/00ee52cd6d5e45b3c7da2c47c780b0fff0cf5840))  - (goliatone)
- Update format ([9c522d9](https://github.com/goliatone/go-admin/commit/9c522d9d4f8987b2de52299e0bd822ebfed62e06))  - (goliatone)
- Udpate deps ([8050f5f](https://github.com/goliatone/go-admin/commit/8050f5f90e34e16ac2fe76c41fc02872fabfb968))  - (goliatone)
- Update tests ([bfb59a5](https://github.com/goliatone/go-admin/commit/bfb59a5c1d2314b02e84460ed3452cf1fcaea247))  - (goliatone)
- Ignore build hash ([39ba35c](https://github.com/goliatone/go-admin/commit/39ba35c93ba66342870f160dffd27018a688aa4b))  - (goliatone)
- Udpate example ([564daa1](https://github.com/goliatone/go-admin/commit/564daa1d2faf402c831074198de0f3935a344eee))  - (goliatone)
- Udpate readme ([ee70713](https://github.com/goliatone/go-admin/commit/ee70713cd7cbe0393721863a9f06bda7c9b0c20a))  - (goliatone)
- Clean up code ([1082d51](https://github.com/goliatone/go-admin/commit/1082d51daea0b1ba566ff6882115ab8926d5b4c5))  - (goliatone)
